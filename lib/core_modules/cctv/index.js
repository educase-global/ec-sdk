...
const Cctv = {
  ...
  *********************************************************************/
	...
	deleteCCTVAccessSignatureAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_CCTV_ACCESS_SIGNATURE_DELETE"], // api urn
			"post", // method
			params, // request-params
			args["auth"]
		);
	...
	deleteCCTVAccessLogoAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_CCTV_ACCESS_LOGO_DELETE"], // api urn
			"post", // method
			params, // request-params
			args["auth"]
		);
