...
const MealCalendar = {
  ...
  *********************************************************************/
	...
	addMenuNameImportAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_GET_MENU_NAME_IMPORT"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	generateMenuNameAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_GET_MENU_NAME_GENERATE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	showMealCalendarAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_SHOW_MEAL_CALENDAR_ADMIN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	addMealSettingsAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_ADD_MEAL_SETTING_ADMIN"], // api urn
			"post", // method
			params, // request-params
			args["auth"], // auth
			null
	...
	editMealSettingsAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_EDIT_MEAL_SETTING_ADMIN"], // api urn
			"get", // method
			params, // request-params
			args["auth"], // auth
			null
	...
	getMealCalendarMonthParent: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_GET_MEAL_CALENDAR_MONTH_PARENT"], // api urn
			"get", // method
			params, // request-params
			args["auth"], // auth
			null
