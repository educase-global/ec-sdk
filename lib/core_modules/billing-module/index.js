...
const Billing = {
  ...
  *********************************************************************/
	...
	getBillingAdminDeleted: function (cb, args) {
		// Construct params
		let params = args["params"];
		Lib.Commons.httpHandler(
			// callback
			...
			CONFIG["API_URN_BILLING_ADMIN_DELETED_DATA"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	getBillingRemoveBill: function (cb, args) {
		// Construct params
		let params = args["params"];
		Lib.Commons.httpHandler(
			// callback
			...
			CONFIG["API_URN_BILLING_ADMIN_DESTROY_BILL"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	getBillingUpdateBill: function (cb, args) {
		// Construct params
		let params = args["params"];
		Lib.Commons.httpHandler(
			// callback
			...
			CONFIG["API_URN_BILLING_ADMIN_UPDATE_BILL"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	getBillingEditBills: function (cb, args) {
		// Construct params
		let params = args["params"];
		Lib.Commons.httpHandler(
			// callback
			...
			CONFIG["API_URN_BILLING_ADMIN_EDIT_BILL"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	getBillingAdminActivity: function (cb, args) {
		// Construct params
		let params = args["params"];
		Lib.Commons.httpHandler(
			// callback
			...
			CONFIG["API_URN_BILLING_ADMIN_ACTIVITY"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
