...
const StudentTransfer = {
    ...
    destroyAdminStudentTransfer: function (cb, args) {
        makeRequest(cb, args, "API_URN_ADMIN_STUDENT_TRANSFER_DESTROY", "post");
    },
    updateAdminStudentTransfer: function (cb, args) {
        makeRequest(cb, args, "API_URN_ADMIN_STUDENT_TRANSFER_UPDATE", "post");
    },
};
