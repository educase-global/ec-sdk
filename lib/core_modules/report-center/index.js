...
const ReportCenter = {
  ...
  *********************************************************************/
	...
	generateReportCenterAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_GET_REPORT_CENTER_GENERATE_REPORT_ADMIN"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	getReportCenterDropdownAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_GET_REPORT_CENTER_ADMIN_REPORT_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	getReportCenterReportDetailAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_GET_REPORT_CENTER_ADMIN_REPORT_DETAIL"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
