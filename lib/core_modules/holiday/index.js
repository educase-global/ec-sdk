  ...
  *********************************************************************/
  ...
  editHolidayCalendarAdmin: function (cb, args) {
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_EDIT_HolidayCalendar_ADMIN"], // api urn
      "GET", // method
      params, // request-params
      args["auth"] // auth
    )
  ...
  updateHolidayCalendarAdmin: function (cb, args) {
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_UPDATE_HolidayCalendar_ADMIN"], // api urn
      "POST", // method
      params, // request-params
      args["auth"]   
      )
  ...
  deleteHolidayCalendarAdmin: function (cb, args) {
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_DELETE_HolidayCalendar_ADMIN"], // api urn
      "POST", // method
      params, // request-params
      args["auth"] // auth
    )
