...
const Holiday = {
  ...
  *********************************************************************/
	...
	bulkupdateHolidayCalendarAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		Lib.Commons.httpHandler(
			// callback
			...
			CONFIG["API_URN_POST_HOLIDAY_CALENDAR_BULK_UPDATE_ADMIN"], // api urn
			"post", // method
			params, // request-params
			args["auth"]
		);
	...
	holidayImportCsvAdmin: function (cb, args) {
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_IMPORT_HOLIDAY_ADMIN"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	holidayCalendarDropdown: function (cb, args) {
		// Construct params
		let params = args["params"];
		Lib.Commons.httpHandler(
			// callback
			...
			CONFIG["API_URN_HOLIDAY_CALENDAR_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	holidayCalendarFranchiseTableDataAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		Lib.Commons.httpHandler(
			// callback
			...
			CONFIG["API_URN_FRANCHISE_HOLIDAY_CALENDAR_TABLE_DATA_ADMIN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	holidayCalendarMergeGetAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		Lib.Commons.httpHandler(
			// callback
			...
			CONFIG["API_URN_GET_MERGE_HOLIDAY_CALENDAR_LIST_ADMIN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	holidayCalendarMergeUpdateAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		Lib.Commons.httpHandler(
			// callback
			...
			CONFIG["API_URN_UPDATE_MERGE_HOLIDAY_CALENDAR_ADMIN"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
