...
const TeacherComment = {
  ...
  *********************************************************************/
	...
	teacherCommentStudentDropdownAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		// http call
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_TEACHER_COMMENT_STUDENT_DROPDOWN_ADMIN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	teacherCommentCategoryStoreAdmin: function (cb, args) {
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_TEACHER_COMMENT_CATEGORY_STORE_ADMIN"],
			"post",
			params,
			args["auth"]
		);
	...
	teacherCommentCategoryEditAdmin: function (cb, args) {
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_TEACHER_COMMENT_CATEGORY_EDIT_ADMIN"],
			"get",
			params,
			args["auth"]
		);
	...
	teacherCommentCategoryUpdateAdmin: function (cb, args) {
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_TEACHER_COMMENT_CATEGORY_UPDATE_ADMIN"],
			"post",
			params,
			args["auth"]
		);
	...
	teacherCommentCategoryDestroyAdmin: function (cb, args) {
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_TEACHER_COMMENT_CATEGORY_DESTROY_ADMIN"],
			"post",
			params,
			args["auth"]
		);
	...
	teacherCommentCategoryTableDataAdmin: function (cb, args) {
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_TEACHER_COMMENT_CATEGORY_TABLE_DATA_ADMIN"],
			"get",
			params,
			args["auth"]
		);
	...
	teacherCommentCategoryDropdownAdmin: function (cb, args) {
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_TEACHER_COMMENT_CATEGORY_DROPDOWN_ADMIN"],
			"get",
			params,
			args["auth"]
		);
	...
	teacherCommentCategoryStatusUpdateAdmin: function (cb, args) {
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_TEACHER_COMMENT_CATEGORY_STATUS_UPDATE_ADMIN"],
			"post",
			params,
			args["auth"]
		);
	...
	teacherCommentSettingsStoreAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_TEACHER_COMMENT_SETTING_STORE_ADMIN"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	teacherCommentSettingsEditAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_TEACHER_COMMENT_SETTING_EDIT_ADMIN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	classTeacherDropdownParent: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_CLASS_TEACHER_DROPDOWN_PARENT"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	classTeacherCommentStoreParent: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_CLASS_TEACHER_COMMENT_STORE_PARENT"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
