...
const Insta = {
  ...
  *********************************************************************/
	...
	viewInstaAlertAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_VIEW_INSTA_ALERT_ADMIN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	instaAlertUpdateIsPinned: function (cb, args) {
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_INSTA_ALERT_UPDATE_IS_PINNED"],
			"put",
			params,
			args["auth"]
		);
	...
	getEnhanceText: function (cb, args) {
		// Construct params
		let params = args["params"];

		// console.log(CONFIG["API_URN_GET_ENHANCE_TEXT"])
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_GET_ENHANCE_TEXT"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
