...
const VisitorRegister = {
  ...
  *********************************************************************/
	...
	visitorRegisterEditAdmin: function (cb, args, apiVersion) {
		// Construct params
		...
		Lib.Commons.httpHandler(
			...
			params, // request-params
			args["auth"], // auth
			apiVersion // serverType node or php
		);
	},

	visitorRegisterShowAdmin: function (cb, args, apiVersion) {
		// Construct params
	...
	visitorRegisterListAdmin: function (cb, args, apiVersion) {
		// Construct params
