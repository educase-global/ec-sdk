...
const VisitorRegister = {
  ...
  *********************************************************************/
	...
	visitorRegisterSettingStore: function (cb, args) {
		// Construct params
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_VISITOR_REGISTER_SETTING_STORE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	visitorRegisterSettingShow: function (cb, args) {
		// Construct params
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_VISITOR_REGISTER_SETTING_SHOW"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	visitorRegisterTypeShow: function (cb, args) {
		// Construct params
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_VISITOR_REGISTER_TYPE_SHOW"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	visitorRegisterUpdateStatus: function (cb, args) {
		// Construct params
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_VISITOR_REGISTER_UPDATE_STATUS"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	visitorRegisterPendingTableData: function (cb, args) {
		// Construct params
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_VISITOR_REGISTER_PENDING_TABLE_DATA"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	visitorRegisterGuestStore: function (cb, args) {
		// Construct params
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_VISITOR_REGISTER_GUEST_STORE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
