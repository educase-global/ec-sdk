...
const Fee = {
  ...
  *********************************************************************/
  ...
  destroyStudentFeeConfigurationAdmin: function (cb, args) {
    let params = args["params"]
    Lib.Commons.httpHandler(
      function (err, http_status, http_headers, data) {
        if (err) {
      ...
      CONFIG["API_URN_DELETED_STUDENT_FEE_CONFIGURATION_ADMIN"], // api urn
      "post", // method
      params, // request-params
      args["auth"] // auth
    )
  ...
  getStudentFeeTypeReportAdmin: function (cb, args) {
    let params = args["params"]
    Lib.Commons.httpHandler(
      function (err, http_status, http_headers, data) {
        if (err) {
      ...
      CONFIG["API_URN_STUDENT_FEE_TYPE_REPORT_ADMIN"], // api urn
      "get", // method
      params, // request-params
      args["auth"] // auth
    )
  ...
  additionalFeeTableDataAdmin: function (cb, args) {
    ...
    additionalCollectionFeeTableDataAdmin: function (cb, args) {
    let params = args["params"]
    Lib.Commons.httpHandler(
      function (err, http_status, http_headers, data) {
        if (err) {
      ...
      CONFIG["API_URN_ADDITIONAL_COLLECTION_FEES_TABLE_DATA_ADMIN"], // api urn
      "get", // method
      params, // request-params
      args["auth"] // auth
    )
