...
const FeeApproval = {
	...
	// POST franchise/fee-approval/workflow-delete - Delete an approval workflow.
	FranchiseFeeApprovalWorkflowDelete: function (cb, args) {
		makeRequest(cb, args, "API_URN_FRANCHISE_FEE_APPROVAL_WORKFLOW_DELETE", "post");
	},
