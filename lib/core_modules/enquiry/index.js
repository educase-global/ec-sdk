...
const Enquiry = {
  ...
  *********************************************************************/
  ...
  convertPreAdmissionEnquiryAdmin: function (cb, args) {
    // Construct params
    let params = args["params"]
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_ENQUIRY_CONVERT_PRE_ADMISSION"], // api urn
      "post", // method
      params, // request-params
      args["auth"] // auth
    )
  },
  getPreAdmissionPaymentStatus: function (cb, args) {
    // Construct params
    let params = args["params"]
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_PRE_ADMISSION_STUDENT_GET_PAYMENT_STATUS"], // api urn
      "get", // method
      params, // request-params
      args["auth"] // auth
    )
