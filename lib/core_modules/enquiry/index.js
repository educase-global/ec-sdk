...
const Enquiry = {
  ...
  *********************************************************************/
  ...
  editEnquirySourcesAdmin: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_EDIT_ENQUIRY_SOURCES"])
  ...
  viewEnquiryReasonAdmin: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_VIEW_ENQUIRY_REASON"])
  ...
  editEnquiryReasonAdmin: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_EDIT_ENQUIRY_REASON"])
  ...
  updateEnquiryReasonAdmin: function (cb, args) {
    // Construct params
    let params = args["params"]
    console.log(CONFIG["API_URN_UPDATE_ENQUIRY_REASON"])
  ...
  deleteEnquiryReasonAdmin: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_DELETE_ENQUIRY_REASON"])
  ...
  getEnquiryReasonListAdmin: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_ENQUIRY_REASON_LIST"])
  ...
  updateEnquiryAdmin: function (cb, args) {
    // Construct params
    let params = args["params"]
    console.log(CONFIG["API_URN_UPDATE_ENQUIRY"])
    // http call
    Lib.Commons.httpHandler(
      // callback
      function (err, http_status, http_headers, data) {
  ...
  showEnquiryAdmin: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_SHOW_ENQUIRY"])
  ...
  editEnquiryAdmin: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_EDIT_ENQUIRY"])
  ...
  deleteEnquiryAdmin: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_DELETE_ENQUIRY"])
  ...
  generateImportEnquiryAdmin: function (cb, args) {
    // Construct params
    let params = args["params"]

    console.log(CONFIG["API_URN_GENERATE_IMPORT_ENQUIRY"])
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_GENERATE_IMPORT_ENQUIRY"], // api urn
      "GET", // method
      params, // request-params
      args["auth"] // auth
    )
  ...
  exportEnquiryAdmin: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_EXPORT_ENQUIRY"])
  ...
  importEnquiryAdmin: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_IMPORT_ENQUIRY"])
