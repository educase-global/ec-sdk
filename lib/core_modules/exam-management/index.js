...
const ExamManagement = {
  ...
  *********************************************************************/
	...
	getExamManagementHallTicketPrint: function (cb, args) {
		// Construct params
		let params = args["params"];
		Lib.Commons.httpHandler(
			// callback
			...
			CONFIG["API_URN_EXAM_MANAGEMENT_HALLTICKET_PRINT"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	getExamManagementHallTicketSettingAdd: function (cb, args) {
		// Construct params
		let params = args["params"];
		Lib.Commons.httpHandler(
			// callback
			...
			CONFIG["API_URN_EXAM_MANAGEMENT_HALLTICKET_SETTING_ADD"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	getExamManagementHallTicketSettingShow: function (cb, args) {
		// Construct params
		let params = args["params"];
		Lib.Commons.httpHandler(
			// callback
			...
			CONFIG["API_URN_EXAM_MANAGEMENT_HALLTICKET_SETTING_SHOW"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	ExamManagementHallTicketSettingDelete: function (cb, args) {
		// Construct params
		let params = args["params"];
		Lib.Commons.httpHandler(
			// callback
			...
			CONFIG["API_URN_EXAM_MANAGEMENT_HALLTICKET_SETTING_DELETE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	// parents side
	ExamManagementHallTicketParentsSideList: function (cb, args) {
		// Construct params
		let params = args["params"];
		Lib.Commons.httpHandler(
			// callback
			...
			CONFIG["API_URN_EXAM_MANAGEMENT_LIST"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	ExamManagementParentsSideHallTicketGenerate: function (cb, args) {
		// Construct params
		let params = args["params"];
		Lib.Commons.httpHandler(
			// callback
			...
			CONFIG["API_URN_EXAM_MANAGEMENT_HALL_TICKET_GENERATE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
