...
const ProgressReport = {
  ...
  *********************************************************************/
	...
	deletePrincipleSignatureAdmin: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_DELETE_PRINCIPAL_SIGNATURE_ADMIN"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	deleteExamInchargeSignatureAdmin: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_DELETE_EXAM_INCHARGE_SIGNATURE_ADMIN"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	deleteReportTeacherSignatureAdmin: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
	...
	progressReportPreSchoolMultiPagerStore: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_PRE_SCHOOL_MULTI_STORE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	progressReportPreSchoolMultiPagerEdit: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_PRE_SCHOOL_MULTI_EDIT"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	progressReportPreSchoolMultiPagerUpdate: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_PRE_SCHOOL_MULTI_UPDATE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	progressReportPreSchoolMultiPagerTableData: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_PRE_SCHOOL_MULTI_TABLE_DATA"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportPreSchoolMultiPagerRestriction: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_MULTI_PAGER_RESTRICTION_SETTINGS"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	progressReportPreSchoolMultiPagerGenerateCSV: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_PRE_SCHOOL_MULTI_PAGER_GENERATE_CSV"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	progressReportPreSchoolMultiPagerImportCSV: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_PRE_SCHOOL_MULTI_PAGER_IMPORT_CSV"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	progressReportPreSchoolMultiPagerReportDropdown: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_PRE_SCHOOL_MULTI_PAGER_REPORT_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	progressReportPreSchoolMultiPagerReportDelete: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_PRE_SCHOOL_MULTI_PAGER_REPORT_DELETE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	progressReportPreSchoolCopyMultiPagerReport: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_PRE_SCHOOL_COPY_MULTI_PAGER_REPORT"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	progressReportMultiPagerReportGenerate: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_MULTI_PAGER_REPORT_VIEW_RE_GENERATE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	progressReportMultiPagerGradeDropdown: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_MULTI_PAGER_GRADE_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	progressReportMultiFillStudentMarksShow: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_MULTI_FILL_MARKS_SHOW"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportMultiResultPrint: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_RESULT_MARKS_PRINT_SHOW"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportMultiFillStudentMarksStore: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_MULTI_FILL_MARKS_STORE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportBuilderStore: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_STORE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportBuilderList: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_LIST"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportBuilderEdit: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_EDIT"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportBuilderUpdate: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_UPDATE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportBuilderDelete: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_DELETE"], // api urn
			"delete", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportEntryStudents: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_ENTRY_STUDENTS"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicTemplatePublish: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_TEMPLATE_PUBLISH"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicAssignTeacher: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_ASSIGN_TEACHER"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportPublish: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_PUBLISH"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportEntrySave: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_ENTRY_SAVE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportEntry: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_ENTRY"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportEquivalenceStore: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_STORE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportEquivalenceList: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_LIST"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportEquivalenceView: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_VIEW"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportEquivalenceUpdate: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_UPDATE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportEquivalenceDelete: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_DELETE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportEquivalenceDropdown: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportTemplateDropdown: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_TEMPLATE_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportStudentsShow: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_STUDENTS_SHOW"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportView: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_VIEW"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportUploadImage: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_UPLOAD_IMAGE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportRemarkStore: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_REMARK_STORE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportRemarkList: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_REMARK_LIST"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportRemarkDropdown: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_REMARK_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportRemarkUpdate: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_REMARK_UPDATE"], // api urn
			"put", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportRemarkDelete: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_REMARK_DELETE"], // api urn
			"delete", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	progressReportDynamicReportUploadPdf: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_UPLOAD_PDF"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	FranchiseProgressReportDynamicReportEquivalenceStore: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_STORE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	FranchiseProgressReportDynamicReportEquivalenceList: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_LIST"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	FranchiseProgressReportDynamicReportEquivalenceView: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_VIEW"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	FranchiseProgressReportDynamicReportEquivalenceUpdate: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_UPDATE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	FranchiseProgressReportDynamicReportEquivalenceDelete: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_DELETE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	FranchiseProgressReportDynamicReportEquivalenceDropdown: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	FranchiseProgressReportDynamicReportBuilderStore: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_STORE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	FranchiseProgressReportDynamicReportBuilderList: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_LIST"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	FranchiseProgressReportDynamicTemplateDropdown: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_TEMPLATE_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	FranchiseProgressReportDynamicReportBuilderEdit: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_EDIT"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	FranchiseProgressReportDynamicReportBuilderUpdate: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_UPDATE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	FranchiseProgressReportDynamicReportBuilderDelete: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_DELETE"], // api urn
			"delete", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	FranchiseProgressReportDynamicReportStore: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_STORE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	FranchiseProgressReportDynamicReportTableData: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_TABLE_DATA"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	FranchiseProgressReportDynamicReportEdit: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_EDIT"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	FranchiseProgressReportDynamicReportUpdate: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_UPDATE"], // api urn
			"put", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	FranchiseProgressReportDynamicReportDelete: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_DELETE"], // api urn
			"delete", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	FranchiseProgressReportDynamicReportPublish: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_PUBLISH"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	FranchiseProgressReportDynamicTemplatePublish: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_TEMPLATE_PUBLISH"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	FranchiseProgressReportDynamicStudentWiseAttendanceReport: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_STUDENT_WISE_ATTENDANCE_REPORT"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
