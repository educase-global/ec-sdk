...
const ProgressReport = {
  ...
  *********************************************************************/
  ...
  getResultSettingsListAdmin: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_GET_RESULT_SETTINGS_LIST_ADMIN"])
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_GET_RESULT_SETTINGS_LIST_ADMIN"], // api urn
      "GET", // method
      params, // request-params
      args["auth"] // auth
    )
  ...
  deleteResultSettingsAdmin: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_DELETE_RESULT_SETTINGS_ADMIN"])
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_DELETE_RESULT_SETTINGS_ADMIN"], // api urn
      "POST", // method
      params, // request-params
      args["auth"] // auth
    )
  ...
  addResultSettingsAdmin: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_ADD_RESULT_SETTINGS_ADMIN"])
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_ADD_RESULT_SETTINGS_ADMIN"], // api urn
      "POST", // method
      params, // request-params
      args["auth"] // auth
    )
  ...
  editResultSettingsAdmin: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_EDIT_RESULT_SETTINGS_ADMIN"])
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_EDIT_RESULT_SETTINGS_ADMIN"], // api urn
      "GET", // method
      params, // request-params
      args["auth"] // auth
    )
  ...
  updateResultSettingsAdmin: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_UPDATE_RESULT_SETTINGS_ADMIN"])
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_UPDATE_RESULT_SETTINGS_ADMIN"], // api urn
      "POST", // method
      params, // request-params
      args["auth"] // auth
    )
