...
const Franchise = {
  ...
  *********************************************************************/
	...
	TeacherCurriculumSessionEnd: function (cb, args) {
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_FRANCHISE_CURRICULUM_TEACHER_CURRICULUM_SESSION_END"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	TeacherCurriculumSessionStart: function (cb, args) {
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_FRANCHISE_CURRICULUM_TEACHER_CURRICULUM_SESSION_START"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
