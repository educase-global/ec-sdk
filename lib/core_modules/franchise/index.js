...
const Franchise = {
  ...
  *********************************************************************/
	...
	/********************************************************************
	Get Franchise Dashboard V3 Fee Chart
	@param {Function} cb - Callback function to be invoked once async execution of this function is finished
	...
	* @param {Object} params - Request parameters
	...
	@callback(err, fee chart data) - Request Callback.
	* @callback {Error} err - Http Error
	* @callback {Object} data - Fee chart data
	*********************************************************************/
	franchiseDashboardV3FeeChart: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			// callback
			function (err, http_status, http_headers, data) {
			...
			CONFIG["API_URN_FRANCHISE_DASHBOARD_V3_FEE_CHART"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	/********************************************************************
	Get Franchise Dashboard V3 Fee Overall
	@param {Function} cb - Callback function to be invoked once async execution of this function is finished
	...
	* @param {Object} params - Request parameters
	...
	@callback(err, fee overall data) - Request Callback.
	* @callback {Error} err - Http Error
	* @callback {Object} data - Fee overall data
	*********************************************************************/
	franchiseDashboardV3FeeOverall: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			// callback
			function (err, http_status, http_headers, data) {
			...
			CONFIG["API_URN_FRANCHISE_DASHBOARD_V3_FEE_OVERALL"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
