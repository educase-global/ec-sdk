...
const Daycare = {
  ...
  *********************************************************************/
	...
	daycareTableData: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_DAYCARE_TABLE_DATA_ADMIN"], // api urn
			"GET", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	getDaycarePackageAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		// http call
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_GET_DAYCARE_PACKAGE_ADMIN"], // api urn
			"GET", // method
			params, // request-params
			args["auth"] // auth
		);
