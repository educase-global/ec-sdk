...
const Daycare = {
  ...
  *********************************************************************/
	...
	daycareCorporateBillGenerate: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_DAYCARE_CORPORATE_BILL_GENERATE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	daycareCorporateBillList: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_DAYCARE_CORPORATE_BILL_LIST"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	daycareCorporateBillView: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_DAYCARE_CORPORATE_BILL_VIEW"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	daycareCorporateBillUpdate: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_DAYCARE_CORPORATE_BILL_UPDATE"], // api urn
			"put", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	daycareCorporateBillDelete: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_DAYCARE_CORPORATE_BILL_DELETE"], // api urn
			"delete", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	daycareCorporateBillInvoiceSequence: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_DAYCARE_CORPORATE_BILL_INVOICE_SEQUENCE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	daycareCorporateBillingDetail: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_DAYCARE_CORPORATE_BILLING_DETAIL"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	daycareCorporateBillingCollect: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_DAYCARE_CORPORATE_BILLING_COLLECT"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	daycareCorporateBillHtml: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_DAYCARE_CORPORATE_BILL_HTML"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	daycareCorporateBillRecuringRuleEdit: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_DAYCARE_CORPORATE_BILL_RECURRING_RULE_DETAIL"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	daycareCorporateBillRecuringRuleActivateDeactivate: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_DAYCARE_CORPORATE_BILL_RECURRING_RULE_STATE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	daycareCorporateBillRecuringRuleUpdate: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_DAYCARE_CORPORATE_BILL_RECURRING_RULE_UPDATE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	daycareCorporateBillRecuringRulesList: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_DAYCARE_CORPORATE_BILL_RECURRING_RULES"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	daycareCorporateBillPublish: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_DAYCARE_CORPORATE_BILL_PUBLISH"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
