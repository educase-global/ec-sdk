...
const Library = {
	...
	// POST library-book-import - Bulk import books from an uploaded file.
	importLibraryBookAdmin: function (cb, args) {
		makeRequest(cb, args, "API_URN_IMPORT_LIBRARY_BOOK_ADMIN", "post");
	},
