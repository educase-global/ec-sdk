...
const SmsEmail = {
  ...
  *********************************************************************/
	...
	allocateBlukSmsSchoolFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_MANAGE_BLUK_SMS_STORE_FRANCHISE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	deallocateSmsFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_MANAGE_SMS_FRANCHISE_DEALLOCATION"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	SmsSettingsFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_MANAGE_SMS_FRANCHISE_SETTINGS_STORE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	SmsSettingsShowFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_MANAGE_SMS_FRANCHISE_SETTINGS_SHOW"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	SmsEmailModuleListShowFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_MANAGE_SMS_FRANCHISE_MODULE_LIST_SHOW"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	SmsEmailModuleListStoreFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_MANAGE_SMS_MODULE_LIST_STORE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	//FRANCHISE
	whatsAppTemplateCreateFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_CREATE_WHATSAPP_TEMPLATE_FRANCHISE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppTemplateDeleteFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_DELETE_WHATSAPP_TEMPLATE_FRANCHISE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppTemplateListFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_GET_WHATSAPP_TEMPLATE_LIST_FRANCHISE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppGetTemplateSyncFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_GET_WHATSAPP_TEMPLATE_SYNC_FRANCHISE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppGetTemplateSyncCopyFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_GET_WHATSAPP_TEMPLATE_SYNC_TEMPLATE_COPY_FRANCHISE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppGetTemplateFbTableDataFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_GET_WHATSAPP_TEMPLATE_FB_TABLE_DATA_FRANCHISE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppTemplateModuleDropdownFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_GET_WHATSAPP_TEMPLATE_MODULE_DROPDOWN_FRANCHISE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppTemplateSubModuleDropdownFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_GET_WHATSAPP_TEMPLATE_SUB_MODULE_DROPDOWN_FRANCHISE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppPhoneVerifyCodeFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN__WHATSAPP_PHONE_VERIFY_CODE_FRANCHISE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppPhoneRequestCodeFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN__WHATSAPP_PHONE_REQUEST_CODE_FRANCHISE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppSettingStoreFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN__WHATSAPP_SETTING_STORE_FRANCHISE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppSettingShowFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN__WHATSAPP_SETTING_SHOW_FRANCHISE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppSettingGetPhoneIdFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN__WHATSAPP_SETTING_GET_PHONEID_FRANCHISE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppSettingRegisterPhoneFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN__WHATSAPP_SETTING_REGISTER_PHONE_FRANCHISE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppSettingPhoneSetVerifyFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN__WHATSAPP_SETTING_PHONE_SET_VERIFY_FRANCHISE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppModulesStoreFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN__WHATSAPP_MODULES_STORE_FRANCHISE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppModulesShowFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN__WHATSAPP_MODULES_SHOW_FRANCHISE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppBrodcastCvsGenerateFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN__WHATSAPP_BROADCAST_CVS_GENERATE_FRANCHISE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppBrodcastStatsFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN__WHATSAPP_BROADCAST_STATS_FRANCHISE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppBrodcastTableListFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN__WHATSAPP_BROADCAST_TABLE_LIST_FRANCHISE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppBrodcastCvsImportFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN__WHATSAPP_BROADCAST_CVS_IMPORT_FRANCHISE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppBrodcastExportFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN__WHATSAPP_BROADCAST_EXPORT_FRANCHISE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppConversationListFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_WHATSAPP_CONVERSATION_LIST_FRANCHISE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppConversationDetailFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_WHATSAPP_CONVERSATION_DETAIL_FRANCHISE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppConversationAssignChatFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_WHATSAPP_CONVERSATION_ASSIGN_CHAT_FRANCHISE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppConversationSendMessageFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_WHATSAPP_CONVERSATION_SEND_MESSAGE_FRANCHISE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppConversationSendTemplateFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_WHATSAPP_CONVERSATION_SEND_TEMPLATE_FRANCHISE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppModulesLibraryShowFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN__WHATSAPP_MODULES_LIBRARY_SHOW_FRANCHISE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppLogListShowFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN__WHATSAPP_LOG_LIST_SHOW_FRANCHISE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppUserStoreFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_WHATSAPP_USER_STORE_FRANCHISE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppUserUpdateFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_WHATSAPP_USER_UPDATE_FRANCHISE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppUserEditFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_WHATSAPP_USER_EDIT_FRANCHISE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	whatsAppUserListFranchise: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_WHATSAPP_USER_LIST_FRANCHISE"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
