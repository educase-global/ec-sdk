  ...
  *********************************************************************/
	...
	storeBirthdaySetting: function (cb, args) {
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_STORE_SETTING_ADMIN"], // api urn
			"post", // method
			params, // request-params
			args["auth"]
		);
	...
	deleteLogoSettingsAdmIn: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BIRTHDAY_DELETE_LOGO_ADMIN"], // api urn
			"post", // method
			params, // request-params
			args["auth"]
		);
	...
	BirthdayTemplateTableData: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BIRTHDAY_TEMPLATE_TABLE_DATA"], // api urn
			"get", // method
			params, // request-params
			args["auth"]
		);
	...
	BirthdayTemplateDropdown: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BIRTHDAY_TEMPLATE_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"]
		);
	...
	BirthdayTemplateStore: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BIRTHDAY_TEMPLATE_STORE"], // api urn
			"post", // method
			params, // request-params
			args["auth"]
		);
	},
	BirthdayTemplateEdit: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BIRTHDAY_TEMPLATE_EDIT"], // api urn
			"get", // method
			params, // request-params
			args["auth"]
		);
	},
	BirthdayTemplateUpdate: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BIRTHDAY_TEMPLATE_UPDATE"], // api urn
			"post", // method
			params, // request-params
			args["auth"]
		);
	},
	BirthdayTemplateDestroy: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BIRTHDAY_TEMPLATE_DESTROY"], // api urn
			"post", // method
			params, // request-params
			args["auth"]
		);
