...
const Payment = {
  ...
  *********************************************************************/
  ...
  processGuestPayment: function (cb, args) {
    // Construct params
    let params = args["params"]
    Lib.Commons.httpHandler(
      // callback
      ...
      CONFIG["API_URN_PROCESS_GUEST_PAYMENT"], // api urn
      "post", // method
      params, // request-params
      args["auth"], // auth
    )
  },
  processBillFeePayment: function (cb, args) {
    // Construct params
    let params = args["params"]
    Lib.Commons.httpHandler(
      // callback
      ...
      CONFIG["API_URN_PROCESS_BILL_FEE_PAYMENT"], // api urn
      "post", // method
      params, // request-params
      args["auth"], // auth
    )
  ...
  parentCreateKitOrder: function (cb, args) {
    // Construct params
    let params = args["params"]
    Lib.Commons.httpHandler(
      // callback
      ...
      CONFIG["API_URN_PARENT_CREATE_KIT_ORDER"], // api urn
      "post", // method
      params, // request-params
      args["auth"], // auth
    )
  ...
  parentKitPayementFail: function (cb, args) {
    // Construct params
    let params = args["params"]
    Lib.Commons.httpHandler(
      // callback
      ...
      CONFIG["API_URN_PARENT_KIT_PAYEMENT_FAIL"], // api urn
      "post", // method
      params, // request-params
      args["auth"], // auth
    )
  ...
  parentProcessKitPayement: function (cb, args) {
    // Construct params
    let params = args["params"]
    Lib.Commons.httpHandler(
      // callback
      ...
      CONFIG["API_URN_PARENT_PROCESS_KIT_PAYEMENT"], // api urn
      "post", // method
      params, // request-params
      args["auth"], // auth
    )
  ...
  parentCreateProductOrder: function (cb, args) {
    // Construct params
    let params = args["params"]
    Lib.Commons.httpHandler(
      // callback
      ...
      CONFIG["API_URN_PARENT_CREATE_PRODUCT_ORDER"], // api urn
      "post", // method
      params, // request-params
      args["auth"], // auth
    )
  ...
  parentProductPayementFail: function (cb, args) {
    // Construct params
    let params = args["params"]
    Lib.Commons.httpHandler(
      // callback
      ...
      CONFIG["API_URN_PARENT_PRODUCT_PAYEMENT_FAIL"], // api urn
      "post", // method
      params, // request-params
      args["auth"], // auth
    )
  ...
  parentProcessProductPayement: function (cb, args) {
    // Construct params
    let params = args["params"]
    Lib.Commons.httpHandler(
      // callback
      ...
      CONFIG["API_URN_PARENT_PROCESS_PRODUCT_PAYEMENT"], // api urn
      "post", // method
      params, // request-params
      args["auth"], // auth
    )
  },
  sendPaymentRequest: function (cb, args) {
    // Construct params
    let params = args["params"]
    Lib.Commons.httpHandler(
      // callback
      ...
      CONFIG["API_URN_SEND_PAYEMENT_REQUEST"], // api urn
      "post", // method
      params, // request-params
      args["auth"], // auth
    )
