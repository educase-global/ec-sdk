 ...
 *********************************************************************/
	...
	getStudentAttendanceHistoryReportAdmin: function (cb, args) {
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_GET_STUDENT_ATTENDANCE_HISTORY_ADMIN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	getStudentAttendanceDetail: function (cb, args) {
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_GET_STUDENT_ATTENDANCE_DETAIL"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	studentAttendanceClassOverview: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_ATTENDANCE_OVERVIEW_CLASS_SECTION_ADMIN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	attendanceWeeklyHolidayRemovalStore: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_ATTENDANCE_WEEKLY_HOLIDAY_REMOVAL_STORE_ADMIN"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	attendanceWeeklyHolidayRemovalEdit: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_ATTENDANCE_WEEKLY_HOLIDAY_REMOVAL_EDIT_ADMIN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	attendanceWeeklyHolidayRemovalDelete: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_ATTENDANCE_WEEKLY_HOLIDAY_REMOVAL_DELETE_ADMIN"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	attendanceWeeklyHolidayRemovalGetListData: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_ATTENDANCE_WEEKLY_HOLIDAY_REMOVAL_LIST_ADMIN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
