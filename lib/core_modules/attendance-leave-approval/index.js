...
const AttendanceLeaveApproval = {
	...
	FranchiseAttendanceLeaveGeneralPreferenceSetCutover: function (cb, args) {
		makeRequest(cb, args, "API_URN_FRANCHISE_ATTENDANCE_LEAVE_GENERAL_PREFERENCE_SET_CUTOVER", "post");
	},
	...
	FranchiseAttendanceLeaveGeneralPreferenceUpdate: function (cb, args) {
		makeRequest(cb, args, "API_URN_FRANCHISE_ATTENDANCE_LEAVE_GENERAL_PREFERENCE_UPDATE", "post");
	},
	...
	FranchiseAttendanceLeaveAttendanceRuleUpdate: function (cb, args) {
		makeRequest(cb, args, "API_URN_FRANCHISE_ATTENDANCE_LEAVE_ATTENDANCE_RULE_UPDATE", "post");
	},
	...
	FranchiseAttendanceLeaveLeaveRuleUpdate: function (cb, args) {
		makeRequest(cb, args, "API_URN_FRANCHISE_ATTENDANCE_LEAVE_LEAVE_RULE_UPDATE", "post");
	},
