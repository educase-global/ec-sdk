...
const AttendanceLeaveApproval = {
	...
	/*
	 * ======================
	 * STAFF SELF-SERVICE (Staff Marking API)
	 * ======================
	 * All routes live under /self/ on the Node server; callers pass serverType: "node" in params.
	 * The server resolves staff_id from the bearer token — never send it.
	 */

	// GET self/attendance-leave-my-attendance - Day-by-day attendance for a range (from_date, to_date unix).
	StaffAttendanceLeaveMyAttendance: function (cb, args) {
		makeRequest(cb, args, "API_URN_SELF_ATTENDANCE_LEAVE_MY_ATTENDANCE", "get");
	},

	// PUT self/attendance-leave-self-mark-attendance - Check in/out (business_date, shift_no, in_time, out_time, channel SELF_MANUAL|SELF_QR, remarks).
	StaffAttendanceLeaveSelfMarkAttendance: function (cb, args) {
		makeRequest(cb, args, "API_URN_SELF_ATTENDANCE_LEAVE_SELF_MARK_ATTENDANCE", "put");
	},

	// GET self/attendance-leave-month-lock-show - Branch month lock status (month, year).
	StaffAttendanceLeaveMonthLockShow: function (cb, args) {
		makeRequest(cb, args, "API_URN_SELF_ATTENDANCE_LEAVE_MONTH_LOCK_SHOW", "get");
	},

	// GET self/attendance-leave-my-leave-balance - Leave balance per type (leave_year).
	StaffAttendanceLeaveMyLeaveBalance: function (cb, args) {
		makeRequest(cb, args, "API_URN_SELF_ATTENDANCE_LEAVE_MY_LEAVE_BALANCE", "get");
	},

	// GET self/attendance-leave-leave-ledger-drilldown - Credit/debit history for one leave type (leave_type_id, from_date, to_date).
	StaffAttendanceLeaveLedgerDrilldown: function (cb, args) {
		makeRequest(cb, args, "API_URN_SELF_ATTENDANCE_LEAVE_LEAVE_LEDGER_DRILLDOWN", "get");
	},

	// POST self/attendance-leave-leave-application-store - Apply for leave (leave_type_id, from_date, to_date, shift_scope, reason, attachment_file).
	StaffAttendanceLeaveApplicationStore: function (cb, args) {
		makeRequest(cb, args, "API_URN_SELF_ATTENDANCE_LEAVE_LEAVE_APPLICATION_STORE", "post");
	},

	// PUT self/attendance-leave-leave-application-cancel - Cancel own application (id).
	StaffAttendanceLeaveApplicationCancel: function (cb, args) {
		makeRequest(cb, args, "API_URN_SELF_ATTENDANCE_LEAVE_LEAVE_APPLICATION_CANCEL", "put");
	},

	// GET self/attendance-leave-my-leave-applications - Own leave applications (status, page, perPage).
	StaffAttendanceLeaveMyLeaveApplications: function (cb, args) {
		makeRequest(cb, args, "API_URN_SELF_ATTENDANCE_LEAVE_MY_LEAVE_APPLICATIONS", "get");
	},

	// POST self/attendance-leave-regularisation-request-store - Correction request (business_date, shift_no, from_status, to_status | to_leave_type_id, corrected_in_time, corrected_out_time, reason, attachment_file).
	StaffAttendanceLeaveRegularisationRequestStore: function (cb, args) {
		makeRequest(cb, args, "API_URN_SELF_ATTENDANCE_LEAVE_REGULARISATION_REQUEST_STORE", "post");
	},

	// PUT self/attendance-leave-regularisation-request-cancel - Cancel own correction request (id).
	StaffAttendanceLeaveRegularisationRequestCancel: function (cb, args) {
		makeRequest(cb, args, "API_URN_SELF_ATTENDANCE_LEAVE_REGULARISATION_REQUEST_CANCEL", "put");
	},

	// GET self/attendance-leave-my-regularisation-requests - Own correction requests (status, page, perPage).
	StaffAttendanceLeaveMyRegularisationRequests: function (cb, args) {
		makeRequest(cb, args, "API_URN_SELF_ATTENDANCE_LEAVE_MY_REGULARISATION_REQUESTS", "get");
	},

	// GET self/attendance-leave-leave-application-table-data - Approver inbox: leave applications (status, page, perPage).
	StaffAttendanceLeaveApplicationTableData: function (cb, args) {
		makeRequest(cb, args, "API_URN_SELF_ATTENDANCE_LEAVE_LEAVE_APPLICATION_TABLE_DATA", "get");
	},

	// PUT self/attendance-leave-leave-application-approve - Approve a leave application (id).
	StaffAttendanceLeaveApplicationApprove: function (cb, args) {
		makeRequest(cb, args, "API_URN_SELF_ATTENDANCE_LEAVE_LEAVE_APPLICATION_APPROVE", "put");
	},

	// PUT self/attendance-leave-leave-application-reject - Reject a leave application (id, reason).
	StaffAttendanceLeaveApplicationReject: function (cb, args) {
		makeRequest(cb, args, "API_URN_SELF_ATTENDANCE_LEAVE_LEAVE_APPLICATION_REJECT", "put");
	},

	// GET self/attendance-leave-regularisation-request-table-data - Approver inbox: correction requests (status, page, perPage).
	StaffAttendanceLeaveRegularisationRequestTableData: function (cb, args) {
		makeRequest(cb, args, "API_URN_SELF_ATTENDANCE_LEAVE_REGULARISATION_REQUEST_TABLE_DATA", "get");
	},

	// PUT self/attendance-leave-regularisation-request-approve - Approve a correction request (id).
	StaffAttendanceLeaveRegularisationRequestApprove: function (cb, args) {
		makeRequest(cb, args, "API_URN_SELF_ATTENDANCE_LEAVE_REGULARISATION_REQUEST_APPROVE", "put");
	},

	// PUT self/attendance-leave-regularisation-request-reject - Reject a correction request (id, reason).
	StaffAttendanceLeaveRegularisationRequestReject: function (cb, args) {
		makeRequest(cb, args, "API_URN_SELF_ATTENDANCE_LEAVE_REGULARISATION_REQUEST_REJECT", "put");
	},
};
