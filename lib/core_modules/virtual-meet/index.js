...
const VirtualMeet = { // Public functions accessible by other modules
  ...
  *********************************************************************/
  getVirtualMeetListAdmin: function(cb, args){
    ...
    console.log(CONFIG['API_URN_GET_VIRTUAL_MEET_LIST_ADMIN']);
  ...
  editVirtualMeetSourcesAdmin: function(cb, args){

    // Construct params
    let params=args['params'];

    console.log(CONFIG['API_URN_EDIT_VIRTUAL_MEET_ADMIN']);
  ...
  updateVirtualMeetAdmin: function(cb, args){
    ...
    // Construct params
    let params=args['params'];
    console.log(CONFIG['API_URN_UPDATE_VIRTUAL_MEET_ADMIN']);
  ...
  deleteVirtualMeetAdmin: function(cb, args){
    ...
    console.log(CONFIG['API_URN_DELETE_VIRTUAL_MEET_ADMIN']);
  ...
  getVirtualMeetListParent: function(cb, args){
    ...
    console.log(CONFIG['API_URN_GET_VIRTUAL_MEET_LIST_PARENT']);
