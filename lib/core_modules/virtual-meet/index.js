...
const VirtualMeet = {
  ...
  *********************************************************************/
  ...
  viewSingleVirtualMeetAdmin: function (cb, args) {
    // Construct params
    let params = args["params"]
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_VIEW_VIRTUAL_SINGLE_MEET_ADMIN"], // api urn
      "get", // method
      params, // request-params
      args["auth"] // auth
    )
...
VirtualMeetShowOccurranceAdmin: function (cb, args) {
  ...
  VirtualMeetFollowingUpdateAdmin: function (cb, args) {
    // Construct params
    let params = args["params"]
    // http call
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_VIRTUAL_MEETING_SINGLE_FOLLOWING_UPDATE"], // api urn
      "post", // method
      params, // request-params
      args["auth"]
    )
