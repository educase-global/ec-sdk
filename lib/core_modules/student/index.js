...
const Student = {
  ...
  *********************************************************************/
  ...
  getPreAdmissionStudentListAdmin: function (cb, args) {
    // Construct params
    let params = args["params"]
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_GET_PRE_ADMISSION_STUDENT_LIST_ADMIN"], // api urn
      "get", // method
      params, // request-params
      args["auth"] // auth
    )
  },
  preAdmissionStudentExtendExpiryAdmin: function (cb, args) {
    // Construct params
    let params = args["params"]
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_GET_PRE_ADMISSION_STUDENT_EXTEND_EXPIRY_ADMIN"], // api urn
      "post", // method
      params, // request-params
      args["auth"] // auth
    )
  },
  studentPreAdmissionDeactivate: function (cb, args) {
    // Construct params
    let params = args["params"]
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_GET_PRE_ADMISSION_STUDENT_ADMISSION_DEACTIVATE_ADMIN"], // api urn
      "post", // method
      params, // request-params
      args["auth"] // auth
    )
  },
  studentPreAdmissionSendAlert: function (cb, args) {
    // Construct params
    let params = args["params"]
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_GET_PRE_ADMISSION_STUDENT_SEND_ALERT_ADMIN"], // api urn
      "post", // method
      params, // request-params
      args["auth"] // auth
    )
  ...
  addDynamicStudentAdmin: function (cb, args) {
    // Construct params
    let params = args["params"]
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_ADD_DYNAMIC_STUDENT_ADMIN"], // api urn
      "post", // method
      params, // request-params
      args["auth"] // auth
    )
  },
  dynamicStudentUpdateAdmin: function (cb, args) {
    // Construct params
    let params = args["params"]
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_UPDATE_DYNAMIC_STUDENT_ADMIN"], // api urn
      "post", // method
      params, // request-params
      args["auth"] // auth
    )
  ...
  getStudentEditAdmin: function (cb, args) {
    // Construct params
    let params = args["params"]
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_EDIT_DYNAMIC_STUDENT_ADMIN"], // api urn
      "get", // method
      params, // request-params
      args["auth"] // auth
    )
  },
getStudentShowAdmin: function (cb, args) {
    // Construct params
    let params = args["params"]
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_SHOW_DYNAMIC_STUDENT_ADMIN"], // api urn
      "get", // method
      params, // request-params
      args["auth"] // auth
    )
  ...
  studentExportAllProfilePhotoAdmin: function (cb, args) {
    // Construct params
    let params = args["params"]
    // http call
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_STUDENT_EXPORT_ALL_PROFILE_PHOTO_ADMIN"], // api urn
      "get", // method
      params, // request-params
      args["auth"]
    )
  ...
  FranchiseStudentFormSettingsAttributeDestroy: function (cb, args) {
    // Construct params
    let params = args["params"]
    // http call
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_STUDENT_FORM_SETTINGS_ATTRIBUTE_DELETE"], // api urn
      "post", // method
      params, // request-params
      args["auth"]
    )
  ...
  studentAEPSettingStore: function (cb, args) {
    // Construct params
    let params = args["params"]
    // http call
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_FRANCHISESTUDENT_AEP_SETTING_STORE"], // api urn
      "post", // method
      params, // request-params
      args["auth"]
    )
  },
   studentAEPSettingShow: function (cb, args) {
    // Construct params
    let params = args["params"]
    // http call
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_FRANCHISE_STUDENT_AEP_SETTING_SHOW"], // api urn
      "get", // method
      params, // request-params
      args["auth"]
    )
  ...
  studentAdmissionExtendExpiry: function (cb, args) {
    // Construct params
    let params = args["params"]
    // http call
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_STUDENT_AMISSION_EXTEND_EXPIRY"], // api urn
      "post", // method
      params, // request-params
      args["auth"]
    )
