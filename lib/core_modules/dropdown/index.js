...
const Dropdown = {
  ...
  *********************************************************************/
	...
	getProgramTypeDropdown: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_GET_PROGRAM_TYPE_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	getFranchiseClassDropdown: function (cb, args) {
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_GET_FRANCHISE_CLASS_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	getFranchiseStudentDropdown: function (cb, args) {
		let params = args["params"];

		// console.log(CONFIG["API_URN_GET_FRANCHISE_STUDENT_DROPDOWN"]);
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
					return cb(err); // Return error and exit
			...
			CONFIG["API_URN_GET_FRANCHISE_STUDENT_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	getConfigCurrentUserYear: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_GET_CONFIG_USER_YEAR"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	googleDriveTokenUpdate: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_GOOGLE_DRIVE_TOKEN_UPDATE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	franchiseGetCityDropdown: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_GET_CITY_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	franchiseGetStateDropdown: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_GET_STATE_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	franchiseGetSchoolDropdown: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_GET_SCHOOL_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	getStaffDropdownCommon: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_GET_STAFF_DROPDOWN_COMMON"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	getStudentDetailDropdown: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_GET_STUDENT_DETAIL_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	getInstallmentDropdownCommon: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_GET_INSTALLMENT_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	getTransportRouteDropdownCommon: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_GET_TRANSPORT_ROUTE_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
