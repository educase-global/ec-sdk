...
const Homework = {
  ...
  *********************************************************************/
  getHomeworkListAdmin: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_GET_HOMEWORK_LIST_ADMIN"])
  ...
  editHomeworkAdmin: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_EDIT_HOMEWORK_ADMIN"])
  ...
  updateHomeworkAdmin: function (cb, args) {
    // Construct params
    let params = args["params"]
    console.log(CONFIG["API_URN_UPDATE_HOMEWORK_ADMIN"])
  ...
  deleteHomeworkAdmin: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_DELETE_HOMEWORK_ADMIN"])
  ...
  getHomeworkDetailAdmin: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_DETAIL_HOMEWORK_LIST_ADMIN"])
  ...
  getHomeworkListParent: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_GET_HOMEWORK_LIST_PARENT"])
  ...
  getHomeworkDetailParent: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_GET_HOMEWORK_DETAIL_PARENT"])
  ...
  submitHomeworkParent: function (cb, args) {
    ...
    console.log(CONFIG["API_URN_SUBMIT_HOMEWORK_PARENT"])
