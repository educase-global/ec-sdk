  ...
  *********************************************************************/
	...
	StudentAttendancePickupStore: function (cb, args) {
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BUSTRACKING_STUDENT_ATTENDANCE_PICKUP_STORE_ADMIN"], // api urn
			"POST", // method
			params, // request-params
			args["auth"]
		);
	...
	StudentAttendancePickupList: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BUSTRACKING_STUDENT_ATTENDANCE_PICKUP_LIST_ADMIN"], // api urn
			"GET", // method
			params, // request-params
			args["auth"]
		);
	...
	StudentAttendanceGetDropList: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BUSTRACKING_STUDENT_ATTENDANCE_DROP_LIST_ADMIN"], // api urn
			"GET", // method
			params, // request-params
			args["auth"]
		);
