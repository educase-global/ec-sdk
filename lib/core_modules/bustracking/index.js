  ...
  *********************************************************************/
	...
	BusRouteView: function (cb, args) {
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BUSTRACKING_BUS_ROUTE_VIEW_ADMIN"], // api urn
			"get", // method
			params, // request-params
			args["auth"]
		);
	...
	BusSendAlertAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BUSTRACKING_SEND_ALERT_ADMIN"], // api urn
			"post", // method
			params, // request-params
			args["auth"]
		);
	...
	// POST bus-route-v2-store - Create a new bus route.
	BusRouteV2StoreAdmin: function (cb, args) {
		makeRequest(cb, args, "API_URN_BUSTRACKING_BUS_ROUTE_V2_STORE_ADMIN", "post");
	},

	// POST bus-route-v2-update - Update an existing bus route.
	BusRouteV2UpdateAdmin: function (cb, args) {
		makeRequest(cb, args, "API_URN_BUSTRACKING_BUS_ROUTE_V2_UPDATE_ADMIN", "post");
	},

	// POST bus-route-v2-destroy - Delete a bus route.
	BusRouteV2DeleteAdmin: function (cb, args) {
		makeRequest(cb, args, "API_URN_BUSTRACKING_BUS_ROUTE_V2_DESTROY_ADMIN", "post");
	},

	// GET bus-route-v2-show - Single bus route detail.
	BusRouteV2ShowAdmin: function (cb, args) {
		makeRequest(cb, args, "API_URN_BUSTRACKING_BUS_ROUTE_V2_SHOW_ADMIN", "get");
	},

	// GET bus-route-v2-table-data - Bus routes listing.
	getBusRouteV2TableDataAdmin: function (cb, args) {
		makeRequest(cb, args, "API_URN_BUSTRACKING_BUS_ROUTE_V2_TABLE_DATA_ADMIN", "get");
	},

	// GET bus-route-v2-drop-down - Bus route list for dropdowns.
	BusRouteV2DropdownAdmin: function (cb, args) {
		makeRequest(cb, args, "API_URN_BUSTRACKING_BUS_ROUTE_V2_DROP_DOWN_ADMIN", "get");
	},
	...
	BusJourneystore: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BUSTRACKING_BUS_JOURNEY_STORE_ADMIN"], // api urn
			"post", // method
			params, // request-params
			args["auth"]
		);
	...
	BusJourneyStopStatus: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BUSTRACKING_BUS_JOURNEY_STOP_STATUS_ADMIN"], // api urn
			"post", // method
			params, // request-params
			args["auth"]
		);
	},
	BusJourneyEndAdmin: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BUSTRACKING_BUS_JOURNEY_END_ADMIN"], // api urn
			"post", // method
			params, // request-params
			args["auth"]
		);
	...
	BusTrackingGpsLocationData: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BUSTRACKING_BUS_GET_TRACKING_LOCATION_GPS_DATA"], // api urn
			"get", // method
			params, // request-params
			args["auth"]
		);
	...
	BusTrackingStopLocationData: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BUSTRACKING_BUS_GET_TRACKING_STOPS_DATA"], // api urn
			"get", // method
			params, // request-params
			args["auth"]
		);
	...
	BusTrackingLiveLocation: function (cb, args) {
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BUSTRACKING_BUS_LIVE_LOCATION"],
			"get",
			params,
			args["auth"]
		);
	...
	BusJourneyStopList: function (cb, args) {
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BUSTRACKING_BUS_JOURNEY_STOP_LIST"],
			"get",
			params,
			args["auth"]
		);
	...
	BusJourneyGetdetailsParent: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BUSTRACKING_BUS_JOURNEY_GET_DETAILS_PARENT"], // api urn
			"get", // method
			params, // request-params
			args["auth"]
		);
	},
	BusGetAttendancedetailsParent: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_BUSTRACKING_BUS_GET_ATTENDANCE_DETAILS_PARENT"], // api urn
			"get", // method
			params, // request-params
			args["auth"]
		);
