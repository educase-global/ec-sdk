...
const CurriculumProvider = {
  ...
  *********************************************************************/
	...
	ProviderSettingEvaluationRemarkDropdown: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_SETTING_EVALUATION_REMARK_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	ProviderSchoolStore: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_SCHOOL_STORE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	ProviderSchoolTableData: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_SCHOOL_TABLE_DATA"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	ProviderCurriculumReorderChapter: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_CURRICULUM_REORDER_CHAPTER"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	ProviderCurriculumReorderChaptersTopic: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_CURRICULUM_REORDER_CHAPTER_TOPIC"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	ProviderCurriculumReorderChapterSubTopic: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_CURRICULUM_REORDER_CHAPTER_TOPIC_SUBTOPIC"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	ProviderCurriculumReorderChapterSubTopicContent: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_CURRICULUM_REORDER_CHAPTER_SUBTOPIC_CONTENT"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	ProviderUserModules: function (cb, args) {
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_PROVIDER_ACCOUNT_MODULES"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	ProviderStaffStore: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STAFF_STORE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	ProviderStaffShow: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STAFF_SHOW"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	ProviderStaffEdit: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STAFF_EDIT"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	ProviderStaffUpdate: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STAFF_UPDATE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	ProviderStaffUpdateStatus: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STAFF_UPDATE_STATUS"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	ProviderStaffDestroy: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STAFF_DESTROY"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	ProviderStaffUndoDestroy: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STAFF_UNDO_DESTROY"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	ProviderStaffTableData: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STAFF_TABLE_DATA"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	ProviderStaffDropdown: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STAFF_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	...
	ProviderStaffRolesStore: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STAFF_ROLES_STORE"],
			"post",
			params,
			args["auth"]
		);
	...
	ProviderStaffRolesEdit: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STAFF_ROLES_EDIT"],
			"get",
			params,
			args["auth"]
		);
	...
	ProviderStaffRolesUpdate: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STAFF_ROLES_UPDATE"],
			"post",
			params,
			args["auth"]
		);
	...
	ProviderStaffRolesUpdateStatus: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STAFF_ROLES_UPDATE_STATUS"],
			"post",
			params,
			args["auth"]
		);
	...
	ProviderStaffRolesDestroy: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STAFF_ROLES_DESTROY"],
			"post",
			params,
			args["auth"]
		);
	...
	ProviderStaffRolesUndoDestroy: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STAFF_ROLES_UNDO_DESTROY"],
			"post",
			params,
			args["auth"]
		);
	...
	ProviderStaffRolesTableData: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STAFF_ROLES_TABLE_DATA"],
			"get",
			params,
			args["auth"]
		);
	...
	ProviderStaffRolesDropdown: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STAFF_ROLES_DROPDOWN"],
			"get",
			params,
			args["auth"]
		);
	...
	ProviderStaffRightsPermissions: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STAFF_RIGHTS_PERMISSIONS"],
			"get",
			params,
			args["auth"]
		);
	...
	ProviderStaffRightsUpdatePermissions: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STAFF_RIGHTS_UPDATE_PERMISSIONS"],
			"post",
			params,
			args["auth"]
		);
	...
	ProviderStorageStore: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STORAGE_STORE"],
			"post",
			params,
			args["auth"]
		);
	},
	ProviderStorageEdit: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_STORAGE_EDIT"],
			"get",
			params,
			args["auth"]
		);
	...
	ProviderDashboardCurriculumStats: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_DASHBOARD_CURRICULUM_STATS"],
			"get",
			params,
			args["auth"]
		);
	},
	ProviderDashboardSchoolStats: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_DASHBOARD_SCHOOL_STATS"],
			"get",
			params,
			args["auth"]
		);
	},
	ProviderDashboardActivities: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_DASHBOARD_ACTIVITIES"],
			"get",
			params,
			args["auth"]
		);
	},
	ProviderDashboardCurriculumActivities: function (cb, args) {
		let params = args["params"];
		Lib.Commons.httpHandler(
			function (err, http_status, http_headers, data) {
				if (err) {
			...
			CONFIG["API_URN_PROVIDER_DASHBOARD_CURRICULUM_ACTIVITIES"],
			"get",
			params,
			args["auth"]
		);
