...
const Feedback = {
  ...
  *********************************************************************/
	...
	//********************************************************** Category Settings API'S*********************************************************************//

	addFeedbackCategory: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_FEEDBACK_CATEGORY_ADD"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	updateFeedbackCategory: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_FEEDBACK_CATEGORY_UPDATE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	getFeedbackCategoryDetail: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_GET_FEEDBACK_CATEGORY_DETAIL_ADMIN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	getFeedbackCategoryDropdown: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_REPLY_FEEDBACK_CATEGORY_DROPDOWN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	getFeedbackCategoryList: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_GET_FEEDBACK_CATEGORY_LIST_ADMIN"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	getFeedbackCategorySettingsDetails: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_FEEDBACK_SETTINGS_DETAILS"], // api urn
			"get", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	feedbackCategorySettingsStore: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_FEEDBACK_SETTINGS_STORE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	feedbackCategoryDestroy: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_FEEDBACK_CATEGORY_DESTROY"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
	},
	feedbackCategoryStatusUpdate: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_URN_FEEDBACK_CATEGORY_STATUS_UPDATE"], // api urn
			"post", // method
			params, // request-params
			args["auth"] // auth
		);
