  ...
  *********************************************************************/
  ...
  timeTableDataAdminMobile: function (cb, args) {
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_TIME_TABLE_DATA_ADMIN_MOB"], // api urn
      "get", // method
      params, // request-params
      args["auth"] // auth
    )
  ...
  timeTableCalendarDataAdmin: function (cb, args) {
    // Construct params
    let params = args["params"]
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_TIME_TABLE_CALENDAR_DATA_ADMIN"], // api urn
      "get", // method
      params, // request-params
      args["auth"] // auth
    )
  },
  timeTableCalendarDataStaff: function (cb, args) {
    // Construct params
    let params = args["params"]
    ...
    Lib.Commons.httpHandler(
      ...
      CONFIG["API_URN_TIME_TABLE_CALENDAR_DATA_STAFF"], // api urn
      "get", // method
      params, // request-params
      args["auth"] // auth
    )
