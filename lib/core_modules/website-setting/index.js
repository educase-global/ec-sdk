...
const WebsiteSetting = {
  ...
  *********************************************************************/
	websiteSettingStore: function (cb, args) {
		// Construct params
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_WEBSITE_SETTING_STORE"], // api urn
			"post", // method
	...
	websiteSettingShow: function (cb, args) {
		// Construct params
		let params = args["params"];
		...
		Lib.Commons.httpHandler(
			...
			CONFIG["API_WEBSITE_SETTING_SHOW"], // api urn
			"get", // method
			params, // request-params
			args["auth"], // auth
			null
