...
const GoogleGeoData = { // Public functions accessible by other modules
  ...
  *********************************************************************/
  createPlacesData: function(places_data){
    ...
    return places_data.map(
      function(address){

        console.log("test6 createPlacesData address ", address);

        console.log("test6 ", Lib.ContactData.createAddressData(
          {
            'address_id': null,
            'title': null,
            'type': null,
  ...
  *********************************************************************/
  createAddressData: function(geo_code_data, location){
    ...
    let address_data = GoogleGeoData.createAddressDataUS(geo_code_data['results'][0]['address_components'], location)
...
const _GoogleGeoData = {  // Private methods accessible within this modules only
  // None
