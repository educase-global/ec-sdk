...
const Commons = {
  ...
  *********************************************************************/
	httpHandler: function (
		...
		http_params,
		auth_bearer_token,
		apiVersion // this will decide which server to use php or node
	) {
		...
		Lib.HttpHandler.fetchJSON(
			...
			Lib.Commons.constructHttpURL(api_urn, apiVersion), //url
			http_method, // method
			http_params, // params
  ...
  *********************************************************************/
	constructHttpURL: function (api_urn, apiVersion) {
