...
function serveStaleAndRevalidate(cb, cacheKey, url, http_method, http_params, auth_bearer_token) {
...
const Commons = {
    ...
    httpHandler: function (cb, api_urn, http_method, http_params, auth_bearer_token) {
        ...
        serveStaleAndRevalidate(cb, cacheKey, url, http_method, http_params, auth_bearer_token);
    },
