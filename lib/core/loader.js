...
const loader = function (shared_libs, config_app) {
	...
	// Set Configrations
	const http_config = {
		TIMEOUT: 120000, // small value shoud cause timeout
		TIMEOUT: 120000, // In milliseconds (3 second). 0 means no timeout
	...
	const config_feedback = {
		...
		API_URN_REPLY_FEEDBACK_CATEGORY_DROPDOWN: "feedback-category-dropdown",
		API_URN_GET_FEEDBACK_CATEGORY_DETAIL_ADMIN: "feedback-category-detail",
		API_URN_GET_FEEDBACK_CATEGORY_LIST_ADMIN: "feedback-category-table-data",
		API_URN_FEEDBACK_CATEGORY_ADD: "feedback-category-add",
		API_URN_FEEDBACK_CATEGORY_DESTROY: "feedback-category-delete",
		API_URN_FEEDBACK_CATEGORY_STATUS_UPDATE: "feedback-category-change-status",
		API_URN_FEEDBACK_CATEGORY_UPDATE: "feedback-category-update",
		API_URN_FEEDBACK_SETTINGS_STORE: "feedback-settings-store",
		API_URN_FEEDBACK_SETTINGS_DETAILS: "feedback-settings-get",
	...
	const report_center = {
		// Admin Api urns
		API_URN_GET_REPORT_CENTER_LIST_ADMIN: "school/download-center-table-data",
		API_URN_GET_REPORT_CENTER_GENERATE_REPORT_ADMIN: "school/download-center-add",
		API_URN_GET_REPORT_CENTER_ADMIN_REPORT_DROPDOWN: "school/download-center-module-dropdown",
		API_URN_GET_REPORT_CENTER_ADMIN_REPORT_DETAIL: "school/download-center-module-detail",
		API_URN_GET_REPORT_CENTER_LIST_ADMIN_DELETE: "school/download-center-delete",

		//Franchise
		API_URN_GET_REPORT_CENTER_LIST_FRANCHISE: "franchise/download-center-table-data",
		API_URN_GET_REPORT_CENTER_LIST_FRANCHISE_DELETE: "franchise/download-center-delete",
		API_URN_GET_REPORT_CENTER_GENERATE_REPORT_FRANCHISE: "franchise/download-center-add",
		API_URN_GET_REPORT_CENTER_FRANCHISE_REPORT_DROPDOWN: "franchise/download-center-module-dropdown",
		API_URN_GET_REPORT_CENTER_FRANCHISE_REPORT_DETAIL: "franchise/download-center-module-detail",
	};
	...
	const config_homework = {
		...
		API_URN_GET_HOMEWORK_SETTINGS_UPDATE_ADMIN: "homework-settings-update",
		API_URN_GET_HOMEWORK_SETTINGS_SHOW_ADMIN: "homework-settings-show",
	...
	const config_progress_report = {
		...
		API_URN_PROGRESS_REPORT_MULTI_PAGER_RESTRICTION_SETTINGS: "franchise-school-rights-setting",
		...
		API_URN_PROGRESS_REPORT_RESULT_MARKS_PRINT_SHOW: "progress-report-multi-student-result",
		
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_STORE: "drb/template/store",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_LIST: "drb/template/list",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_EDIT: "drb/template/edit",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_UPDATE: "drb/template/update",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_DELETE: "drb/template/delete",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_ENTRY_STUDENTS: "drb/report/entry/students",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_PUBLISH: "drb/report/publish",
		API_URN_PROGRESS_REPORT_DYNAMIC_TEMPLATE_PUBLISH: "drb/template/publish",
		API_URN_PROGRESS_REPORT_DYNAMIC_ASSIGN_TEACHER: "drb/report/assign-teacher",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_ENTRY_SAVE: "drb/report/entry/save",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_ENTRY: "drb/report/entry",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_STORE: "drb/equivalence/store",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_LIST: "drb/equivalence/list",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_VIEW: "drb/equivalence/view",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_UPDATE: "drb/equivalence/update",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_DELETE: "drb/equivalence/delete",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_DROPDOWN: "drb/equivalence/dropdown",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_TEMPLATE_DROPDOWN: "drb/template-dropdown",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_STUDENTS_SHOW: "drb/report/students",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_VIEW: "drb/report/view",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_UPLOAD_IMAGE: "drb/upload-image",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_REMARK_STORE: "drb/remark/store",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_REMARK_LIST: "drb/remark/list",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_REMARK_DROPDOWN: "drb/remark/dropdown",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_REMARK_UPDATE: "drb/remark/update",
		API_URN_PROGRESS_REPORT_DYNAMIC_REPORT_REMARK_DELETE: "drb/remark/delete",
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_UPLOAD_PDF: "drb/report/upload-pdf",
		
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_STORE: "drb/franchise/equivalence/store",
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_LIST: "drb/franchise/equivalence/list",
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_VIEW: "drb/franchise/equivalence/view",
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_UPDATE: "drb/franchise/equivalence/update",
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_DELETE: "drb/franchise/equivalence/delete",
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_EQUIVALENCE_DROPDOWN: "drb/franchise/equivalence/dropdown",

		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_STORE: "drb/franchise/template/store",
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_LIST: "drb/franchise/template/list",
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_TEMPLATE_DROPDOWN: "drb/franchise/template-dropdown",
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_EDIT: "drb/franchise/template/edit",
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_UPDATE: "drb/franchise/template/update",
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_BUILDER_DELETE: "drb/franchise/template/delete",
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_STORE: "drb/franchise/report/store",
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_TABLE_DATA: "drb/franchise/report/table-data",
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_EDIT: "drb/franchise/report/edit",
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_UPDATE: "drb/franchise/report/update",
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_DELETE: "drb/franchise/report/delete",
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_REPORT_PUBLISH: "drb/franchise/report/publish",
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_TEMPLATE_PUBLISH: "drb/franchise/template/publish",
		
		API_URN_FRANCHISE_PROGRESS_REPORT_DYNAMIC_STUDENT_WISE_ATTENDANCE_REPORT: "student-wise-attendance-report",
	};
	...
	const config_diary = {
		...
		API_URN_FRANCHISER_DIARY_TEMPLATE_LIST: "franchiser/diary-template-list",
		API_URN_FRANCHISER_DIARY_TEMPLATE_EXCLUDE_SCHOOLS: "franchiser/diary-template-exclude-schools",
		API_URN_FRANCHISER_DIARY_TEMPLATE_STORE: "franchiser/diary-template-store",
		API_URN_FRANCHISER_DIARY_TEMPLATE_SHOW: "franchiser/diary-template-show",
		API_URN_FRANCHISER_DIARY_TEMPLATE_UPDATE: "franchiser/diary-template-update",
		API_URN_FRANCHISER_DIARY_TEMPLATE_TOGGLE_STATUS: "franchiser/diary-template-toggle-status",
		API_URN_FRANCHISER_DIARY_TEMPLATE_DESTROY: "franchiser/diary-template-destroy",
		API_URN_FRANCHISER_DIARY_TEMPLATE_DROPDOWN: "franchiser/diary-template-dropdown",
		API_URN_FRANCHISER_DIARY_FORM_COMPONENT: "franchiser/diary-form-component",

		API_URN_FRANCHISER_DIARY_OPTION_LIST: "franchiser/diary-option-list",
		API_URN_FRANCHISER_DIARY_OPTION_STORE: "franchiser/diary-option-store",
		API_URN_FRANCHISER_DIARY_OPTION_CHILD_STORE: "franchiser/diary-option-child-store",
		API_URN_FRANCHISER_DIARY_OPTION_SHOW: "franchiser/diary-option-show",
		API_URN_FRANCHISER_DIARY_OPTION_UPDATE_SINGLE: "franchiser/diary-option-update-single",
		API_URN_FRANCHISER_DIARY_OPTION_UPDATE: "franchiser/diary-option-update",
		API_URN_FRANCHISER_DIARY_OPTION_DELETE: "franchiser/diary-option-delete",
		API_URN_FRANCHISER_DIARY_OPTION_CHILD_DELETE: "franchiser/diary-option-child-delete",
		API_URN_FRANCHISER_DIARY_OPTION_TYPE_DROPDOWN: "franchiser/diary-option-type-dropdown",
		API_URN_FRANCHISER_DIARY_OPTION_PARENT_STORE: "franchiser/diary-option-parent-store",
		API_URN_FRANCHISER_DIARY_OPTION_PARENT_UPDATE: "franchiser/diary-option-update-parent",
		API_URN_FRANCHISER_DIARY_OPTION_PARENT_DELETE: "franchiser/diary-option-parent-delete",
		API_URN_ADMIN_DIARY_STUDENT_SHOW: "branch/diary-student-show",
		API_URN_ADMIN_DIARY_LIST: "branch/diary-list",
		API_URN_ADMIN_DIARY_EDIT_SHOW: "branch/diary-edit-show",
		API_URN_ADMIN_DIARY_STUDENT_LIST: "branch/diary-student-list",
		API_URN_ADMIN_DIARY_UPDATE: "branch/diary-update",
		API_URN_ADMIN_DIARY_STATUS_UPDATE: "branch/diary-status-update",
		API_URN_ADMIN_DIARY_PIN_UNPIN: "branch/diary-pin-unpin",
		API_URN_ADMIN_DIARY_TEMPLATE_SHOW: "branch/diary-template-show",
		API_URN_ADMIN_DIARY_TEMPLATE_DROPDOWN: "branch/diary-template-dropdown",
		API_URN_ADMIN_DIARY_SHOW: "branch/diary-show",
		API_URN_ADMIN_DIARY_STORE: "branch/diary-store",
		API_URN_ADMIN_DIARY_DESTROY: "branch/diary-destroy",
		API_URN_ADMIN_DIARY_MEDIA_DELETE: "branch/diary-media-delete",
		API_URN_STUDENT_DIARY_LIST: "student/diary-list",
		API_URN_STUDENT_DIARY_SHOW: "student/diary-show",
		API_URN_STUDENT_DIARY_READ: "student/diary-read",
		API_URN_STUDENT_DIARY_ACKNOWLEDGE: "student/diary-acknowledge",
		API_URN_STUDENT_DIARY_FEEDBACK: "student/diary-feedback",
		API_URN_STUDENT_DIARY_ACKNOWLEDGEMENT_LIST: "diary-acknowledgement-list",
		API_URN_STUDENT_DIARY_CATEGORY_LIST: "student/diary-category-list",
		API_URN_STUDENT_DIARY_META_DATA: "student/diary-meta",
		API_URN_STUDENT_DIARY_TEMPLATE_DROPDOWN: "student/diary-template-dropdown",
	};
	...
	const config_attendance = {
		...
		API_URN_GET_STUDENT_ATTENDANCE_DETAIL: "student/attendance-detail",
	...
	const config_mealcalendar = {
		...
		API_URN_GET_MENU_NAME_IMPORT: "menu-name-import",
		API_URN_GET_MENU_NAME_GENERATE: "menu-name-generate",
	...
	const config_teacherComment = {
		...
		API_URN_TEACHER_COMMENT_STUDENT_DROPDOWN_ADMIN: "teacher-comment-student-dropdown",

		API_URN_TEACHER_COMMENT_CATEGORY_STORE_ADMIN: "/teacher-comment-category-store",
		API_URN_TEACHER_COMMENT_CATEGORY_EDIT_ADMIN: "teacher-comment-category-edit",
		API_URN_TEACHER_COMMENT_CATEGORY_UPDATE_ADMIN: "teacher-comment-category-update",
		API_URN_TEACHER_COMMENT_CATEGORY_DESTROY_ADMIN: "teacher-comment-category-destroy",
		API_URN_TEACHER_COMMENT_CATEGORY_TABLE_DATA_ADMIN: "teacher-comment-category-table-data",
		API_URN_TEACHER_COMMENT_CATEGORY_DROPDOWN_ADMIN: "teacher-comment-category-dropdown",
		API_URN_TEACHER_COMMENT_CATEGORY_STATUS_UPDATE_ADMIN: "teacher-comment-category-status-update",
	...
	const config_enquiry = {
		...
		API_URN_STUDENT_ENQUIRY_GENERATE_FORM: "student-enquiry-generate-form",
		...
		API_URN_ENQUIRY_FOLLOWUP_LEAD_STAGE_DROPDOWN: "enquiry-lead-stage-dropdown",
		API_URN_ENQUIRY_CONVERT: "enquiry-convert",
		API_URN_ENQUIRY_CONVERT_PRE_ADMISSION: "enquiry-admission-student-config",
		API_URN_PRE_ADMISSION_STUDENT_GET_PAYMENT_STATUS: "student-admission-get-payment",
	...
	const config_meet = {
		...
		API_URN_VIEW_VIRTUAL_SINGLE_MEET_ADMIN: "meeting-single-show",
		API_URN_VIRTUAL_MEETING_CALENDER_ADMIN: "meeting-calendar",
		API_URN_VIRTUAL_MEETING_SHOW_PARTICIPANTS_ADMIN: "meeting-show-participants",
		API_URN_VIRTUAL_MEETING_SHOW_OCCURRENCE_ADMIN: "meeting-show-occurrence",
		API_URN_VIRTUAL_MEETING_SHOW_ATTENDANCE_OCCURRENCE_ADMIN: "meeting-show-occurrence-participants",
		API_URN_VIRTUAL_MEETING_DESTROY_SINGLE_ADMIN: "meeting-single-destroy",
		API_URN_VIRTUAL_MEETING_CANCEL_ADMIN: "meeting-cancel",
		API_URN_VIRTUAL_MEETING_JOIN_ADMIN: "meeting-join",
		API_URN_VIRTUAL_MEETING_SINGLE_SHOW: "meeting-single-edit",
		API_URN_VIRTUAL_MEETING_SINGLE_UPDATE: "meeting-single-update",
		API_URN_VIRTUAL_MEETING_SINGLE_FOLLOWING_UPDATE: "meeting-following-update",
		API_URN_VIRTUAL_MEETING_SINGLE_CANCEL: "meeting-single-cancel",
		...
		API_URN_STUDENT_MEETING_SHOW: "student/meeting-show",
		API_URN_STUDENT_MEETING_SHOW_PARTICIPANTS: "student/meeting-show-participants",
		API_URN_STUDENT_MEETING_CALENDAR: "student/meeting-calendar",
		API_URN_STUDENT_MEETING_JOIN: "student/meeting-join"
	};

	const config_student = {
		// Api urns
		API_URN_GET_STUDENT_LIST_ADMIN: "student-table-data",
		API_URN_GET_PRE_ADMISSION_STUDENT_LIST_ADMIN: "student-admission-table-data",
		API_URN_GET_PRE_ADMISSION_STUDENT_EXTEND_EXPIRY_ADMIN: "student-admission-extend-expiry",
		API_URN_GET_PRE_ADMISSION_STUDENT_ADMISSION_DEACTIVATE_ADMIN: "student-admission-deactivate",
		API_URN_GET_PRE_ADMISSION_STUDENT_SEND_ALERT_ADMIN: "student-admission-send-alert",
		API_URN_GET_STUDENT_FORM_SETTINGS_ADMIN: "school/student-form-detail",
		API_URN_ADD_STUDENT_ADMIN: "student-store",
		API_URN_ADD_DYNAMIC_STUDENT_ADMIN: "dynamic-form/student-store",
		API_URN_EDIT_DYNAMIC_STUDENT_ADMIN: "dynamic-form/student-edit",
		API_URN_SHOW_DYNAMIC_STUDENT_ADMIN: "dynamic-form/student-show",
		API_URN_UPDATE_DYNAMIC_STUDENT_ADMIN: "dynamic-form/student-update",
		...
		API_URN_STUDENT_BONAFIDE_HEADER_SIGNATURE_STORE_ADMIN: "transfer-certificate-signature-store",
		API_URN_STUDENT_BONAFIDE_HEADER_SIGNATURE_SHOW_ADMIN: "transfer-certificate-signature-edit",
		API_URN_STUDENT_BONAFIDE_HEADER_DELETE_ADMIN: "transfer-certificate-destroy-school-header",
		API_URN_STUDENT_BONAFIDE_SIGNATURE_DELETE_ADMIN: "transfer-certificate-destroy-Bonafide-signature",
		...
		API_URN_STUDENT_CHANGE_RTE_STATUS_ADMIN: "student-change-rte",
		API_URN_STUDENT_UPGRADE_ADMIN: "student-upgrade",
		API_URN_STUDENT_MULTIPLE_UPGRADE_ADMIN: "student-upgrade-multi",
		...
		API_URN_STUDENT_APPLY_CLASS_FEE_CONFIRMATION_ADMIN: "admission-dropdown",
		...
		API_URN_STUDENT_FORM_SETTINGS_SHOW: "franchise/student-form-edit",
		API_URN_STUDENT_FORM_SETTINGS_UPDATE: "franchise/student-form-update",
		API_URN_STUDENT_FORM_SETTINGS_ATTRIBUTE_DELETE: "franchise/delete-student-form-field",

		API_URN_FRANCHISESTUDENT_AEP_SETTING_STORE: "franchise/student-aep-setting/store-update",
		API_URN_FRANCHISE_STUDENT_AEP_SETTING_SHOW: "franchise/student-aep-setting/edit",
		...
		API_URN_STUDENT_AMISSION_EXTEND_EXPIRY: "admission-extend",
		...
		API_URN_STUDENT_AMISSION_CONFIRMATION_UPDATE_STUDENT: "admission-update-student",
		API_URN_STUDENT_AMISSION_CONFIRMATION_DELETE_STUDENT: "admission-delete-student",
		API_URN_STUDENT_AMISSION_STUDENT_CHANGE_STATUS_CONFIRM: "admin/admission-accept",
		API_URN_STUDENT_AMISSION_STUDENT_CHANGE_STATUS_CANCEL: "admin/admission-reject",
	...
	const config_e_learning = {
		...
		API_URN_TUTORIAL_DESTROY_LINK_ADMIN: "tutorial-destroy-link",
		...
		// ----------------------------- E-Learning Assessment API's Parent ----------------------------- //
		...
		API_URN_GET_TUTORIAL_LIST_FRANCHISE: "franchise/tutorial-table-data",
		API_URN_DELETE_TUTORIAL_FRANCHISE: "franchise/tutorial-destroy",
		API_URN_EDIT_TUTORIAL_FRANCHISE: "franchise/tutorial-edit",
		API_URN_UPDATE_TUTORIAL_FRANCHISE: "franchise/tutorial-update",
		API_URN_ADD_TUTORIAL_FRANCHISE: "franchise/tutorial-store",
		API_URN_VIEW_TUTORIAL_FRANCHISE: "franchise/tutorial-show",
		API_URN_TUTORIAL_DESTROY_LINK_FRANCHISE: "franchise/tutorial-destroy-link",
		API_URN_DELETE_DOCUMENT_FRANCHISE: "franchise/tutorial-destroy-document",
		API_URN_SUBJECT_DROPDOWN: "subject-dropdown",
		API_URN_E_LEARNING_BRANCH_DROPDOWN_FRANCHISE: "franchise/e-learning-branch-dropdown",


		// ----------------------------- E-Learning Category API's Franchise ----------------------------- //
		API_URN_GET_CATEGORY_LIST_FRANCHISE: "franchise/tutorial-category-table-data",
		API_URN_DELETE_CATEGORY_FRANCHISE: "franchise/tutorial-category-destroy",
		API_URN_EDIT_CATEGORY_FRANCHISE: "franchise/tutorial-category-edit",
		API_URN_UPDATE_CATEGORY_FRANCHISE: "franchise/tutorial-category-update",
		API_URN_ADD_CATEGORY_FRANCHISE: "franchise/tutorial-category-store",
		API_URN_VIEW_CATEGORY_FRANCHISE: "franchise/tutorial-category-show",
		API_URN_VIEW_CATEGORY_DROPDOWN_FRANCHISE: "franchise/tutorial-category-dropdown",

		// ----------------------------- E-Learning Digital Content API's Franchise ----------------------------- //
		API_URN_ADD_DIGITAL_CONTENT_FRANCHISE: "franchise/digital-content-store",
		API_URN_GET_DIGITAL_CONTENT_LIST_FRANCHISE: "franchise/digital-content-table-data",
		API_URN_EDIT_DIGITAL_CONTENT_FRANCHISE: "franchise/digital-content-edit",
		API_URN_UPDATE_DIGITAL_CONTENT_FRANCHISE: "franchise/digital-content-update",
		API_URN_DELETE_DIGITAL_CONTENT_FRANCHISE: "franchise/digital-content-destroy",
	...
	const config_insta = {
		...
		API_URN_GET_ENHANCE_TEXT: "enhance-text",
		API_URN_INSTA_ALERT_UPDATE_IS_PINNED: "insta-alert-update-is-pinned",
	};
	...
	const config_daycare = {
		...
		API_URN_REALLOCATE_STUDENT_ADMIN: "re-allocate-student-update",
		...
		API_URN_STUDENT_GENERATE_BILL_QUATERWISE_ADMIN: "daycare-quater-month",
		...
		API_URN_STUDENT_IN_OUT_HISTORY_EXPORT_ADMIN: "student-in-out-history-export",
		...
		API_URN_DAYCARE_CORPORATE_BILL_GENERATE: "corporate-generate-bill-store",
		API_URN_DAYCARE_CORPORATE_BILL_LIST: "corporate-bill-list",
		API_URN_DAYCARE_CORPORATE_BILL_VIEW: "corporate-bill-view",
		API_URN_DAYCARE_CORPORATE_BILL_UPDATE: "corporate-bill-update",
		API_URN_DAYCARE_CORPORATE_BILL_DELETE: "corporate-bill-delete",
		API_URN_DAYCARE_CORPORATE_BILL_INVOICE_SEQUENCE: "corporate-bill-invoice-sequence",
		API_URN_DAYCARE_CORPORATE_BILLING_DETAIL: "corporate-billing-detail",
		API_URN_DAYCARE_CORPORATE_BILLING_COLLECT: "corporate-billing-collect",
		API_URN_DAYCARE_CORPORATE_BILL_HTML: "generate-corporate-bill-html",
		API_URN_DAYCARE_CORPORATE_BILL_RECURRING_RULE_DETAIL: "corporate-recurring-rule-detail",
		API_URN_DAYCARE_CORPORATE_BILL_RECURRING_RULE_STATE: "corporate-recurring-rule-state",
		API_URN_DAYCARE_CORPORATE_BILL_RECURRING_RULE_UPDATE: "corporate-recurring-rule-update",
		API_URN_DAYCARE_CORPORATE_BILL_RECURRING_RULES: "corporate-recurring-rules",
		API_URN_DAYCARE_CORPORATE_BILL_PUBLISH: "publish-corporate-bill",
	};
	...
	const config_events = {
		...
		API_URN_GET_EVENT_EXPORT_EXCEL_ADMIN: "event-export-Excel",
		API_URN_GET_EVENT_IMPORT_EXCEL_ADMIN: "event-import-event-excel",
		...
		API_URN_SPECIAL_EVENT_TABLE_DATA_ADMIN: "special-event-table-data",
		API_URN_VIEW_SPECIAL_EVENT_ADMIN: "special-event-view",
		API_URN_SPECIAL_EVENT_STATUS_UPDATE_ADMIN: "event-change-status",
		API_URN_STUDENT_WISE_LIST_EVENT_REMARK_UPDATE_ADMIN: "special-event-remark-update",
		API_URN_VIEW_SPECIAL_EVENT_DELETE_ADMIN: "special-event-row-delete",
		API_URN_STUDENT_WISE_EVENT_TABLE_DATA_ADMIN: "student-wise-event-table-data",
		API_URN_VIEW_STUDENT_WISE_EVENT_ADMIN: "student-wise-event-view",
	...
	const config_birthday = {
		...
		API_URN_BIRTHDAY_TEMPLATE_TABLE_DATA: "birthday-template-table-data",
		API_URN_BIRTHDAY_TEMPLATE_DROPDOWN: "birthday-template-dropdown",
		API_URN_BIRTHDAY_TEMPLATE_STORE: "birthday-template-store",
		API_URN_BIRTHDAY_TEMPLATE_EDIT: "birthday-template-edit",
		API_URN_BIRTHDAY_TEMPLATE_UPDATE: "birthday-template-update",
		API_URN_BIRTHDAY_TEMPLATE_DESTROY: "birthday-template-destroy",
	};
	...
	const config_fee = {
		...
		API_URN_FEE_MANAGEMENT_ADMIN_FEE_CUSTOMIZE_SETTING_EDIT: "franchise/configration/fee-customize-setting-edit",
		...
		API_URN_DELETED_STUDENT_FEE_CONFIGURATION_ADMIN: "remove-student-fee-configration",
		...
		API_URN_STUDENT_FEE_TYPE_REPORT_ADMIN: "fee-type-report",
		API_URN_STUDENT_FEE_INSTALLMENT_DATA_FEE_TYPE_EXPORT_ADMIN: "fee-type-export",
		API_URN_STUDENT_FEE_INSTALLMENT_DATA_STUDENT_WISE_FEE_TYPE_EXPORT_ADMIN: "student-wise-fee-export",
		...
		API_URN_STUDENT_FEE_RECEIPT_DATA_FRANCHISE: "franchise/student-fee-receipt-data",
		...
		API_URN_FEE_DISCOUNT_EDIT_CUSTOMIZE: "student-customize-fee-discount-drop-down",
		...
		API_URN_FEE_EXPORT_UNPAID_REPORT_ADMIN: "export-pending-student-daycare-bill",
		API_URN_FEE_EXPORT_PAID_REPORT_ADMIN: "export-paid-student-daycare-bill",
		API_URN_DAYCARE_FEE_EXPORT_DETAIL_REPORT_ADMIN: "export-collect-fee-report-data",
		...
		API_URN_ADDITIONAL_COLLECTION_FEES_TABLE_DATA_ADMIN: "additional-fee-collection-report-table-data",
		...
		API_MODULE_PAYMENT_GATEWAY_REPORT_ADMIN: "school/payment-settlement-transaction-list",
		API_MODULE_PAYMENT_GATEWAY_REPORT_ADMIN_STUDENT_WISE: "school/payment-settlement-transaction-detail",
		...
		API_MODULE_STUDENT_FEE_ADDITIONAL_FEE_VIEW_PRINT: "additional-print-receipt",
	...
	const config_configuration = {
		...
		API_URN_DESIGNATION_SETTING_UPDATE_ADMIN: "designation-setting-update",
		API_URN_DESIGNATION_SETTING_UPDATE_FRANCHISE: "franchise/designation-setting-update",
		...
		API_URN_ADMIN_DESIGNATION_LIST: "designation-dropdown",
		...
		API_URN_SCHOOL_ADMIN_SOCIAL_LINKS_EDIT: "social-links-school-edit",
		API_URN_SCHOOL_ADMIN_SOCIAL_LINKS_UPDATE: "social-links-school-update",
		...
		API_URN_GET_DATA_APP_VERSION_UPGRADE: "version",
		API_URN_UPGRADE_APP_UPDATE: "version/update",
		API_URN_SCHOOL_GEOFENCE_SETTINGS_SHOW: "geofence/settings",
		API_URN_SCHOOL_GEOFENCE_SETTINGS_STORE: "geofence/settings",
		API_URN_SCHOOL_GEOFENCE_MODULES_SHOW: "geofence/modules",
		API_URN_SCHOOL_GEOFENCE_MODULES_STORE: "geofence/modules",
		API_URN_SCHOOL_GEOFENCE_CONFIG_SHOW: "geofence/config",
	};
	...
	const config_dropdown = {
		...
		API_URN_GET_CONFIG_USER_YEAR: "admission-year-dropdown",
		...
		API_URN_GET_STAFF_DROPDOWN_COMMON: "staff-dropdown",
		API_URN_GET_STUDENT_DETAIL_DROPDOWN: "student-detail-dropdown",
		API_URN_GET_INSTALLMENT_DROPDOWN: "installment-dropdown",
		API_URN_GET_TRANSPORT_ROUTE_DROPDOWN: "bus-route-drop-down",
	};
	...
	const config_staff = {
		...
		API_URN_FRANCHISE_STAFF_SHOW_MULTIPLE: "franchise/staff-show-multiple",
	...
	const config_auth = {
		...
		API_URN_GET_FRANCHISER_STAFF_SWITCH_BRANCH_LIST: "franchiser-staff-switch-branch-list",
		API_URN_FRANCHISER_STAFF_SWITCH_BRANCH_UPDATE: "franchiser-staff-switch-branch",
		API_URN_USER_TABLE_PREFERENCES: "user-table-preferences",
		API_URN_USER_TABLE_PREFERENCES_LIST: "user-table-preferences-list",
		API_URN_USER_TABLE_PREFERENCES_SINGLE_ID: "user-table-preferences",
		API_URN_FORGOT_USERNAME: "forgot-username",
		API_URN_VERIFY_USERNAME: "verify-username",
		API_URN_SET_SECURITY_PIN: "set-security-pin",
		API_URN_SET_SECURITY_QUESTION: "set-security-question",
		API_URN_SECURITY_QUESTIONS: "security-questions",
		API_URN_PUBLIC_SECURITY_QUESTIONS: "public/security-questions",
		API_URN_VERIFY_SECURITY_CREDENTIAL: "verify-security-credential",
		API_URN_RESET_PASSWORD: "reset-password",
		API_URN_SEND_STAFF_OTP: "send-staff-otp",
		API_URN_VERIFY_STAFF_OTP: "verify-staff-otp",
	};
	...
	const config_shared = {
		...
		// Node Api Urls
		API_URL_NODEJS_SB: config_app["API_URL_NODEJS_SB"],
		API_URL_NODEJS_PROD: config_app["API_URL_NODEJS_PROD"],
	...
	const config_sms_email = {
		...
		API_URN_MANAGE_BLUK_SMS_STORE_FRANCHISE: "franchise/manage-bulk-school-sms-store",
		API_URN_MANAGE_SMS_FRANCHISE_DEALLOCATION: "franchise/manage-deallocate-school-sms-store",
		API_URN_MANAGE_SMS_FRANCHISE_SETTINGS_STORE: "franchise/sms-setting-store-update",
		API_URN_MANAGE_SMS_FRANCHISE_SETTINGS_SHOW: "franchise/sms-setting-show",
		API_URN_MANAGE_SMS_FRANCHISE_MODULE_LIST_SHOW: "franchise/sms-module-list",
		API_URN_MANAGE_SMS_MODULE_LIST_STORE: "franchise/sms-module-store-update",
		...
		//Franchise WhatsApp
		API_URN_CREATE_WHATSAPP_TEMPLATE_FRANCHISE: "franchise/whatsapp-template-store",
		API_URN_DELETE_WHATSAPP_TEMPLATE_FRANCHISE: "franchise/whatsapp-template-destroy",
		API_URN_GET_WHATSAPP_TEMPLATE_LIST_FRANCHISE: "franchise/whatsapp-template-table-data",
		API_URN_GET_WHATSAPP_TEMPLATE_SYNC_FRANCHISE: "franchise/whatsapp-template-sync",
		API_URN_GET_WHATSAPP_TEMPLATE_SYNC_TEMPLATE_COPY_FRANCHISE: "franchise/whatsapp-media-upload",
		API_URN_GET_WHATSAPP_TEMPLATE_FB_TABLE_DATA_FRANCHISE: "franchise/whatsapp-template-fb-table-data",
		//Module Dropdown
		API_URN_GET_WHATSAPP_TEMPLATE_MODULE_DROPDOWN_FRANCHISE: "franchise/whatsapp-module-dropdown",
		API_URN_GET_WHATSAPP_TEMPLATE_SUB_MODULE_DROPDOWN_FRANCHISE: "franchise/whatsapp-submodule-dropdown",

		//SETTINGS
		//SETTING CONFIGURATION 
		API_URN__WHATSAPP_PHONE_VERIFY_CODE_FRANCHISE: "franchise/whatsapp-phone-verify-code",
		API_URN__WHATSAPP_PHONE_REQUEST_CODE_FRANCHISE: "franchise/whatsapp-phone-request-code",
		API_URN__WHATSAPP_SETTING_STORE_FRANCHISE: "franchise/whatsapp-setting-store",
		API_URN__WHATSAPP_SETTING_SHOW_FRANCHISE: "franchise/whatsapp-setting-get",
		API_URN__WHATSAPP_SETTING_GET_PHONEID_FRANCHISE: "franchise/whatsapp-phone-id",
		API_URN__WHATSAPP_SETTING_REGISTER_PHONE_FRANCHISE: "franchise/whatsapp-phone-register",
		API_URN__WHATSAPP_SETTING_PHONE_SET_VERIFY_FRANCHISE: "franchise/whatsapp-phone-set-verify",
		//SETTING MODULES
		API_URN__WHATSAPP_MODULES_STORE_FRANCHISE: "franchise/whatsapp-module-store",
		API_URN__WHATSAPP_MODULES_SHOW_FRANCHISE: "franchise/whatsapp-module-show",

		//BRODCAST
		API_URN__WHATSAPP_BROADCAST_CVS_GENERATE_FRANCHISE: "franchise/whatsapp-broadcast-csv-generate",
		API_URN__WHATSAPP_BROADCAST_STATS_FRANCHISE: "franchise/whatsapp-broadcast-stats",
		API_URN__WHATSAPP_BROADCAST_TABLE_LIST_FRANCHISE: "franchise/whatsapp-broadcast-table-data",
		API_URN__WHATSAPP_BROADCAST_CVS_IMPORT_FRANCHISE: "franchise/whatsapp-broadcast-csv-import",
		API_URN__WHATSAPP_BROADCAST_EXPORT_FRANCHISE: "franchise/whatsapp-broadcast-export-details",

		//CONVERSATION 
		API_URN_WHATSAPP_CONVERSATION_LIST_FRANCHISE: "franchise/whatsapp-conversation-list",
		API_URN_WHATSAPP_CONVERSATION_DETAIL_FRANCHISE: "franchise/whatsapp-conversation-detail",
		API_URN_WHATSAPP_CONVERSATION_ASSIGN_CHAT_FRANCHISE: "franchise/whatsapp-conversation-assign",
		API_URN_WHATSAPP_CONVERSATION_SEND_MESSAGE_FRANCHISE: "franchise/whatsapp-conversation-send-message",
		API_URN_WHATSAPP_CONVERSATION_SEND_TEMPLATE_FRANCHISE: "franchise/whatsapp-conversation-send-template",
		//LIBRARY
		API_URN__WHATSAPP_MODULES_LIBRARY_SHOW_FRANCHISE: "franchise/whatsapp-library-show",
		//LOG
		API_URN__WHATSAPP_LOG_LIST_SHOW_FRANCHISE: "franchise/whatsapp-log-list",
		//USER
		API_URN_WHATSAPP_USER_STORE_FRANCHISE: "franchise/whatsapp-user-store",
		API_URN_WHATSAPP_USER_UPDATE_FRANCHISE: "franchise/whatsapp-user-update",
		API_URN_WHATSAPP_USER_EDIT_FRANCHISE: "franchise/whatsapp-user-edit",
		API_URN_WHATSAPP_USER_LIST_FRANCHISE: "franchise/whatsapp-user-list",

		// API_URN_ENQUIRY_WHATSAPP_AUTOMATION_STORE_FRANCHISE: "/franchise/enquiry-automation-store",
		// API_URN_ENQUIRY_WHATSAPP_AUTOMATION_EDIT_FRANCHISE: "/franchise/enquiry-automation-edit",
		// API_URN_ENQUIRY_WHATSAPP_AUTOMATION_TEMPLATE_DROPDOWN_FRANCHISE: "/franchise/enquiry-automation-template-dropdown",
		// API_URN_ENQUIRY_WHATSAPP_AUTOMATION_UPDATE_FRANCHISE: "/franchise/enquiry-automation-update",
		// API_URN_ENQUIRY_WHATSAPP_AUTOMATION_TABLE_DATA_FRANCHISE: "/franchise/enquiry-automation-table-data",
		// API_URN_ENQUIRY_WHATSAPP_AUTOMATION_DELETE_FRANCHISE: "/franchise/enquiry-automation-destroy",
	...
	const config_year_management = {
		...
		API_URN_NEXT_ACADEMIC_YEAR_ADMIN: "get-next-academic-year",
	...
	const config_time_table = {
		...
		API_URN_TIME_TABLE_CALENDAR_DATA_STAFF: "staff/time-table-calendar-data",
	...
	const config_public = {
		...
		API_URN_GET_APP_MODULE_LIST: "get-app-module",
	...
	const config_our_centers = {
		...
		API_URN_OUR_CENTERS_SCHOOL_STATE_CITY_DETAILS: "school-dropdown",
	}
	...
	const config_dashboard = {
		...
		API_URN_FRANCHISE_DASHBOARD_CLASS_STUDENT_COUNT: "franchise-dashboard-class-student-count",
		API_URN_FRANCHISE_DASHBOARD_FEE_TYPE_SHOW_LIST: "franchise-feeFranchiseDashboard",
		API_URN_FRANCHISE_DASHBOARD_STUDENT_CATEGORY_COUNT: "franchise-dashboard-student-category-count"
	};
	...
	const config_student_transfer = {
		API_URN_FRANCHISE_STUDENT_TRANSFER_TABLE_DATA: "franchise/student-transfer/table-data",
		API_URN_FRANCHISE_STUDENT_TRANSFER_ACCEPT: "franchise/student-transfer/accept",
		API_URN_FRANCHISE_STUDENT_TRANSFER_REJECT: "franchise/student-transfer/reject",

		API_URN_FRANCHISE_STUDENT_TRANSFER_SETTING_STORE: "franchise/student-transfer-setting/store",
		API_URN_FRANCHISE_STUDENT_TRANSFER_SETTING_UPDATE: "franchise/student-transfer-setting/update",
		API_URN_FRANCHISE_STUDENT_TRANSFER_SETTING_DETAILS: "franchise/student-transfer-setting/details",

		API_URN_FRANCHISE_STUDENT_TRANSFER_POLICY_TABLE_DATA: "franchise/student-transfer-policy/table-data",
		API_URN_FRANCHISE_STUDENT_TRANSFER_POLICY_SHOW: "franchise/student-transfer-policy/show",
		API_URN_FRANCHISE_STUDENT_TRANSFER_POLICY_STORE: "franchise/student-transfer-policy/store",
		API_URN_FRANCHISE_STUDENT_TRANSFER_POLICY_UPDATE: "franchise/student-transfer-policy/update",
		API_URN_FRANCHISE_STUDENT_TRANSFER_POLICY_DELETE: "franchise/student-transfer-policy/delete",
		API_URN_FRANCHISE_STUDENT_TRANSFER_POLICY_ADD_TERMS: "franchise/student-transfer-policy/add-terms",
		API_URN_FRANCHISE_STUDENT_TRANSFER_POLICY_DELETE_TERMS: "franchise/student-transfer-policy/delete-terms",

		API_URN_ADMIN_STUDENT_TRANSFER_TABLE_DATA: "admin/student-transfer/table-data",
		API_URN_ADMIN_STUDENT_TRANSFER_SHOW: "admin/student-transfer/show",
		API_URN_ADMIN_STUDENT_TRANSFER_STORE: "admin/student-transfer/store",
		API_URN_ADMIN_STUDENT_TRANSFER_DESTROY: "admin/student-transfer/destroy",
		API_URN_ADMIN_STUDENT_TRANSFER_UPDATE: "admin/student-transfer/update",
	}
	const config_franchise = {
		API_URN_FRANCHISE_SCHOOL_STORE: "school-store",
		API_URN_FRANCHISE_SCHOOL_TABLE_DATA: "school-table-data",
		API_URN_FRANCHISE_SCHOOL_CHANGE_STATUS: "school-change-status",
		API_URN_FRANCHISE_SCHOOL_EDIT_DATA: "school-edit",
		API_URN_FRANCHISE_SCHOOL_UPDATE_DATA: "school-update",
		API_URN_FRANCHISE_DASHBOARD_V3_FEE_CHART: "franchise-dashboard/v3/fee-chart",
		API_URN_FRANCHISE_DASHBOARD_V3_FEE_OVERALL: "franchise-dashboard/v3/fee-overall",
		...
		API_URN_FRANCHISE_GET_KYC_EDIT: "franchise/configuration/kyc-setting-edit",
		API_URN_FRANCHISE_GET_KYC_UPDATE: "franchise/configuration/kyc-setting-update",

		API_URN_FRANCHISE_GET_PROGRAM_TYPE_TABLE_DATA: "franchise/program-type-table-data",
		API_URN_FRANCHISE_GET_PROGRAM_TYPE_STATUS_CHANGE: "franchise/program-type-status-change",
		API_URN_FRANCHISE_GET_PROGRAM_TYPE_UPDATE: "franchise/program-type-update",
		API_URN_FRANCHISE_GET_PROGRAM_TYPE_DROPDOWN: "get-program-type",
		...
		API_URN_FRANCHISE_STORE_LEAD_STAGE: "franchise/enquiry-lead-store",
		API_URN_FRANCHISE_UPDATE_LEAD_STAGE: "franchise/enquiry-lead-update",
		API_URN_FRANCHISE_DELETE_LEAD_STAGE: "franchise/enquiry-lead-destroy",
		API_URN_FRANCHISE_EDIT_LEAD_STAGE: "franchise/enquiry-lead-edit",
		API_URN_FRANCHISE_GET_ALL_LEAD_STAGE: "franchise/enquiry-lead-all-edit",
		API_URN_FRANCHISE_GET_LEAD_STAGE_TABLE: "franchise/enquiry-lead-table-data",
		API_URN_FRANCHISE_STORE_LEAD_STAGE_DROPDOWN: "franchise/enquiry-lead-dropdown",
		API_URN_FRANCHISE_STORE_LEAD_STAGE_FOLLOW_UP_UPDATE: "franchise-enquiry-followUp-trans",
		...
		API_URN_FRANCHISE_VIEW_STUDENT_ENQUIRY: "franchise-student-enquiry-show",
		API_URN_FRANCHISE_ADD_STUDENT_ENQUIRY: "franchise-student-enquiry-store",
		API_URN_FRANCHISE_STUDENT_ENQUIRY_PRE_ADMISSION_STORE: "franchise/enquiry-admission-setting-store",
		API_URN_FRANCHISE_STUDENT_ENQUIRY_PRE_ADMISSION_EDIT: "franchise/enquiry-admission-setting-edit",
		API_URN_FRANCHISE_STUDENT_ENQUIRY_SETTING_EDIT: "franchise/enquiry-setting-franchise-edit",
		API_URN_FRANCHISE_STUDENT_ENQUIRY_SETTING_STORE: "franchise/enquiry-setting-franchise-store",
		...
		API_URN_FRANCHISE_PDF_CURRICULLUM_UPDATE_STATUS: 'curriculum-change-status',
		...
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_TEMPLATE_STORE: "franchise/curriculum-lesson-plan-template",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_TEMPLATE_LIST: "franchise/curriculum-lesson-plan-template-list",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_TEMPLATE_SHOW_EDIT: "franchise/curriculum-lesson-plan-template",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_TEMPLATE_UPDATE: "franchise/curriculum-lesson-plan-template",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_TEMPLATE_DELETE: "franchise/curriculum-lesson-plan-template",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_TEMPLATE_DROPDOWN: "franchise/curriculum-lesson-plan-template-dropdown",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN: "franchise/curriculum-lesson-plan",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_EDIT: "franchise/curriculum-lesson-plan-edit",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_UPDATE: "franchise/curriculum-lesson-plan",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_LIST: "franchise/curriculum-lesson-plan-list",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_SHOW: "franchise/curriculum-lesson-plan",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_DELETE: "franchise/curriculum-lesson-plan",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_CHANGE_STATUS: "franchise/curriculum-lesson-plan-change-status",

		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_CHAPTER: "franchise/curriculum-lesson-plan-chapter",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_CHAPTER_RENAME: "franchise/curriculum-lesson-plan-chapter-rename",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_CHAPTER_DELETE: "franchise/curriculum-lesson-plan-chapter-delete",

		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_SUB_TOPIC_RESOURCE_STORE: "franchise/curriculum-lesson-plan-sub-topic-resource-store",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_SUB_TOPIC_RESOURCE_DELETE: "franchise/curriculum-lesson-plan-sub-topic-resource-delete",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_SUB_TOPIC_RESOURCE_RENAME: "franchise/curriculum-lesson-plan-sub-topic-resource-rename",

		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_ALLOCATE_BRANCH_LIST: "franchise/curriculum-lesson-plan-allocated-branch-list",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_ALLOCATE_BRANCH_DROPDOWN: "franchise/curriculum-lesson-plan-allocate-branch-dropdown",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_DE_ALLOCATE: "franchise/curriculum-lesson-plan-de-allocate",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_ALLOCATE: "franchise/curriculum-lesson-plan-allocate",
		...
		API_URN_FRANCHISE_CURRICULUM_ASSIGN_CLASS: "franchise/curriculum-assign-class",
		...
		API_URN_FRANCHISE_DELETE_STAFF_DOCUMENT: 'franchiser-staff-document-destroy',
		...
		API_URN_FRANCHISE_STAFF_BRANCH_DESIGNATION_DROPDOWN: "franchise/designation-dropdown",
		...
		API_URN_STUDENT_ENQUIRY_EXPORT: "franchise-export-enquiry-csv",
		...
		API_URN_FRANCHISE_ENQUIRY_DOWNLOAD_TEMPLATE: "franchise-enquiry-download-template",
		API_URN_FRANCHISE_ENQUIRY_IMPORT_EXCEL: "franchise-enquiry-import-excel",
		API_URN_FRANCHISE_ENQUIRY_EXPORT_EXCEL: "franchise-enquiry-export-excel",
		...
		API_URN_FRANCHISE_EXPORT_PENDING_FEE_REPORT_DATA: "franchise/student-pending-installment-export",
		...
		API_URN_FRANCHISE_STUDENT_FEE_DATA_EXPORT: "franchise/export-student-fee-data",
		API_URN_FRANCHISE_OVERALL_COLLECTION_DATA_EXPORT: "franchise/export-overall-collection",
		API_URN_FRANCHISE_STUDENT_FEE_DATA_DAYCARE_EXPORT: "franchise/export-daycare-fee-data",
		API_URN_FRANCHISE_EASEBUZZ_REPORT: "franchise/payment-settlement-list",
		API_URN_FRANCHISE_EASEBUZZ_REPORT_FETCH: "franchise/sync-payment--settlement-transaction",
		API_URN_FRANCHISE_EASEBUZZ_BRANCHWISE_REPORT: "franchise/payment-settlement-transaction-list",
		API_URN_FRANCHISE_EASEBUZZ_REPORT_STUDENT_WISE: "franchise/payment-settlement-transaction-detail",
		//**************************** Fee Management Module API's in Franchise Side  ************************************//

		/*************************
			 * Fee Type
			 * ***********************/

		API_URN_FRANCHISE_STUDENT_FEE_TYPE_STORE: "franchise/configration/fee-type-store",
		API_URN_FRANCHISE_STUDENT_FEE_TYPE_VIEW_LIST: "franchise/configration/fee-type-show",
		API_URN_FRANCHISE_STUDENT_FEE_TYPE_EDIT: "franchise/configration/fee-type-edit",
		API_URN_FRANCHISE_STUDENT_FEE_TYPE_UPDATE: "franchise/configration/fee-type-update",
		API_URN_FRANCHISE_STUDENT_FEE_TYPE_DESTROY: "franchise/configration/fee-type-destroy",
		API_URN_FRANCHISE_STUDENT_FEE_TYPE_CHANGE: "franchise/configration/fee-type-change-status",
		API_URN_FRANCHISE_STUDENT_FEE_TYPE_LIST: "franchise/configration/fee-type-table-data",
		API_URN_FRANCHISE_STUDENT_FEE_TYPE_DROPDOWN_LIST: "franchise/configration/fee-type-dropdown",

		/*************************
			 * Class Configuration Type
			 * ***********************/

		API_URN_FRANCHISE_STUDENT_FEE_CONFIGURATION_TYPE_STORE: "franchise/configration/class-config-type-store",
		API_URN_FRANCHISE_STUDENT_FEE_CONFIGURATION_TYPE_VIEW_LIST: "franchise/configration/class-config-type-show",
		API_URN_FRANCHISE_STUDENT_FEE_CONFIGURATION_TYPE_EDIT: "franchise/configration/class-config-type-edit",
		API_URN_FRANCHISE_STUDENT_FEE_CONFIGURATION_TYPE_UPDATE: "franchise/configration/class-config-type-update",
		API_URN_FRANCHISE_STUDENT_FEE_CONFIGURATION_TYPE_DESTROY: "franchise/configration/class-config-type-destroy",
		API_URN_FRANCHISE_STUDENT_FEE_CONFIGURATION_TYPE_MARK_DEFAULT: "franchise/configration/class-config-type-mark-default",
		API_URN_FRANCHISE_STUDENT_FEE_CONFIGURATION_TYPE_LIST: "franchise/configration/class-config-type-table-data",
		API_URN_FRANCHISE_STUDENT_FEE_CONFIGURATION_TYPE_DROPDOWN_LIST: "franchise/configration/class-config-type-drop-down",
		...
		API_URN_FRANCHISE_STUDENT_FEE_TEMPLATE_STORE: "franchise/configration/fee-template-store",
		API_URN_FRANCHISE_STUDENT_FEE_TEMPLATE_VIEW_LIST: "franchise/configration/fee-template-show",
		API_URN_FRANCHISE_STUDENT_FEE_TEMPLATE_EDIT: "franchise/configration/fee-template-edit",
		API_URN_FRANCHISE_STUDENT_FEE_TEMPLATE_UPDATE: "franchise/configration/fee-template-update",
		API_URN_FRANCHISE_STUDENT_FEE_TEMPLATE_DESTROY: "franchise/configration/fee-template-destroy",
		API_URN_FRANCHISE_STUDENT_FEE_TEMPLATE_LIST: "franchise/configration/fee-template-table-data",
		API_URN_FRANCHISE_STUDENT_FEE_TEMPLATE_DROPDOWN_LIST: "franchise/configration/fee-template-dropdown",
		API_URN_FRANCHISE_STUDENT_FEE_TEMPLATE_STATUS_CHANGE: "franchise/configration/fee-template-change-status",
		API_URN_FRANCHISE_STUDENT_FEE_TEMPLATE_COPY: "franchise/configuration/copy-template",
		API_URN_FRANCHISE_STUDENT_FEE_TEMPLATE_TIER_WISE_BRANCH: "franchise/configration/fee-template-school-dropdown",

		/*************************
			 * Fee Configuration
			 * ***********************/

		API_URN_FRANCHISE_STUDENT_FEE_CONFIGURATION_STORE: "franchise/configration/fee-configuration-store",
		API_URN_FRANCHISE_STUDENT_FEE_CONFIGURATION_EDIT: "franchise/configration/fee-configuration-edit",
		API_URN_FRANCHISE_STUDENT_FEE_CONFIGURATION_UPDATE: "franchise/configration/fee-configuration-update",
		API_URN_FRANCHISE_STUDENT_FEE_CONFIGURATION_DESTROY: "franchise/configration/fee-configuration-destroy",
		API_URN_FRANCHISE_STUDENT_FEE_CONFIGURATION_LIST: "franchise/configration/fee-configuration-table-data",
		API_URN_FRANCHISE_STUDENT_FEE_COPY_CONFIGURATION: "franchise/configration/copy-school-fee-configuration",

		/*************************
			 * Fee General Settings
			 * ***********************/

		API_URN_FRANCHISE_STUDENT_FEE_MANAGEMENT_SETTINGS_ADD: "franchise/configration/fee-setting-update",
		API_URN_FRANCHISE_STUDENT_FEE_MANAGEMENT_SETTINGS_VIEW: "franchise/configration/fee-setting-show",

		/*************************
			 * Fee Branch Settings
			 * ***********************/

		API_URN_FRANCHISE_STUDENT_FEE_MANAGEMENT_BRANCH_SETTINGS_ADD: "franchise/configration/fee-customize-setting-update",
		API_URN_FRANCHISE_STUDENT_FEE_MANAGEMENT_BRANCH_SETTINGS_VIEW: "franchise/configration/fee-customize-setting-table-data",

		/*************************
			 * Fee Customize Settings
			 * ***********************/

		API_URN_FRANCHISE_STUDENT_FEE_MANAGEMENT_BRANCH_CUSTOMIZE_SETTINGS_ADD: "franchise/configration/fee-configuration-setting-update",
		API_URN_FRANCHISE_STUDENT_FEE_MANAGEMENT_BRANCH_CUSTOMIZE_SETTINGS_VIEW: "franchise/configration/fee-configuration-setting-show",

		/*************************
			 * Discount Category
			 * ***********************/

		API_URN_FRANCHISE_STUDENT_FEE_DISCOUNT_STORE: "franchise/configration/fee-discount-store",
		API_URN_FRANCHISE_STUDENT_FEE_DISCOUNT_VIEW: "franchise/configration/fee-discount-show",
		API_URN_FRANCHISE_STUDENT_FEE_DISCOUNT_EDIT: "franchise/configration/fee-discount-edit",
		API_URN_FRANCHISE_STUDENT_FEE_DISCOUNT_UPDATE: "franchise/configration/fee-discount-update",
		API_URN_FRANCHISE_STUDENT_FEE_DISCOUNT_DESTROY: "franchise/configration/fee-discount-destroy",
		API_URN_FRANCHISE_STUDENT_FEE_DISCOUNT_LIST: "franchise/configration/fee-discount-table-data",
		API_URN_FRANCHISE_STUDENT_FEE_DISCOUNT_DROPDOWN_LIST: "franchise/configration/fee-discount-drop-down",
		//**************************** End ***************************************//

		//**************************** Fee Reconcilation Module API's in Franchise Side  ************************************//

		/*************************
			 * Fee Reconcilation
			 * ***********************/
		API_URN_FRANCHISE_FEE_REPORT_RECONCILATION_VERIFIED_LIST: "franchise/feereconcilation/verified-table-data",
		API_URN_FRANCHISE_FEE_REPORT_RECONCILATION_UNVERIFIED_LIST: "franchise/feereconcilation/unverified-table-data",
		API_URN_FRANCHISE_FEE_REPORT_RECONCILATION_OVERALL_LIST: "franchise/feereconcilation/overall-table-data",
		API_URN_FRANCHISE_FEE_REPORT_RECONCILATION_STATUS_CHANGE: "franchise/feereconcilation/changes-status",
		API_URN_FRANCHISE_FEE_REPORT_RECONCILATION_SETTINGS_EDIT: "franchise/feereconcilation/setting-edit",
		API_URN_FRANCHISE_FEE_REPORT_RECONCILATION_SETTINGS_UPDATE: "franchise/feereconcilation/setting-update",
		API_URN_FRANCHISE_FEE_REPORT_RECONCILATION_EXPORT: "franchise/feereconcilation/report-export",
		...
		API_URN_FRANCHISE_SCHOOL_TIER_DROPDOWN_NEW: "school-tier-dropdown-new",
		API_URN_FRANCHISE_SCHOOL_TIMEZONE: "timezone",
		API_URN_FRANCHISE_SCHOOL_TIER_UPDATE: "school-tier-update",
		API_URN_FRANCHISE_SCHOOL_TIER_TABLE_DATA: "school-tier-table-data",
		// --------------------------------- Branch Group API's --------------------------------- //
		API_URN_FRANCHISE_BRANCH_GROUP_STORE: "school-group-store",
		API_URN_FRANCHISE_BRANCH_GROUP_DESTROY: "school-group-destroy",
		API_URN_FRANCHISE_BRANCH_GROUP_EDIT: "school-group-edit",
		API_URN_FRANCHISE_BRANCH_GROUP_DROPDOWN: "school-group-dropdown",
		API_URN_FRANCHISE_BRANCH_GROUP_UPDATE: "school-group-update",
		API_URN_FRANCHISE_GET_BRANCH_FROM_GROUP: "get-school-group-dropdown",
		API_URN_FRANCHISE_BRANCH_GROUP_TABLE_DATA: "school-group-table-data",

		// --------------------------------- School Restrict Setting API's --------------------------------- //
		...
		API_URN_FRANCHISE_COMMUNICATION_CHANGE_STATUS: "franchise/communication-change-status",
		...
		API_URN_FRANCHISE_COMMUNICATION_ASSIGN_BRANCHES: "franchise/communication-assign-branches",
		API_URN_FRANCHISE_COMMUNICATION_EXTEND_EXPIRY: "franchise/communication-extend-expiry",
		...
		API_URN_FRANCHISE_NEXT_ACADEMIC_YEAR: "franchise-get-next-academic-year",
		...
		API_URN_FRANCHISE_INVENTORY_PRODUCT_CHANGE_STATUS: "franchise/product-change-status",
		API_URN_FRANCHISE_INVENTORY_PRODUCT_PARENT_SIDE_VISIBILITY_UPDATE: "franchise/change-parent-status",
		API_URN_FRANCHISE_INVENTORY_PRODUCT_GET_STOCK_DETAIL: "franchise/get-product-stock-detail",
		API_URN_FRANCHISE_INVENTORY_PRODUCT_UPDATE_STOCK_DETAIL: "franchise/update-product-stock-detail",
		//**************************************************** Inventory Shipping Rule API's ****************************************************//
		API_URN_FRANCHISE_INVENTORY_SHIPPING_RULE_STORE: "franchise/inv/shipping-rule-store",
		API_URN_FRANCHISE_INVENTORY_SHIPPING_RULE_UPDATE: "franchise/inv/shipping-rule-update",
		API_URN_FRANCHISE_INVENTORY_SHIPPING_RULE_DESTROY: "franchise/inv/shipping-rule-destroy",
		API_URN_FRANCHISE_INVENTORY_SHIPPING_RULE_EDIT: "franchise/inv/shipping-rule-edit",
		API_URN_FRANCHISE_INVENTORY_SHIPPING_RULE_TABLE_DATA: "franchise/inv/shipping-rule-table-data",
		API_URN_FRANCHISE_INVENTORY_SHIPPING_RULE_STATUS_UPDATE: "franchise/inv/shipping-rule-status-update",
		...
		API_URN_FRANCHISE_INVENTORY_PRODUCT_KIT_CHANGE_STATUS: "franchise/product-kit-change-status",
		//**************************************************** Inventory Warehouse API's ****************************************************//
		API_URN_FRANCHISE_INVENTORY_WAREHOUSE_STORE: "franchise/inv/warehouse-store",
		API_URN_FRANCHISE_INVENTORY_WAREHOUSE_UPDATE: "franchise/inv/warehouse-update",
		API_URN_FRANCHISE_INVENTORY_WAREHOUSE_DESTROY: "franchise/inv/warehouse-destroy",
		API_URN_FRANCHISE_INVENTORY_WAREHOUSE_STATUS_UPDATE: "franchise/inv/warehouse-status-update",
		API_URN_FRANCHISE_INVENTORY_WAREHOUSE_EDIT: "franchise/inv/warehouse-edit",
		API_URN_FRANCHISE_INVENTORY_WAREHOUSE_SHOW: "franchise/inv/warehouse-show",
		API_URN_FRANCHISE_INVENTORY_WAREHOUSE_TABLE_DATA: "franchise/inv/warehouse-table-data",
		API_URN_FRANCHISE_INVENTORY_WAREHOUSE_DROPDOWN: "franchise/inv/warehouse-dropdown",
		API_URN_FRANCHISE_INVENTORY_WAREHOUSE_ADD_STOCK: "franchise/inv/warehouse-add-stock",
		API_URN_FRANCHISE_INVENTORY_WAREHOUSE_PRODUCT_TABLE_DATA: "franchise/inv/warehouse-product-table-data",
		API_URN_FRANCHISE_INVENTORY_WAREHOUSE_PRODUCT_STOCK_HISTORY: "franchise/inv/warehouse-product-stock-history",
		API_URN_FRANCHISE_INVENTORY_WAREHOUSE_MAKE_PRIMARY: "franchise/inv/warehouse-make-primary",

		//**************************************************** Service Charge API's ****************************************************//
		API_URN_FRANCHISER_SERVICE_CHARGE_TABLE_DATA: "franchiser/service-charge-table-data",
		API_URN_FRANCHISER_SERVICE_CHARGE_SHOW: "franchiser/service-charge-show",
		API_URN_FRANCHISER_SERVICE_CHARGE_STORE: "franchiser/service-charge-store",
		API_URN_FRANCHISER_SERVICE_CHARGE_UPDATE: "franchiser/service-charge-update",
		API_URN_FRANCHISER_SERVICE_CHARGE_DESTROY: "franchiser/service-charge-destroy",
		API_URN_FRANCHISER_SERVICE_CHARGE_SETTING_SHOW: "franchiser/service-charge-setting-show",
		API_URN_FRANCHISER_SERVICE_CHARGE_SETTING_STORE: "franchiser/service-charge-setting-store",
		API_URN_FRANCHISER_SERVICE_CHARGE_COLLECTION_TABLE: "franchiser/service-charge-school-collection",

		// Franchiser Service Charge Class Fee Setting
		API_URN_FRANCHISER_SERVICE_CHARGE_CLASS_FEE_SETTING_TABLE_DATA: "franchiser/service-charge-class-fee-setting-table-data",
		API_URN_FRANCHISER_SERVICE_CHARGE_CLASS_FEE_SETTING_SHOW: "franchiser/service-charge-class-fee-setting-show",
		API_URN_FRANCHISER_SERVICE_CHARGE_CLASS_FEE_SETTING_STORE: "franchiser/service-charge-class-fee-setting-store",
		API_URN_FRANCHISER_SERVICE_CHARGE_CLASS_FEE_SETTING_UPDATE: "franchiser/service-charge-class-fee-setting-update",
		API_URN_FRANCHISER_SERVICE_CHARGE_CLASS_FEE_SETTING_DESTROY: "franchiser/service-charge-class-fee-setting-destroy",
		...
		API_URN_FRANCHISE_PRODUCT_BULK_ORDER_ACCEPT: "franchise/order-bulk-accept",
		API_URN_FRANCHISE_PRODUCT_BULK_ORDER_DISPATCH: "franchise/order-bulk-dispatch",
		API_URN_FRANCHISE_PRODUCT_BULK_ORDER_DELIVERED: "franchise/order-bulk-delivered",
		...
		API_URN_FRANCHISE_KIT_PRODUCT_INVOICE_ORDER_MANUAL_STORE: "franchise/order-manual-store",
		API_URN_FRANCHISE_KIT_PRODUCT_INVOICE_NEXT_NO: "franchise/order-next-invoice-no",
		API_URN_FRANCHISE_KIT_PRODUCT_INVOICE_COLLECTION_STORE: "franchise/product-invoice-collection-store",
		API_URN_FRANCHISE_KIT_PRODUCT_VARIANT_DROPDOWN: "franchise/get-product-variant-dropdown",
		...
		API_URN_FRANCHISE_KIT_ORDER_EXPORT: "franchise/order-export",
		...
		//Franchise subject management API's
		// --------------------------------- Subject API's --------------------------------- //
		API_URN_FRANCHISE_SUBJECT_MANAGEMENT_SUBJECT_STORE: "franchise/subject-store",
		API_URN_FRANCHISE_SUBJECT_MANAGEMENT_SUBJECT_EDIT: "franchise/subject-edit",
		API_URN_FRANCHISE_SUBJECT_MANAGEMENT_SUBJECT_UPDATE: "franchise/subject-update",
		API_URN_FRANCHISE_SUBJECT_MANAGEMENT_SUBJECT_DESTROY: "franchise/subject-destroy",
		API_URN_FRANCHISE_SUBJECT_MANAGEMENT_SUBJECT_TABLE_DATA: "franchise/subject-table-data",
		API_URN_FRANCHISE_SUBJECT_MANAGEMENT_SUBJECT_CHANGE_STATUS: "franchise/subject-status-change",
		...
		API_URN_FRANCHISE_DESIGNATION_STATUS_CHANGE: "franchise/designation-status-change",
		API_URN_FRANCHISE_DESIGNATION_DROPDOWN: "franchise/designation-dropdown",
		API_URN_FRANCHISE_NOTIFICATION_SETTINGS_GET: "notification-module-list",
		API_URN_FRANCHISE_NOTIFICATION_SETTINGS_POST: "notification-module-store-update",
		...
		API_URN_FRANCHISE_FEE_MANAGEMENT_FEE_CONFIGURATION_COPY: "franchise/copy-school-fee-configuration",

		//**************************** Franchise Staff Attendence Module API's  ************************************//

		/*************************
				 * Day Setting API's 
				 * ***********************/

		API_URN_FRANCHISE_STAFF_ATTENDANCE_WEEKLY_HOLIDAY_STORE_ADD: "franchise/weekly-holidays-store",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_WEEKLY_HOLIDAY_STORE_EDIT: "franchise/weekly-holidays-edit",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_WEEKLY_HOLIDAY_STORE_UPDATE: "franchise/weekly-holidays-update",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_WEEKLY_HOLIDAY_STORE_DESTROY: "franchise/weekly-holidays-destroy",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_WEEKLY_HOLIDAY_STORE_LIST: "franchise/weekly-holidays-table-data",

		/*************************
				 * Weekly Holiday Removal Setting API's 
				 * ***********************/

		API_URN_FRANCHISE_STAFF_ATTENDANCE_WEEKLY_HOLIDAY_REMOVAL_STORE_ADD: "franchise/weekly-holiday-removal-store",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_WEEKLY_HOLIDAY_REMOVAL_STORE_EDIT: "franchise/weekly-holiday-removal-edit",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_WEEKLY_HOLIDAY_REMOVAL_STORE_DESTROY: "franchise/weekly-holiday-removal-destroy",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_WEEKLY_HOLIDAY_REMOVAL_STORE_LIST: "franchise/weekly-holiday-removal-table-data",

		/*************************
				 * Hour Setting API's 
				 * ***********************/

		API_URN_FRANCHISE_STAFF_ATTENDANCE_HOUR_SETTING_STORE_ADD: "franchise/hour-setting-store",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_HOUR_SETTING_STORE_EDIT: "franchise/hour-setting-edit",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_HOUR_SETTING_STORE_UPDATE: "franchise/hour-setting-update",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_HOUR_SETTING_STORE_LIST: "franchise/hour-setting-table-data",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_HOUR_SETTING_STORE_DESTROY: "franchise/hour-setting-destroy",

		/*************************
				 * Attendance Setting API's 
				 * ***********************/

		API_URN_FRANCHISE_STAFF_ATTENDANCE_SETTING_STORE_ADD: "franchise/staff-attendance-setting-update",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_SETTING_STORE_EDIT: "franchise/staff-attendance-setting-show",

		/*************************
				 * Attendance History API's 
				 * ***********************/

		API_URN_FRANCHISE_STAFF_ATTENDANCE_HISTORY_VIEW: "franchise/history-staff-attendance-table-data",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_ACADEMIC_YEAR: "franchise-year",

		/*************************
						 * Attendance Report API's 
						 * ***********************/

		API_URN_FRANCHISE_STAFF_ATTENDANCE_REPORT_VIEW: "franchise/staff-attendance-report",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_REPORT_OVERVIEW: "franchise/staff-attendance-overview",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_REPORT_OVERVIEW_PIE_CHART: "franchise/staff-attendance-show",

		/*************************
						 * Attendance RFID API's 
						 * ***********************/

		API_URN_FRANCHISE_STAFF_ATTENDANCE_RFID_ADD: "franchise/rfid-staff-store",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_RFID_MULTIPLE_ADD: "franchise/rfid-staff-multiple-store",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_RFID_DESTROY: "franchise/rfid-staff-destroy",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_RFID_TABLE_DATA: "franchise/rfid-staff-table-data",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_RFID_DROPDOWN: "franchise/rfid-device-dropdown",

		/*************************
						 * Attendance Manage API's 
						 * ***********************/

		API_URN_FRANCHISE_STAFF_ATTENDANCE_MANAGE_STAFF_SHOW: "franchise/staff-attendance-show",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_MANAGE_STAFF_ADD: "franchise/staff-attendance-store",


		//**************************** End ***************************************//

		//**************************** Branch Staff Attendence Module API's in Franchise Side  ************************************//

		/*************************
						 * Attendance Report Overall API's 
						 * ***********************/

		API_URN_BRANCH_STAFF_ATTENDANCE_REPORT_STAFF_SHOW: "franchise/school-staff-attendance-show",
		API_URN_BRANCH_STAFF_ATTENDANCE_REPORT_BRANCH_WISE_STAFF: "franchise/school-staff-attendance-report",

		/*************************
						 * Attendance Report History API's 
						 * ***********************/

		API_URN_BRANCH_STAFF_ATTENDANCE_HISTORY_STAFF_SHOW: "franchise/school-history-staff-attendance-table-data",
		API_URN_BRANCH_STAFF_ATTENDANCE_HISTORY_EXPORT: "franchise/staff-attendance-export",

		/*************************
						 * Day Settings API's 
						 * ***********************/

		API_URN_SCHOOL_STAFF_ATTENDANCE_WEEKLY_HOLIDAY_STORE_ADD: "franchise/global/weekly-holidays-store",
		API_URN_SCHOOL_STAFF_ATTENDANCE_WEEKLY_HOLIDAY_STORE_EDIT: "franchise/global/weekly-holidays-edit",
		API_URN_SCHOOL_STAFF_ATTENDANCE_WEEKLY_HOLIDAY_STORE_UPDATE: "franchise/global/weekly-holidays-update",
		API_URN_SCHOOL_STAFF_ATTENDANCE_WEEKLY_HOLIDAY_STORE_DESTROY: "franchise/global/weekly-holidays-destroy",
		API_URN_SCHOOL_STAFF_ATTENDANCE_WEEKLY_HOLIDAY_STORE_LIST: "franchise/global/weekly-holidays-table-data",

		/*************************
						 * Weekly Holiday Removal Setting API's 
						 * ***********************/

		API_URN_SCHOOL_STAFF_ATTENDANCE_WEEKLY_HOLIDAY_REMOVAL_STORE_ADD: "franchise/global/weekly-holiday-removal-store",
		API_URN_SCHOOL_STAFF_ATTENDANCE_WEEKLY_HOLIDAY_REMOVAL_STORE_EDIT: "franchise/global/weekly-holiday-removal-edit",
		API_URN_SCHOOL_STAFF_ATTENDANCE_WEEKLY_HOLIDAY_REMOVAL_STORE_DESTROY: "franchise/global/weekly-holiday-removal-destroy",
		API_URN_SCHOOL_STAFF_ATTENDANCE_WEEKLY_HOLIDAY_REMOVAL_STORE_LIST: "franchise/global/weekly-holiday-removal-table-data",

		/*************************
				 * Attendance Setting API's 
				 * ***********************/

		API_URN_SCHOOL_STAFF_ATTENDANCE_SETTING_STORE_ADD: "franchise/global/staff-attendance-setting-update",
		API_URN_SCHOOL_STAFF_ATTENDANCE_SETTING_STORE_EDIT: "franchise/global/staff-attendance-setting-show",
		API_URN_SCHOOL_STAFF_BRANCH_ATTENDANCE_DROPDOWN: "franchise/global/attendance-school-dropdown",

		/*************************
				 * Franchise Progress Report Template API's 
				 * ***********************/

		API_URN_FRANCHISE_PROGRESS_REPORT_TEMPLATE_STORE: "franchise/progress-report-template-store",
		API_URN_FRANCHISE_PROGRESS_REPORT_TEMPLATE_EDIT: "franchise/progress-report-template-edit",
		API_URN_FRANCHISE_PROGRESS_REPORT_TEMPLATE_UPDATE: "franchise/progress-report-template-update",
		API_URN_FRANCHISE_PROGRESS_REPORT_TEMPLATE_LIST: "franchise/progress-report-template-table-data",
		API_URN_FRANCHISE_PROGRESS_REPORT_TEMPLATE_DROPDOWN: "franchise/progress-report-template-dropdown",
		API_URN_FRANCHISE_PROGRESS_REPORT_TEMPLATE_DESTROY: "franchise/progress-report-template-destroy",
		API_URN_FRANCHISE_PROGRESS_REPORT_TEMPLATE_COPY: "franchise/progress-report-template-copy",
		API_URN_FRANCHISE_PROGRESS_REPORT_TEMPLATE_STATUS: "franchise/progress-report-template-change-status",

		/*************************
				 *  Franchise Progress Report Result Settings API's 
				 * ***********************/

		API_URN_FRANCHISE_PROGRESS_REPORT_RESULT_SETTINGS_STORE: "franchise/report-result-setting-store",
		API_URN_FRANCHISE_PROGRESS_REPORT_RESULT_SETTINGS_SHOW: "franchise/report-result-setting-show",
		API_URN_FRANCHISE_PROGRESS_REPORT_RESULT_SETTINGS_EDIT: "franchise/report-result-setting-edit",
		API_URN_FRANCHISE_PROGRESS_REPORT_RESULT_SETTINGS_LIST: "franchise/report-result-setting-table-data",
		API_URN_FRANCHISE_PROGRESS_REPORT_RESULT_SETTINGS_UPDATE: "franchise/report-result-setting-update",
		API_URN_FRANCHISE_PROGRESS_REPORT_RESULT_SETTINGS_DESTROY: "franchise/report-result-setting-destroy",

		/*************************
				 *  Franchise Progress Report Settings API's 
				 * ***********************/
		API_URN_FRANCHISE_PROGRESS_REPORT_SETTINGS_STORE: "franchise/progress-report-setting-add",
		API_URN_FRANCHISE_PROGRESS_REPORT_SETTINGS_SHOW: "franchise/progress-report-setting-get",
		API_URN_FRANCHISE_PROGRESS_REPORT_SETTINGS_IMAGE_DESTROY: "franchise/progress-report-setting-destroy-file",
		API_URN_PROGRESS_REPORT_SCHOOL_FRANCHISE_TEMPLATE: "franchise/progress-report-template-school-table-data",

		// * Franchise Broadcast Message API's *

		API_URN_FRANCHISE_BROADCAST_TABLE_DATA: "franchise/broadcast-table-data",
		API_URN_FRANCHISE_BROADCAST_STORE: "franchise/broadcast-store",
		API_URN_FRANCHISE_BROADCAST_UPDATE: "franchise/broadcast-update",
		API_URN_FRANCHISE_BROADCAST_DESTROY: "franchise/broadcast-destroy",
		API_URN_FRANCHISE_BROADCAST_EDIT: "franchise/broadcast-edit",
		API_URN_FRANCHISE_BROADCAST_CATEGORY_TABLE_DATA: "franchise/broadcast-category-table-data",
		API_URN_FRANCHISE_BROADCAST_CATEGORY_STORE: "franchise/broadcast-category-store",
		API_URN_FRANCHISE_BROADCAST_CATEGORY_UPDATE: "franchise/broadcast-category-update",
		API_URN_FRANCHISE_BROADCAST_CATEGORY_DESTROY: "franchise/broadcast-category-destroy",
		API_URN_FRANCHISE_BROADCAST_CATEGORY_EDIT: "franchise/broadcast-category-edit",
		API_URN_FRANCHISE_BROADCAST_CATEGORY_DROPDOWN: "franchise/broadcast-category-dropdown",

	};

	const config_user_activity = {
		// Node base URL already ends with /api/v2, so the URN must not repeat v2.
		API_URN_USER_ACTIVITY_DEVICE_TRACK: "user-activity/device-track",
		API_URN_USER_ACTIVITY_UPDATE: "user-activity/update",
		API_URN_USER_ACTIVITY_LOGOUT: "user-activity/logout",
	};

	const config_fee_approval = {
		API_URN_FRANCHISE_FEE_APPROVAL_APPROVER_DROPDOWN: "franchise/fee-approval/approver-dropdown",
		API_URN_FRANCHISE_FEE_APPROVAL_AUDIT_LIST: "franchise/fee-approval/audit-list",
		API_URN_FRANCHISE_FEE_APPROVAL_CONFIG_PUBLISH: "franchise/fee-approval/config-publish",
		API_URN_FRANCHISE_FEE_APPROVAL_CONFIG_SAVE_DRAFT: "franchise/fee-approval/config-save-draft",
		API_URN_FRANCHISE_FEE_APPROVAL_CONFIG_SHOW: "franchise/fee-approval/config-show",
		API_URN_FRANCHISE_FEE_APPROVAL_OVERVIEW: "franchise/fee-approval/overview",
		API_URN_FRANCHISE_FEE_APPROVAL_REQUEST_ACTION: "franchise/fee-approval/request-action",
		API_URN_FRANCHISE_FEE_APPROVAL_REQUEST_BULK_ACTION: "franchise/fee-approval/request-bulk-action",
		API_URN_FRANCHISE_FEE_APPROVAL_REQUEST_COMMENT_STORE: "franchise/fee-approval/request-comment-store",
		API_URN_FRANCHISE_FEE_APPROVAL_REQUEST_FILTER_OPTIONS: "franchise/fee-approval/request-filter-options",
		API_URN_FRANCHISE_FEE_APPROVAL_REQUEST_LIST: "franchise/fee-approval/request-list",
		API_URN_FRANCHISE_FEE_APPROVAL_REQUEST_SHOW: "franchise/fee-approval/request-show",
		API_URN_FRANCHISE_FEE_APPROVAL_REQUEST_STORE: "franchise/fee-approval/request-store",
		API_URN_FRANCHISE_FEE_APPROVAL_WORKFLOW_DROPDOWN: "franchise/fee-approval/workflow-dropdown",
		API_URN_FRANCHISE_FEE_APPROVAL_CONFIG_BRANCH_UPDATE: "franchise/fee-approval/config-branch-update",
		API_URN_FRANCHISE_FEE_APPROVAL_CONFIG_BRANCH_SHOW: "franchise/fee-approval/config-branch-show",
		API_URN_FRANCHISE_FEE_APPROVAL_CONFIG_ENGINE_UPDATE: "franchise/fee-approval/config-engine-update",
		API_URN_FRANCHISE_FEE_APPROVAL_CONFIG_EVENT_UPDATE: "franchise/fee-approval/config-event-update",
		API_URN_FRANCHISE_FEE_APPROVAL_WORKFLOW_LIST: "franchise/fee-approval/workflow-list",
		API_URN_FRANCHISE_FEE_APPROVAL_WORKFLOW_SHOW: "franchise/fee-approval/workflow-show",
		API_URN_FRANCHISE_FEE_APPROVAL_WORKFLOW_STORE: "franchise/fee-approval/workflow-store",
		API_URN_FRANCHISE_FEE_APPROVAL_WORKFLOW_UPDATE: "franchise/fee-approval/workflow-update",
		API_URN_FRANCHISE_FEE_APPROVAL_WORKFLOW_DELETE: "franchise/fee-approval/workflow-delete",
		API_URN_ADMIN_FEE_APPROVAL_REQUEST_LIST: "fee-approval/request-list",
		API_URN_ADMIN_FEE_APPROVAL_REQUEST_WITHDRAW: "fee-approval/request-withdraw",
	};

	/* Payroll & Salary — PRD Phase 2. Same Node service as Attendance & Leave, so the
	   module sets serverType itself rather than trusting every caller to. */
	const config_payroll_salary = {
		// BRANCH SEAT
		API_URN_FNF_SETTLEMENT_APPROVE: "fnf-settlement-approve",
		API_URN_FNF_SETTLEMENT_ELIGIBLE_STAFF: "fnf-settlement-eligible-staff",
		API_URN_FNF_SETTLEMENT_MARK_PAID: "fnf-settlement-mark-paid",
		API_URN_FNF_SETTLEMENT_PREVIEW: "fnf-settlement-preview",
		API_URN_FNF_SETTLEMENT_REOPEN: "fnf-settlement-reopen",
		API_URN_FNF_SETTLEMENT_SHOW: "fnf-settlement-show",
		API_URN_FNF_SETTLEMENT_STORE: "fnf-settlement-store",
		API_URN_FNF_SETTLEMENT_TABLE_DATA: "fnf-settlement-table-data",
		API_URN_PAYROLL_AUDIT_LOG_EXPORT: "payroll-audit-log-export",
		API_URN_PAYROLL_AUDIT_LOG_FILTER_OPTIONS: "payroll-audit-log-filter-options",
		API_URN_PAYROLL_AUDIT_LOG_TABLE_DATA: "payroll-audit-log-table-data",
		API_URN_PAYROLL_DASHBOARD: "payroll-dashboard",
		API_URN_PAYROLL_REPORT: "payroll-report",
		API_URN_PAYROLL_REPORT_EXPORT: "payroll-report-export",
		API_URN_PAYROLL_REPORT_LIST: "payroll-report-list",
		API_URN_PAYROLL_UNIT_SETTINGS_ACTIVATE: "payroll-unit-settings-activate",
		API_URN_PAYROLL_UNIT_SETTINGS_DEACTIVATE: "payroll-unit-settings-deactivate",
		API_URN_PAYROLL_UNIT_SETTINGS_SHOW: "payroll-unit-settings-show",
		API_URN_PAYROLL_UNIT_SETTINGS_UPDATE: "payroll-unit-settings-update",
		API_URN_PAYSLIP_BULK_EMAIL: "payslip-bulk-email",
		API_URN_PAYSLIP_BULK_ZIP: "payslip-bulk-zip",
		API_URN_PAYSLIP_BULK_ZIP_STATUS: "payslip-bulk-zip-status",
		API_URN_PAYSLIP_DOWNLOAD: "payslip-download",
		API_URN_PAYSLIP_EMAIL: "payslip-email",
		API_URN_PAYSLIP_SHOW: "payslip-show",
		API_URN_PAYSLIP_TABLE_DATA: "payslip-table-data",
		API_URN_PT_SLAB_STORE: "pt-slab-store",
		API_URN_PT_SLAB_TABLE_DATA: "pt-slab-table-data",
		API_URN_SALARY_ADVANCE_CLOSE: "salary-advance-close",
		API_URN_SALARY_ADVANCE_STORE: "salary-advance-store",
		API_URN_SALARY_ADVANCE_TABLE_DATA: "salary-advance-table-data",
		API_URN_SALARY_COMPONENT_CHANGE_STATUS: "salary-component-change-status",
		API_URN_SALARY_COMPONENT_STORE: "salary-component-store",
		API_URN_SALARY_COMPONENT_TABLE_DATA: "salary-component-table-data",
		API_URN_SALARY_RUN_APPROVE: "salary-run-approve",
		API_URN_SALARY_RUN_COMPUTE: "salary-run-compute",
		API_URN_SALARY_RUN_CREATE: "salary-run-create",
		API_URN_SALARY_RUN_EXCEPTION_RESOLVE: "salary-run-exception-resolve",
		API_URN_SALARY_RUN_INPUT_TABLE_DATA: "salary-run-input-table-data",
		API_URN_SALARY_RUN_INPUT_UPDATE: "salary-run-input-update",
		API_URN_SALARY_RUN_ITEM_SHOW: "salary-run-item-show",
		API_URN_SALARY_RUN_ITEM_TABLE_DATA: "salary-run-item-table-data",
		API_URN_SALARY_RUN_LOP_DAYS: "salary-run-lop-days",
		API_URN_SALARY_RUN_MARK_PAID: "salary-run-mark-paid",
		API_URN_SALARY_RUN_REOPEN: "salary-run-reopen",
		API_URN_SALARY_RUN_REVIEW: "salary-run-review",
		API_URN_SALARY_RUN_SEND_BACK: "salary-run-send-back",
		API_URN_SALARY_RUN_SHOW: "salary-run-show",
		API_URN_SALARY_RUN_VARIANCE_ACKNOWLEDGE: "salary-run-variance-acknowledge",
		API_URN_SALARY_STRUCTURE_CHANGE_STATUS: "salary-structure-change-status",
		API_URN_SALARY_STRUCTURE_DUPLICATE: "salary-structure-duplicate",
		API_URN_SALARY_STRUCTURE_PREVIEW: "salary-structure-preview",
		API_URN_SALARY_STRUCTURE_SCOPE_DESIGNATION_DROPDOWN: "salary-structure-scope-designation-dropdown",
		API_URN_SALARY_STRUCTURE_SCOPE_STAFF_DROPDOWN: "salary-structure-scope-staff-dropdown",
		API_URN_SALARY_STRUCTURE_SHOW: "salary-structure-show",
		API_URN_SALARY_STRUCTURE_STORE: "salary-structure-store",
		API_URN_SALARY_STRUCTURE_TABLE_DATA: "salary-structure-table-data",
		API_URN_SALARY_TRANSFER_SHEET: "salary-transfer-sheet",
		API_URN_SALARY_TRANSFER_SHEET_EXPORT: "salary-transfer-sheet-export",
		API_URN_STAFF_ATTENDANCE_SUMMARY: "staff-attendance-summary",
		API_URN_STAFF_IDENTITY_DEPARTMENT_LIST: "staff-identity-department-list",
		API_URN_STAFF_IDENTITY_SHOW: "staff-identity-show",
		API_URN_STAFF_IDENTITY_STORE: "staff-identity-store",
		API_URN_STAFF_SALARY_ARREARS_PREVIEW: "staff-salary-arrears-preview",
		API_URN_STAFF_SALARY_ASSIGN: "staff-salary-assign",
		API_URN_STAFF_SALARY_BULK_ASSIGN: "staff-salary-bulk-assign",
		API_URN_STAFF_SALARY_BULK_PREVIEW: "staff-salary-bulk-preview",
		API_URN_STAFF_SALARY_EXPORT: "staff-salary-export",
		API_URN_STAFF_SALARY_SHOW: "staff-salary-show",
		API_URN_STAFF_SALARY_TABLE_DATA: "staff-salary-table-data",
		API_URN_STATUTORY_CONFIG_SHOW: "statutory-config-show",
		API_URN_STATUTORY_CONFIG_UPDATE: "statutory-config-update",
		API_URN_TDS_PRECEDENCE_SHOW: "tds-precedence-show",
		API_URN_YTD_OPENING_STORE: "ytd-opening-store",
		API_URN_YTD_OPENING_TABLE_DATA: "ytd-opening-table-data",

		// FRANCHISE (HEAD OFFICE) SEAT
		API_URN_FRANCHISE_FNF_SETTLEMENT_APPROVE: "franchise/fnf-settlement-approve",
		API_URN_FRANCHISE_FNF_SETTLEMENT_ELIGIBLE_STAFF: "franchise/fnf-settlement-eligible-staff",
		API_URN_FRANCHISE_FNF_SETTLEMENT_MARK_PAID: "franchise/fnf-settlement-mark-paid",
		API_URN_FRANCHISE_FNF_SETTLEMENT_PREVIEW: "franchise/fnf-settlement-preview",
		API_URN_FRANCHISE_FNF_SETTLEMENT_REOPEN: "franchise/fnf-settlement-reopen",
		API_URN_FRANCHISE_FNF_SETTLEMENT_SHOW: "franchise/fnf-settlement-show",
		API_URN_FRANCHISE_FNF_SETTLEMENT_STORE: "franchise/fnf-settlement-store",
		API_URN_FRANCHISE_FNF_SETTLEMENT_TABLE_DATA: "franchise/fnf-settlement-table-data",
		API_URN_FRANCHISE_PAYROLL_AUDIT_LOG_EXPORT: "franchise/payroll-audit-log-export",
		API_URN_FRANCHISE_PAYROLL_AUDIT_LOG_FILTER_OPTIONS: "franchise/payroll-audit-log-filter-options",
		API_URN_FRANCHISE_PAYROLL_AUDIT_LOG_TABLE_DATA: "franchise/payroll-audit-log-table-data",
		API_URN_FRANCHISE_PAYROLL_DASHBOARD: "franchise/payroll-dashboard",
		API_URN_FRANCHISE_PAYROLL_REPORT: "franchise/payroll-report",
		API_URN_FRANCHISE_PAYROLL_REPORT_EXPORT: "franchise/payroll-report-export",
		API_URN_FRANCHISE_PAYROLL_REPORT_LIST: "franchise/payroll-report-list",
		API_URN_FRANCHISE_PAYROLL_UNIT_SETTINGS_ACTIVATE: "franchise/payroll-unit-settings-activate",
		API_URN_FRANCHISE_PAYROLL_UNIT_SETTINGS_DEACTIVATE: "franchise/payroll-unit-settings-deactivate",
		API_URN_FRANCHISE_PAYROLL_UNIT_SETTINGS_OWNERSHIP_UPDATE: "franchise/payroll-unit-settings-ownership-update",
		API_URN_FRANCHISE_PAYROLL_UNIT_SETTINGS_SHOW: "franchise/payroll-unit-settings-show",
		API_URN_FRANCHISE_PAYROLL_UNIT_SETTINGS_TABLE_DATA: "franchise/payroll-unit-settings-table-data",
		API_URN_FRANCHISE_PAYROLL_UNIT_SETTINGS_UPDATE: "franchise/payroll-unit-settings-update",
		API_URN_FRANCHISE_PAYSLIP_BULK_EMAIL: "franchise/payslip-bulk-email",
		API_URN_FRANCHISE_PAYSLIP_BULK_ZIP: "franchise/payslip-bulk-zip",
		API_URN_FRANCHISE_PAYSLIP_BULK_ZIP_STATUS: "franchise/payslip-bulk-zip-status",
		API_URN_FRANCHISE_PAYSLIP_DOWNLOAD: "franchise/payslip-download",
		API_URN_FRANCHISE_PAYSLIP_EMAIL: "franchise/payslip-email",
		API_URN_FRANCHISE_PAYSLIP_SHOW: "franchise/payslip-show",
		API_URN_FRANCHISE_PAYSLIP_TABLE_DATA: "franchise/payslip-table-data",
		API_URN_FRANCHISE_PT_SLAB_STORE: "franchise/pt-slab-store",
		API_URN_FRANCHISE_PT_SLAB_TABLE_DATA: "franchise/pt-slab-table-data",
		API_URN_FRANCHISE_SALARY_ADVANCE_CLOSE: "franchise/salary-advance-close",
		API_URN_FRANCHISE_SALARY_ADVANCE_STORE: "franchise/salary-advance-store",
		API_URN_FRANCHISE_SALARY_ADVANCE_TABLE_DATA: "franchise/salary-advance-table-data",
		API_URN_FRANCHISE_SALARY_COMPONENT_CHANGE_STATUS: "franchise/salary-component-change-status",
		API_URN_FRANCHISE_SALARY_COMPONENT_STORE: "franchise/salary-component-store",
		API_URN_FRANCHISE_SALARY_COMPONENT_TABLE_DATA: "franchise/salary-component-table-data",
		API_URN_FRANCHISE_SALARY_RUN_APPROVE: "franchise/salary-run-approve",
		API_URN_FRANCHISE_SALARY_RUN_COMPUTE: "franchise/salary-run-compute",
		API_URN_FRANCHISE_SALARY_RUN_CREATE: "franchise/salary-run-create",
		API_URN_FRANCHISE_SALARY_RUN_EXCEPTION_RESOLVE: "franchise/salary-run-exception-resolve",
		API_URN_FRANCHISE_SALARY_RUN_INPUT_TABLE_DATA: "franchise/salary-run-input-table-data",
		API_URN_FRANCHISE_SALARY_RUN_INPUT_UPDATE: "franchise/salary-run-input-update",
		API_URN_FRANCHISE_SALARY_RUN_ITEM_SHOW: "franchise/salary-run-item-show",
		API_URN_FRANCHISE_SALARY_RUN_ITEM_TABLE_DATA: "franchise/salary-run-item-table-data",
		API_URN_FRANCHISE_SALARY_RUN_LOP_DAYS: "franchise/salary-run-lop-days",
		API_URN_FRANCHISE_SALARY_RUN_MARK_PAID: "franchise/salary-run-mark-paid",
		API_URN_FRANCHISE_SALARY_RUN_REOPEN: "franchise/salary-run-reopen",
		API_URN_FRANCHISE_SALARY_RUN_REVIEW: "franchise/salary-run-review",
		API_URN_FRANCHISE_SALARY_RUN_SEND_BACK: "franchise/salary-run-send-back",
		API_URN_FRANCHISE_SALARY_RUN_SHOW: "franchise/salary-run-show",
		API_URN_FRANCHISE_SALARY_RUN_VARIANCE_ACKNOWLEDGE: "franchise/salary-run-variance-acknowledge",
		API_URN_FRANCHISE_SALARY_STRUCTURE_CHANGE_STATUS: "franchise/salary-structure-change-status",
		API_URN_FRANCHISE_SALARY_STRUCTURE_DUPLICATE: "franchise/salary-structure-duplicate",
		API_URN_FRANCHISE_SALARY_STRUCTURE_PREVIEW: "franchise/salary-structure-preview",
		API_URN_FRANCHISE_SALARY_STRUCTURE_SCOPE_DESIGNATION_DROPDOWN: "franchise/salary-structure-scope-designation-dropdown",
		API_URN_FRANCHISE_SALARY_STRUCTURE_SCOPE_STAFF_DROPDOWN: "franchise/salary-structure-scope-staff-dropdown",
		API_URN_FRANCHISE_SALARY_STRUCTURE_SHOW: "franchise/salary-structure-show",
		API_URN_FRANCHISE_SALARY_STRUCTURE_STORE: "franchise/salary-structure-store",
		API_URN_FRANCHISE_SALARY_STRUCTURE_TABLE_DATA: "franchise/salary-structure-table-data",
		API_URN_FRANCHISE_SALARY_TRANSFER_SHEET: "franchise/salary-transfer-sheet",
		API_URN_FRANCHISE_SALARY_TRANSFER_SHEET_EXPORT: "franchise/salary-transfer-sheet-export",
		API_URN_FRANCHISE_STAFF_ATTENDANCE_SUMMARY: "franchise/staff-attendance-summary",
		API_URN_FRANCHISE_STAFF_IDENTITY_DEPARTMENT_LIST: "franchise/staff-identity-department-list",
		API_URN_FRANCHISE_STAFF_IDENTITY_SHOW: "franchise/staff-identity-show",
		API_URN_FRANCHISE_STAFF_IDENTITY_STORE: "franchise/staff-identity-store",
		API_URN_FRANCHISE_STAFF_SALARY_ARREARS_PREVIEW: "franchise/staff-salary-arrears-preview",
		API_URN_FRANCHISE_STAFF_SALARY_ASSIGN: "franchise/staff-salary-assign",
		API_URN_FRANCHISE_STAFF_SALARY_BULK_ASSIGN: "franchise/staff-salary-bulk-assign",
		API_URN_FRANCHISE_STAFF_SALARY_BULK_PREVIEW: "franchise/staff-salary-bulk-preview",
		API_URN_FRANCHISE_STAFF_SALARY_EXPORT: "franchise/staff-salary-export",
		API_URN_FRANCHISE_STAFF_SALARY_SHOW: "franchise/staff-salary-show",
		API_URN_FRANCHISE_STAFF_SALARY_TABLE_DATA: "franchise/staff-salary-table-data",
		API_URN_FRANCHISE_STATUTORY_CONFIG_SHOW: "franchise/statutory-config-show",
		API_URN_FRANCHISE_STATUTORY_CONFIG_UPDATE: "franchise/statutory-config-update",
		API_URN_FRANCHISE_TDS_PRECEDENCE_SHOW: "franchise/tds-precedence-show",
		API_URN_FRANCHISE_YTD_OPENING_STORE: "franchise/ytd-opening-store",
		API_URN_FRANCHISE_YTD_OPENING_TABLE_DATA: "franchise/ytd-opening-table-data",

		// STAFF SELF-SERVICE
		API_URN_STAFF_MY_PAYSLIP_DOWNLOAD: "staff/my-payslip-download",
		API_URN_STAFF_MY_PAYSLIP_SHOW: "staff/my-payslip-show",
		API_URN_STAFF_MY_PAYSLIP_TABLE_DATA: "staff/my-payslip-table-data",

	};

	const config_attendance_leave_approval = {
		// SETTINGS - GENERAL PREFERENCE
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_GENERAL_PREFERENCE_SHOW: "franchise/attendance-leave-general-preference-show",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_GENERAL_PREFERENCE_SET_CUTOVER: "franchise/attendance-leave-general-preference-set-cutover",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_GENERAL_PREFERENCE_UPDATE: "franchise/attendance-leave-general-preference-update",

		// RULES - ATTENDANCE
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_ATTENDANCE_RULE_TABLE_DATA: "franchise/attendance-leave-attendance-rule-table-data",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_ATTENDANCE_RULE_SHOW: "franchise/attendance-leave-attendance-rule-show",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_ATTENDANCE_RULE_STORE: "franchise/attendance-leave-attendance-rule-store",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_ATTENDANCE_RULE_UPDATE: "franchise/attendance-leave-attendance-rule-update",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_ATTENDANCE_RULE_CLONE: "franchise/attendance-leave-attendance-rule-clone",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_ATTENDANCE_RULE_DEACTIVATE: "franchise/attendance-leave-attendance-rule-deactivate",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_ATTENDANCE_RULE_SET_STATUS: "franchise/attendance-leave-attendance-rule-set-status",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_ATTENDANCE_RULE_SET_DEFAULT: "franchise/attendance-leave-attendance-rule-set-default",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_ATTENDANCE_RULE_VERSION_HISTORY: "franchise/attendance-leave-attendance-rule-version-history",

		// RULES - LEAVE
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_LEAVE_RULE_TABLE_DATA: "franchise/attendance-leave-leave-rule-table-data",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_LEAVE_RULE_SHOW: "franchise/attendance-leave-leave-rule-show",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_LEAVE_RULE_STORE: "franchise/attendance-leave-leave-rule-store",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_LEAVE_RULE_UPDATE: "franchise/attendance-leave-leave-rule-update",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_LEAVE_RULE_DEACTIVATE: "franchise/attendance-leave-leave-rule-deactivate",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_LEAVE_RULE_SET_STATUS: "franchise/attendance-leave-leave-rule-set-status",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_LEAVE_RULE_SET_DEFAULT: "franchise/attendance-leave-leave-rule-set-default",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_LEAVE_RULE_VERSION_HISTORY: "franchise/attendance-leave-leave-rule-version-history",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_LEAVE_TYPE_OPTIONS: "franchise/attendance-leave-leave-type-options",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_LEAVE_TYPE_MASTER_LIST: "franchise/attendance-leave-leave-type-master-list",

		// RULES - ASSIGNMENT
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_RULE_ASSIGNMENT_TABLE_DATA: "franchise/attendance-leave-rule-assignment-table-data",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_RULE_ASSIGNMENT_COVERAGE_COUNTS: "franchise/attendance-leave-rule-assignment-coverage-counts",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_RULE_OPTIONS: "franchise/attendance-leave-rule-options",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_RULE_ASSIGNMENT_STORE: "franchise/attendance-leave-rule-assignment-store",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_RULE_ASSIGNMENT_BULK_STORE: "franchise/attendance-leave-rule-assignment-bulk-store",

		// REPORTS - MONTHLY GRID
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_MONTHLY_GRID: "franchise/attendance-leave-monthly-grid",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_BULK_UPDATE_STATUS: "franchise/attendance-leave-bulk-update-status",

		// REPORTS - MONTH LOCK
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_MONTH_LOCK_LIST: "franchise/attendance-leave-month-lock-list",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_MONTH_LOCK_LOCK: "franchise/attendance-leave-month-lock-lock",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_MONTH_LOCK_UNLOCK: "franchise/attendance-leave-month-lock-unlock",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_MONTH_OPTIONS: "franchise/attendance-leave-month-options",

		// REPORTS - LOP SUMMARY
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_LOP_SUMMARY: "franchise/attendance-leave-lop-summary",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_LOP_SUMMARY_EXPORT: "franchise/attendance-leave-lop-summary-export",

		// REPORTS - OPENING BALANCES
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_OPENING_BALANCE_TABLE_DATA: "franchise/attendance-leave-opening-balance-table-data",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_OPENING_BALANCE_STORE: "franchise/attendance-leave-opening-balance-store",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_OPENING_BALANCE_BULK_STORE: "franchise/attendance-leave-opening-balance-bulk-store",

		// MANAGE - DAILY MARKING
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_DAILY_ROSTER: "franchise/attendance-leave-daily-roster",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_MARK_ATTENDANCE: "franchise/attendance-leave-mark-attendance",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_MARK_ALL_PRESENT: "franchise/attendance-leave-mark-all-present",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_MARK_REMAINING_PRESENT: "franchise/attendance-leave-mark-remaining-present",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_ATTENDANCE_CLEAR: "franchise/attendance-leave-attendance-clear",

		// MANAGE - REGULARISATION
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_REGULARISATION_REQUEST_TABLE_DATA: "franchise/attendance-leave-regularisation-request-table-data",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_REGULARISATION_REQUEST_APPROVE: "franchise/attendance-leave-regularisation-request-approve",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_REGULARISATION_REQUEST_REJECT: "franchise/attendance-leave-regularization-request-reject",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_REGULARISATION_REQUEST_BULK_APPROVE: "franchise/attendance-leave-regularisation-request-bulk-approve",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_REGULARISATION_REQUEST_STORE: "franchise/attendance-leave-regularisation-request-store",

		// MANAGE - LEAVE APPROVAL
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_LEAVE_APPLICATION_TABLE_DATA: "franchise/attendance-leave-leave-application-table-data",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_LEAVE_APPLICATION_BULK_APPROVE: "franchise/attendance-leave-leave-application-bulk-approve",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_LEAVE_APPLICATION_APPROVE: "franchise/attendance-leave-leave-application-approve",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_LEAVE_APPLICATION_REJECT: "franchise/attendance-leave-leave-application-reject",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_LEAVE_APPLICATION_STORE: "franchise/attendance-leave-leave-application-store",

		// APPROVAL MATRIX
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_APPROVAL_RIGHT_TABLE_DATA: "franchise/attendance-leave-approval-right-table-data",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_APPROVAL_RIGHT_STORE: "franchise/attendance-leave-approval-right-store",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_APPROVAL_RIGHT_ACTIVATE: "franchise/attendance-leave-approval-right-activate",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_APPROVAL_CONFIG_SHOW: "franchise/attendance-leave-approval-config-show",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_APPROVAL_CONFIG_UPDATE: "franchise/attendance-leave-approval-config-update",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_APPROVAL_RIGHT_DESTROY: "franchise/attendance-leave-approval-right-destroy",

		// ATTENDANCE IMPORT
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_IMPORT_TEMPLATE: "franchise/attendance-leave-import-template",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_IMPORT_PREVIEW: "franchise/attendance-leave-import-preview",
		API_URN_FRANCHISE_ATTENDANCE_LEAVE_IMPORT_COMMIT: "franchise/attendance-leave-import-commit",

		// Staff self-service (Staff Marking API, Node /api/v2/self/*): my attendance, leave, corrections, approver inbox.
		API_URN_SELF_ATTENDANCE_LEAVE_MY_ATTENDANCE: "self/attendance-leave-my-attendance",
		API_URN_SELF_ATTENDANCE_LEAVE_SELF_MARK_ATTENDANCE: "self/attendance-leave-self-mark-attendance",
		API_URN_SELF_ATTENDANCE_LEAVE_MONTH_LOCK_SHOW: "self/attendance-leave-month-lock-show",
		API_URN_SELF_ATTENDANCE_LEAVE_MY_LEAVE_BALANCE: "self/attendance-leave-my-leave-balance",
		API_URN_SELF_ATTENDANCE_LEAVE_LEAVE_LEDGER_DRILLDOWN: "self/attendance-leave-leave-ledger-drilldown",
		API_URN_SELF_ATTENDANCE_LEAVE_LEAVE_APPLICATION_STORE: "self/attendance-leave-leave-application-store",
		API_URN_SELF_ATTENDANCE_LEAVE_LEAVE_APPLICATION_CANCEL: "self/attendance-leave-leave-application-cancel",
		API_URN_SELF_ATTENDANCE_LEAVE_MY_LEAVE_APPLICATIONS: "self/attendance-leave-my-leave-applications",
		API_URN_SELF_ATTENDANCE_LEAVE_REGULARISATION_REQUEST_STORE: "self/attendance-leave-regularisation-request-store",
		API_URN_SELF_ATTENDANCE_LEAVE_REGULARISATION_REQUEST_CANCEL: "self/attendance-leave-regularisation-request-cancel",
		API_URN_SELF_ATTENDANCE_LEAVE_MY_REGULARISATION_REQUESTS: "self/attendance-leave-my-regularisation-requests",
		API_URN_SELF_ATTENDANCE_LEAVE_LEAVE_APPLICATION_TABLE_DATA: "self/attendance-leave-leave-application-table-data",
		API_URN_SELF_ATTENDANCE_LEAVE_LEAVE_APPLICATION_APPROVE: "self/attendance-leave-leave-application-approve",
		API_URN_SELF_ATTENDANCE_LEAVE_LEAVE_APPLICATION_REJECT: "self/attendance-leave-leave-application-reject",
		API_URN_SELF_ATTENDANCE_LEAVE_REGULARISATION_REQUEST_TABLE_DATA: "self/attendance-leave-regularisation-request-table-data",
		API_URN_SELF_ATTENDANCE_LEAVE_REGULARISATION_REQUEST_APPROVE: "self/attendance-leave-regularisation-request-approve",
		API_URN_SELF_ATTENDANCE_LEAVE_REGULARISATION_REQUEST_REJECT: "self/attendance-leave-regularisation-request-reject",
	};

	const config_dynamic_design = {
		// DESIGN TYPE
		API_URN_DYNAMIC_DESIGN_TYPE_TABLE_DATA: "dynamic-design-type-table-data",
		API_URN_DYNAMIC_DESIGN_TYPE_DROPDOWN: "dynamic-design-type-dropdown",
		API_URN_DYNAMIC_DESIGN_TYPE_STORE: "dynamic-design-type-store",
		API_URN_DYNAMIC_DESIGN_TYPE_UPDATE: "dynamic-design-type-update",
		API_URN_DYNAMIC_DESIGN_TYPE_DESTROY: "dynamic-design-type-destroy",

		// DESIGN TEMPLATE
		API_URN_DYNAMIC_DESIGN_TEMPLATE_TABLE_DATA: "dynamic-design-template-table-data",
		API_URN_DYNAMIC_DESIGN_TEMPLATE_DROPDOWN: "dynamic-design-template-dropdown",
		API_URN_DYNAMIC_DESIGN_TEMPLATE_SHOW: "dynamic-design-template-show",
		API_URN_DYNAMIC_DESIGN_TEMPLATE_STORE: "dynamic-design-template-store",
		API_URN_DYNAMIC_DESIGN_TEMPLATE_UPDATE: "dynamic-design-template-update",
		API_URN_DYNAMIC_DESIGN_TEMPLATE_DESTROY: "dynamic-design-template-destroy",

		// IMAGE LIBRARY
		API_URN_DYNAMIC_DESIGN_IMAGE_UPLOAD: "dynamic-design-image-upload",
		API_URN_DYNAMIC_DESIGN_IMAGE_TABLE_DATA: "dynamic-design-image-table-data",
		API_URN_DYNAMIC_DESIGN_IMAGE_DESTROY: "dynamic-design-image-destroy",

		// MERGE FIELDS
		API_URN_DYNAMIC_DESIGN_STUDENT_FIELDS: "dynamic-design-student-fields",
		API_URN_DYNAMIC_DESIGN_STAFF_FIELDS: "dynamic-design-staff-fields",

		// SETTINGS
		API_URN_DYNAMIC_DESIGN_SETTING_SHOW: "dynamic-design-setting-show",

		// FRANCHISE - DESIGN TYPE
		API_URN_FRANCHISE_DYNAMIC_DESIGN_TYPE_TABLE_DATA: "franchise/dynamic-design-type-table-data",
		API_URN_FRANCHISE_DYNAMIC_DESIGN_TYPE_DROPDOWN: "franchise/dynamic-design-type-dropdown",
		API_URN_FRANCHISE_DYNAMIC_DESIGN_TYPE_STORE: "franchise/dynamic-design-type-store",
		API_URN_FRANCHISE_DYNAMIC_DESIGN_TYPE_UPDATE: "franchise/dynamic-design-type-update",
		API_URN_FRANCHISE_DYNAMIC_DESIGN_TYPE_PUBLISH: "franchise/dynamic-design-type-publish",
		API_URN_FRANCHISE_DYNAMIC_DESIGN_TYPE_DESTROY: "franchise/dynamic-design-type-destroy",

		// FRANCHISE - DESIGN TEMPLATE
		API_URN_FRANCHISE_DYNAMIC_DESIGN_TEMPLATE_TABLE_DATA: "franchise/dynamic-design-template-table-data",
		API_URN_FRANCHISE_DYNAMIC_DESIGN_TEMPLATE_SHOW: "franchise/dynamic-design-template-show",
		API_URN_FRANCHISE_DYNAMIC_DESIGN_TEMPLATE_STORE: "franchise/dynamic-design-template-store",
		API_URN_FRANCHISE_DYNAMIC_DESIGN_TEMPLATE_UPDATE: "franchise/dynamic-design-template-update",
		API_URN_FRANCHISE_DYNAMIC_DESIGN_TEMPLATE_PUBLISH: "franchise/dynamic-design-template-publish",
		API_URN_FRANCHISE_DYNAMIC_DESIGN_TEMPLATE_CLONE: "franchise/dynamic-design-template-clone",
		API_URN_FRANCHISE_DYNAMIC_DESIGN_TEMPLATE_DESTROY: "franchise/dynamic-design-template-destroy",

		// FRANCHISE - SCOPE & BRANCHES
		API_URN_FRANCHISE_DYNAMIC_DESIGN_BRANCH_DROPDOWN: "franchise/dynamic-design-branch-dropdown",
		API_URN_FRANCHISE_DYNAMIC_DESIGN_TEMPLATE_BRANCH_TABLE_DATA: "franchise/dynamic-design-template-branch-table-data",

		// FRANCHISE - IMAGE LIBRARY
		API_URN_FRANCHISE_DYNAMIC_DESIGN_IMAGE_UPLOAD: "franchise/dynamic-design-image-upload",
		API_URN_FRANCHISE_DYNAMIC_DESIGN_IMAGE_TABLE_DATA: "franchise/dynamic-design-image-table-data",
		API_URN_FRANCHISE_DYNAMIC_DESIGN_IMAGE_DESTROY: "franchise/dynamic-design-image-destroy",

		// FRANCHISE - SETTINGS
		API_URN_FRANCHISE_DYNAMIC_DESIGN_SETTING_EDIT: "franchise/dynamic-design-setting-edit",
		API_URN_FRANCHISE_DYNAMIC_DESIGN_SETTING_UPDATE: "franchise/dynamic-design-setting-update",
	};

	const config_broadcast = {
		API_URN_BROADCAST_LIST_ADMIN: "admin/broadcast-data",
		API_URN_BROADCAST_LIST_STAFF: "staff/broadcast-data",
		API_URN_BROADCAST_LIST_STUDENT: "student/broadcast-data",
		API_URN_BROADCAST_UNREAD_LIST_ADMIN: "admin/unread-broadcast-data",
		API_URN_BROADCAST_UNREAD_LIST_STAFF: "staff/unread-broadcast-data",
		API_URN_BROADCAST_UNREAD_LIST_STUDENT: "student/unread-broadcast-data",
		API_URN_BROADCAST_SHOW_ADMIN: "admin/broadcast-show",
		API_URN_BROADCAST_STORE_ADMIN: "admin/broadcast-store",
		API_URN_BROADCAST_UPDATE_ADMIN: "admin/broadcast-update",
		API_URN_BROADCAST_DESTROY_ADMIN: "admin/broadcast-destroy",
		API_URN_BROADCAST_MARK_AS_READ: "broadcast/mark-as-read",
	};
	...
	const config_visitor_register = {
		...
		API_URN_VISITOR_REGISTER_STORE_GUEST: "visitor-register-store",

		API_URN_VISITOR_REGISTER_SETTING_STORE: "visitor-register-setting-store",
		API_URN_VISITOR_REGISTER_SETTING_SHOW: "visitor-register-setting-show",
		API_URN_VISITOR_REGISTER_TYPE_SHOW: "visitor-register-type-show",
		API_URN_VISITOR_REGISTER_UPDATE_STATUS: "visitor-register-status-update",
		API_URN_VISITOR_REGISTER_PENDING_TABLE_DATA: "visitor-register-pending-table-data",
		API_URN_VISITOR_REGISTER_GUEST_STORE: "guest-visitor-register",
	}
	...
	const config_kit_ordering = {
		...
		API_URN_ORDER_PRODUCT_EXPORT_ADMIN: "admin/order-export",
		...
		API_URN_KIT_ORDERING_CLASS_DROPDOWN_ADMIN: "admin/cart-product-class-dropdown",
	...
	const config_curriculum = {
		...
		API_URN_CURRICULUM_SCHOOL_CURRICULUM_LIST: "school/curriculum-list",
		API_URN_CURRICULUM_SCHOOL_CURRICULUM_CHAPTER_SHOW: "school/curriculum-chapter-show",
		API_URN_CURRICULUM_SCHOOL_CURRICULUM_TOPIC_SHOW: "school/curriculum-topic-show",
		API_URN_CURRICULUM_SCHOOL_CURRICULUM_SUBTOPIC_SHOW: "school/curriculum-subtopic-show",
		API_URN_CURRICULUM_SCHOOL_CURRICULUM_SUBTOPIC_CONTENT: "school/curriculum-subtopic-content",
		...
		API_URN_ADMIN_CURRICULUM_LESSON_PLAN_LIST: "admin/curriculum-lesson-plan-list",
		API_URN_ADMIN_CURRICULUM_LESSON_PLAN_ALLOCATED_STAFF_LIST: "admin/curriculum-lesson-plan-allocated-staff-list",
		API_URN_ADMIN_CURRICULUM_LESSON_PLAN_ALLOCATE_DEALLOCATE_STAFF: "admin/curriculum-lesson-plan-allocate-deallocate-staff",
		API_URN_ADMIN_CURRICULUM_LESSON_PLAN_STAFF_DROPDOWN: "admin/curriculum-lesson-plan-allocate-staff-dropdown",
		API_URN_ADMIN_CURRICULUM_LESSON_PLAN_SHOW: "admin/curriculum-lesson-plan",
		API_URN_ADMIN_CURRICULUM_LESSON_PLAN_SHOW_DATA: "admin/curriculum-lesson-plan-data",
		API_URN_ADMIN_CURRICULUM_LESSON_PLAN_SHOW_SUB_TOPIC_DATA: "admin/curriculum-lesson-plan-sub-topic-data",
		API_URN_STAFF_CURRICULUM_LESSON_PLAN_LIST: "staff/curriculum-lesson-plan-list",
		API_URN_STAFF_CURRICULUM_LESSON_PLAN_SHOW: "staff/curriculum-lesson-plan",
		API_URN_STAFF_CURRICULUM_LESSON_PLAN_SUB_TOPIC_SHOW: "staff/curriculum-lesson-plan-sub-topic-show",
		API_URN_STAFF_CURRICULUM_LESSON_PLAN_CHAPTER_DROPDOWN: "staff/curriculum-lesson-plan-chapter-dropdown",
		API_URN_STAFF_CURRICULUM_LESSON_PLAN_SUB_TOPIC_PROGRESS_UPDATE: "staff/curriculum-lesson-plan-sub-topic-progress-update",
		API_URN_STAFF_CURRICULUM_LESSON_PLAN_TOPIC_SHOW: "staff/curriculum-lesson-plan-topic-show",
		...
		API_URN_TEACHER_CURRICULUM_EVALUATION: "teacher/curriculum-evaluate",
		API_URN_TEACHER_CURRICULUM_STUDENT_LIST: "teacher/curriculum-evaluate-student-list",

		//FRANCHISE
		API_URN_FRANCHISE_CURRICULUM_PROVIDER_CATEGORY: "franchise/curriculum-provider-category",
		API_URN_FRANCHISE_CURRICULUM_PROVIDER_CATEGORY_LIST: "franchise/curriculum-provider-category-list",
		API_URN_FRANCHISE_CURRICULUM_ASSIGNED_TEACHERS_DELETE: "school/curriculum-assign-teacher-destroy",
	}

	const curriculum_provider = {
		API_URN_GET_CURRICULLUM_PROVIDER_USER_DATA: "get-provider-user-data",
		// Provider Setting Evaluation Legend API's
		API_URN_PROVIDER_SETTING_EVALUATION_LEGEND_STORE: "provider/setting/evaluation/legend/store",
		API_URN_PROVIDER_SETTING_EVALUATION_LEGEND_EDIT: "provider/setting/evaluation/legend/edit",
		API_URN_PROVIDER_SETTING_EVALUATION_LEGEND_UPDATE: "provider/setting/evaluation/legend/update",
		API_URN_PROVIDER_SETTING_EVALUATION_LEGEND_UPDATE_STATUS: "provider/setting/evaluation/legend/update-status",
		API_URN_PROVIDER_SETTING_EVALUATION_LEGEND_DESTROY: "provider/setting/evaluation/legend/destroy",
		API_URN_PROVIDER_SETTING_EVALUATION_LEGEND_UNDO_DESTROY: "provider/setting/evaluation/legend/undo-destroy",
		API_URN_PROVIDER_SETTING_EVALUATION_LEGEND_TABLE_DATA: "provider/setting/evaluation/legend/table-data",
		API_URN_PROVIDER_SETTING_EVALUATION_LEGEND_DROPDOWN: "provider/setting/evaluation/legend/dropdown",

		// Provider Setting Evaluation Remark API's
		API_URN_PROVIDER_SETTING_EVALUATION_REMARK_STORE: "provider/setting/evaluation/remark/store",
		API_URN_PROVIDER_SETTING_EVALUATION_REMARK_EDIT: "provider/setting/evaluation/remark/edit",
		API_URN_PROVIDER_SETTING_EVALUATION_REMARK_UPDATE: "provider/setting/evaluation/remark/update",
		API_URN_PROVIDER_SETTING_EVALUATION_REMARK_UPDATE_STATUS: "provider/setting/evaluation/remark/update-status",
		API_URN_PROVIDER_SETTING_EVALUATION_REMARK_DESTROY: "provider/setting/evaluation/remark/destroy",
		API_URN_PROVIDER_SETTING_EVALUATION_REMARK_UNDO_DESTROY: "provider/setting/evaluation/remark/undo-destroy",
		API_URN_PROVIDER_SETTING_EVALUATION_REMARK_TABLE_DATA: "provider/setting/evaluation/remark/table-data",
		API_URN_PROVIDER_SETTING_EVALUATION_REMARK_DROPDOWN: "provider/setting/evaluation/remark/dropdown",

		// Provider Setting Subject API's
		API_URN_PROVIDER_SETTING_SUBJECT_STORE: "provider/setting/subject/store",
		API_URN_PROVIDER_SETTING_SUBJECT_EDIT: "provider/setting/subject/edit",
		API_URN_PROVIDER_SETTING_SUBJECT_UPDATE: "provider/setting/subject/update",
		API_URN_PROVIDER_SETTING_SUBJECT_UPDATE_STATUS: "provider/setting/subject/update-status",
		API_URN_PROVIDER_SETTING_SUBJECT_DESTROY: "provider/setting/subject/destroy",
		API_URN_PROVIDER_SETTING_SUBJECT_UNDO_DESTROY: "provider/setting/subject/undo-destroy",
		API_URN_PROVIDER_SETTING_SUBJECT_TABLE_DATA: "provider/setting/subject/table-data",
		API_URN_PROVIDER_SETTING_SUBJECT_DROPDOWN: "provider/setting/subject/dropdown",
		API_URN_PROVIDER_SETTING_SUBJECT_LEARNING_DROPDOWN: "provider/setting/subject/learning-dropdown",
		API_URN_PROVIDER_SETTING_SUBJECT_LEARNING_DESTROY: "provider/setting/subject/learning-destroy",
		API_URN_PROVIDER_SETTING_SUBJECT_LEARNING_UNDO_DESTROY: "provider/setting/subject/learning-undo-destroy",

		// Provider School API's
		API_URN_PROVIDER_SCHOOL_STORE: "provider/curriculum/school/store",
		API_URN_PROVIDER_SCHOOL_TABLE_DATA: "provider/curriculum/school/table-data",

		// Provider Setting Action API's
		API_URN_PROVIDER_SETTING_ACTION_STORE: "provider/setting/action/store",
		API_URN_PROVIDER_SETTING_ACTION_EDIT: "provider/setting/action/edit",
		API_URN_PROVIDER_SETTING_ACTION_UPDATE: "provider/setting/action/update",
		API_URN_PROVIDER_SETTING_ACTION_UPDATE_STATUS: "provider/setting/action/update-status",
		API_URN_PROVIDER_SETTING_ACTION_DESTROY: "provider/setting/action/destroy",
		API_URN_PROVIDER_SETTING_ACTION_UNDO_DESTROY: "provider/setting/action/undo-destroy",
		API_URN_PROVIDER_SETTING_ACTION_TABLE_DATA: "provider/setting/action/table-data",
		API_URN_PROVIDER_SETTING_ACTION_DROPDOWN: "provider/setting/action/dropdown",

		// Provider Setting Curriculum Store API's
		API_URN_PROVIDER_CURRICULUM_TABLE_DATA: "provider/curriculum/table-data",
		API_URN_PROVIDER_CURRICULUM_STORE: "provider/curriculum/store",
		API_URN_PROVIDER_CURRICULUM_DESTROY: "provider/curriculum/destroy",
		API_URN_PROVIDER_CURRICULUM_EDIT: "provider/curriculum/edit",
		API_URN_PROVIDER_CURRICULUM_DESTROY_CONTENT: "provider/curriculum/destroy-content",
		API_URN_PROVIDER_CURRICULUM_EDIT_CONTENT: "provider/curriculum/edit-content",
		API_URN_PROVIDER_CURRICULUM_UPDATE: "provider/curriculum/update",
		API_URN_PROVIDER_CURRICULUM_UPDATE_STATUS: "provider/curriculum/update-status",
		API_URN_PROVIDER_CURRICULUM_UPDATE_TOPIC_CONTENT: "provider/curriculum/update-content",

		API_URN_PROVIDER_CURRICULUM_ADD_CHAPTER: "provider/curriculum/add-chapter",
		API_URN_PROVIDER_CURRICULUM_REORDER_CHAPTER: "provider/curriculum/reorder-chapter",
		API_URN_PROVIDER_CURRICULUM_ADD_CHAPTER_TOPIC: "provider/curriculum/add-chapter-topic",
		API_URN_PROVIDER_CURRICULUM_REORDER_CHAPTER_TOPIC: "provider/curriculum/reorder-chapter-topic",
		API_URN_PROVIDER_CURRICULUM_ADD_CHAPTER_TOPIC_SUBTOPIC: "provider/curriculum/add-chapter-sub-topic",
		API_URN_PROVIDER_CURRICULUM_REORDER_CHAPTER_TOPIC_SUBTOPIC: "provider/curriculum/reorder-chapter-sub-topic",
		API_URN_PROVIDER_CURRICULUM_UPDATE_CHAPTER_SUBTOPIC: "provider/curriculum/update-chapter-sub-topic",
		API_URN_PROVIDER_CURRICULUM_REORDER_CHAPTER_SUBTOPIC_CONTENT: "provider/curriculum/reorder-chapter-sub-topic-content",
		API_URN_PROVIDER_CURRICULUM_EDIT_CHAPTER_SUBTOPIC: "provider/curriculum/edit-chapter-sub-topic",
		API_URN_PROVIDER_CURRICULUM_DESTROY_CHAPTER_SUB_TOPIC_CONTENT: "provider/curriculum/destroy-chapter-sub-topic-content",
		API_URN_PROVIDER_CURRICULUM_DESTROY_CHAPTER_SUB_TOPIC_CONTENT_MEDIA: "provider/curriculum/destroy-chapter-sub-topic-content-media",
		API_URN_PROVIDER_CURRICULUM_ADD_SUBJECT: "provider/curriculum/add-subject",
		API_URN_PROVIDER_CURRICULUM_DIARY_DOCUMENT_DELETE: "provider/curriculum/destroy-chapter-sub-topic-diary-media",

		// Provider Account API's
		API_URN_PROVIDER_ACCOUNT_LOGIN: "provider/account/login",
		API_URN_PROVIDER_ACCOUNT_UPDATE: "provider/account/update",
		API_URN_PROVIDER_ACCOUNT_UPDATE_ORGANIZATION: "provider/account/update-organization",
		API_URN_PROVIDER_ACCOUNT_DETAIL: "provider/account/account-detail",
		API_URN_PROVIDER_ACCOUNT_GET_USER_DATA: "provider/account/me",
		API_URN_PROVIDER_ACCOUNT_MODULES: "provider/account/modules",
		API_URN_PROVIDER_ACCOUNT_LOGOUT: "provider/account/logout",

		// Provider Setting Class API's
		API_URN_PROVIDER_SETTING_CLASS_STORE: "provider/setting/class/store",
		API_URN_PROVIDER_SETTING_CLASS_EDIT: "provider/setting/class/edit",
		API_URN_PROVIDER_SETTING_CLASS_UPDATE: "provider/setting/class/update",
		API_URN_PROVIDER_SETTING_CLASS_UPDATE_STATUS: "provider/setting/class/update-status",
		API_URN_PROVIDER_SETTING_CLASS_DESTROY: "provider/setting/class/destroy",
		API_URN_PROVIDER_SETTING_CLASS_UNDO_DESTROY: "provider/setting/class/undo-destroy",
		API_URN_PROVIDER_SETTING_CLASS_TABLE_DATA: "provider/setting/class/table-data",
		API_URN_PROVIDER_SETTING_CLASS_DROPDOWN: "provider/setting/class/dropdown",

		// Provider Setting Category API's
		API_URN_PROVIDER_SETTING_CATEGORY_STORE: "provider/setting/category/store",
		API_URN_PROVIDER_SETTING_CATEGORY_EDIT: "provider/setting/category/edit",
		API_URN_PROVIDER_SETTING_CATEGORY_UPDATE: "provider/setting/category/update",
		API_URN_PROVIDER_SETTING_CATEGORY_UPDATE_STATUS: "provider/setting/category/update-status",
		API_URN_PROVIDER_SETTING_CATEGORY_DESTROY: "provider/setting/category/destroy",
		API_URN_PROVIDER_SETTING_CATEGORY_UNDO_DESTROY: "provider/setting/category/undo-destroy",
		API_URN_PROVIDER_SETTING_CATEGORY_TABLE_DATA: "provider/setting/category/table-data",
		API_URN_PROVIDER_SETTING_CATEGORY_DROPDOWN: "provider/setting/category/dropdown",

		// Provider Files Curriculum API's
		API_URN_PROVIDER_FILE_STORE: "provider/files/store",
		API_URN_PROVIDER_FILE_RENAME: "provider/files/rename",
		API_URN_PROVIDER_FILE_TABLE_DATA: "provider/files/table-data",
		API_URN_PROVIDER_FILE_FETCH_CONTENT: "provider/files/fetch-content",
		API_URN_PROVIDER_FILE_DESTROY: "provider/files/destroy",
		API_URN_PROVIDER_FILE_RESTORE: "provider/files/restore",

		// Provider Staff API's
		API_URN_PROVIDER_STAFF_STORE: "provider/staff/store",
		API_URN_PROVIDER_STAFF_SHOW: "provider/staff/show",
		API_URN_PROVIDER_STAFF_EDIT: "provider/staff/edit",
		API_URN_PROVIDER_STAFF_UPDATE: "provider/staff/update",
		API_URN_PROVIDER_STAFF_UPDATE_STATUS: "provider/staff/update-status",
		API_URN_PROVIDER_STAFF_DESTROY: "provider/staff/destroy",
		API_URN_PROVIDER_STAFF_UNDO_DESTROY: "provider/staff/undo-destroy",
		API_URN_PROVIDER_STAFF_TABLE_DATA: "provider/staff/table-data",
		API_URN_PROVIDER_STAFF_DROPDOWN: "provider/staff/dropdown",

		// Provider Designation/Roles API's
		API_URN_PROVIDER_STAFF_ROLES_STORE: "provider/staff/roles/store",
		API_URN_PROVIDER_STAFF_ROLES_EDIT: "provider/staff/roles/edit",
		API_URN_PROVIDER_STAFF_ROLES_UPDATE: "provider/staff/roles/update",
		API_URN_PROVIDER_STAFF_ROLES_UPDATE_STATUS: "provider/staff/roles/update-status",
		API_URN_PROVIDER_STAFF_ROLES_DESTROY: "provider/staff/roles/destroy",
		API_URN_PROVIDER_STAFF_ROLES_UNDO_DESTROY: "provider/staff/roles/undo-destroy",
		API_URN_PROVIDER_STAFF_ROLES_TABLE_DATA: "provider/staff/roles/table-data",
		API_URN_PROVIDER_STAFF_ROLES_DROPDOWN: "provider/staff/roles/dropdown",

		// Provider Rights API's
		API_URN_PROVIDER_STAFF_RIGHTS_PERMISSIONS: "provider/staff/rights/permissions",
		API_URN_PROVIDER_STAFF_RIGHTS_UPDATE_PERMISSIONS: "provider/staff/rights/update-permissions",

		// Provider Storage API's
		API_URN_PROVIDER_STORAGE_STORE: "provider/storage/store",
		API_URN_PROVIDER_STORAGE_EDIT: "provider/storage/edit",

		// Provider Dashboard API's
		API_URN_PROVIDER_DASHBOARD_CURRICULUM_STATS: "provider/dashboard/curriculum-stats",
		API_URN_PROVIDER_DASHBOARD_SCHOOL_STATS: "provider/dashboard/school-stats",
		API_URN_PROVIDER_DASHBOARD_ACTIVITIES: "provider/dashboard/activities",
		API_URN_PROVIDER_DASHBOARD_CURRICULUM_ACTIVITIES: "provider/dashboard/curriculum-activities",
	}

	const config_payment = {
		API_URN_PROCESS_FEE_PAYMENT: "process-fee-payment",
		API_URN_PROCESS_GUEST_PAYMENT: "process-guest-payment",
		API_URN_PROCESS_BILL_FEE_PAYMENT: "process-bill-fee-payment",
		...
		API_URN_SEND_PAYEMENT_REQUEST: "send-payment-request"
	}
	...
	const config_meeting_room = {
		...
		API_URN_MEETING_ROOM_MARK_READ_ADMIN: "meeting-room-mark-read"
	}
	...
	const config_bustracking = {
		API_URN_BUSTRACKING_BUS_ROUTE_VIEW_ADMIN: "bus-tracking-student-table-data",
		API_URN_BUSTRACKING_BUS_STORE_ADMIN: "bus-store",
		API_URN_BUSTRACKING_SEND_ALERT_ADMIN: "bus-tracking-send-alert",
		...
		API_URN_BUSTRACKING_BUS_LIVE_LOCATION: "bus-tracking-live-location",
		API_URN_BUSTRACKING_BUS_JOURNEY_STOP_LIST: "bus-journey-stop-list",
	...
	/***************************** BILLING MODULE ON FRANCHISE AND ADMIN SIDE *****************************/
	const config_billing = {

		/*************************************** ADMIN SIDE **********************************************/

		/***************************** ADMIN SIDE BILLING MODULE VIEW API'S *****************************/
		API_URN_BILLING_ADMIN_VIEW_DASHBOARD_TOTAL_BILL: "billing-total-fee",
		API_URN_BILLING_ADMIN_VIEW_DASHBOARD_RECENT_BILL: "billing-recent",
		API_URN_BILLING_ADMIN_VIEW_DASHBOARD_MONTHLY_REPORT: "billing-monthly-report",
		API_URN_BILLING_ADMIN_VIEW_DASHBOARD_CATEGORY_REPORT: "billing-category-report",

		/***************************** ADMIN SIDE BILLING MODULE CATEGORY API'S *****************************/
		API_URN_BILLING_ADMIN_CATEGORY_ADD: "billing-category-store",
		API_URN_BILLING_ADMIN_CATEGORY_EDIT: "billing-category-edit",
		API_URN_BILLING_ADMIN_CATEGORY_UPDATE: "billing-category-update",
		API_URN_BILLING_ADMIN_CATEGORY_DELETE: "billing-category-destroy",
		API_URN_BILLING_ADMIN_CATEGORY_DELETE_ROW: "billing-category-item-destroy",
		API_URN_BILLING_ADMIN_CATEGORY_LIST: "billing-category-table-data",
		API_URN_BILLING_ADMIN_CATEGORY_DROPDOWN: "billing-category-dropdown",
		API_URN_BILLING_ADMIN_CATEGORY_SUB_CATAGORY_DROPDOWN: "billing-sub-category-dropdown",
		API_URN_BILLING_ADMIN_CATEGORY_CHANGE_STATUS: "billing-category-change-status",

		/***************************** ADMIN SIDE BILLING MODULE REPORT API'S *****************************/
		API_URN_BILLING_ADMIN_REPORT_CATEGORY_WISE: "billing-category-report-table-data",
		API_URN_BILLING_ADMIN_REPORT_CATEGORY_WISE_VIEW: "billing-category-report-view",
		API_URN_BILLING_ADMIN_REPORT_COLLECTED: "billing-collected-report-table-data",
		API_URN_BILLING_ADMIN_REPORT_COLLECTED_EXPORT: "billing-collected-report-export",
		API_URN_BILLING_ADMIN_REPORT_PENDING: "billing-pending-report-table-data",
		API_URN_BILLING_ADMIN_REPORT_PENDING_EXPORT: "billing-pending-report-export",

		/***************************** ADMIN SIDE BILLING MODULE SETTINGS API'S *****************************/
		API_URN_BILLING_ADMIN_SEARCH_STUDENT: "search-student",
		API_URN_BILLING_ADMIN_SETTINGS_ADD_UPDATE: "billing-setting-store",
		API_URN_BILLING_ADMIN_SETTINGS_EDIT: "billing-setting-edit",
		API_URN_BILLING_ADMIN_DELETED_DATA: "billing-deleted-table-data",
		API_URN_BILLING_ADMIN_SETTINGS_DELETE: "billing-setting-signature-destroy",
		API_URN_BILLING_ADMIN_COLLECT_BILL: "billing-collect",
		API_URN_BILLING_ADMIN_CREATE_BILL: "billing-store",
		API_URN_BILLING_ADMIN_GET_INVOICE_NUMBER: "billing-invoice-number",
		API_URN_BILLING_ADMIN_SHOW_BILL: "billing-show",
		API_URN_BILLING_ADMIN_ACTIVITY: "bill-activity",
		API_URN_BILLING_ADMIN_SHOW_BILL_DETAIL: "billing-detail",
		API_URN_BILLING_ADMIN_DESTROY_BILL: "billing-destroy",
		API_URN_BILLING_ADMIN_BILLING_TABLE_DATA: "billing-table-data",
		API_URN_BILLING_ADMIN_BILLING_TABLE_DATA: "billing-table-data",
		API_URN_BILLING_ADMIN_BILLING_TABLE_DATA_EXPORT: "billing-export",
		API_URN_BILLING_ADMIN_EDIT_BILL: "billing-edit",
		API_URN_BILLING_ADMIN_UPDATE_BILL: "billing-update",

		/*************************************** FRANCHISE SIDE **********************************************/
		API_URN_BILLING_FRANCHISE_CATEGORY_ADD: "franchise/billing-category-store",
		API_URN_BILLING_FRANCHISE_CATEGORY_EDIT: "franchise/billing-category-edit",
		API_URN_BILLING_FRANCHISE_CATEGORY_UPDATE: "franchise/billing-category-update",
		API_URN_BILLING_FRANCHISE_CATEGORY_DELETE: "franchise/billing-category-destroy",
		API_URN_BILLING_FRANCHISE_CATEGORY_DELETE_ROW: "franchise/billing-category-item-destroy",
		API_URN_BILLING_FRANCHISE_CATEGORY_LIST: "franchise/billing-category-table-data",
		API_URN_BILLING_FRANCHISE_CATEGORY_DROPDOWN: "franchise/billing-category-dropdown",
		API_URN_BILLING_FRANCHISE_CATEGORY_SUB_CATAGORY_DROPDOWN: "franchise/billing-sub-category-dropdown",
		API_URN_BILLING_FRANCHISE_CATEGORY_CHANGE_STATUS: "franchise/billing-category-change-status",
		API_URN_BILLING_FRANCHISE_BILLING_EXPORT: "franchise/billing-export",

		/*************************************** PARENTS SIDE **********************************************/
		API_URN_BILLING_PARENTS_SIDE_BILLING_TABLE_DATA: "parent/billing-table-data",
		API_URN_BILLING_PARENTS_SIDE_BILLING_SHOW: "parent/billing-show",
	...
	const exam_management = {
		...
		API_URN_EXAM_MANAGEMENT_HALLTICKET_PRINT: "exam-management-hallticket-print",
		API_URN_EXAM_MANAGEMENT_HALLTICKET_SETTING_ADD: "exam-management-hallticket-setting-add",
		API_URN_EXAM_MANAGEMENT_HALLTICKET_SETTING_SHOW: "exam-management-hallticket-setting-get",
		API_URN_EXAM_MANAGEMENT_HALLTICKET_SETTING_DELETE: "exam-management-hallticket-setting-delete",

		// Parents side
		API_URN_EXAM_MANAGEMENT_LIST: "parent/exam-management-hallticket-table-data",
		API_URN_EXAM_MANAGEMENT_HALL_TICKET_GENERATE: "parent/exam-management-hallticket-generate",
	}
	const gatepass = {
		//SETTINGS
		API_URN_GATE_PASS_SETTINGS_ADD_UPDATE_STORE: "gatepass-setting-store",
		API_URN_GATE_PASS_SETTINGS_EDIT: "gatepass-setting-edit",

		//ISSUED GATE PASS
		API_URN_GATE_PASS_ISSUED_GATE_PASS_ADD: "gatepass-store",
		API_URN_GATE_PASS_ISSUED_GATE_PASS_EDIT: "gatepass-edit",
		API_URN_GATE_PASS_ISSUED_GATE_PASS_GET_STUDENT_LIST: "gatepass-student-data",
		API_URN_GATE_PASS_ISSUED_GATE_PASS_SHOW: "gatepass-show",
		API_URN_GATE_PASS_ISSUED_GATE_PASS_UPDATE: "gatepass-update",
		API_URN_GATE_PASS_ISSUED_GATE_PASS_DELETE: "gatepass-destroy",
		API_URN_GATE_PASS_ISSUED_GATE_PASS_LIST: "gatepass-table-data",
		API_URN_GATE_PASS_ISSUED_GATE_PASS_APPROVE: "gatepass-status-update",
		API_URN_GATE_PASS_ISSUED_GATE_PASS_MARKOUT_CHECK: "gatepass-markout",
		API_URN_GATE_PASS_BULK_APPROVE: "gatepass-bulk-status-update",

		//Parent Side
		API_URN_GATE_PASS_PARENT_SIDE_ADD: "parent/gatepass-store",
		API_URN_GATE_PASS_PARENT_SIDE_EDIT: "parent/gatepass-edit",
		API_URN_GATE_PASS_PARENT_SIDE_SHOW: "parent/gatepass-show",
		API_URN_GATE_PASS_PARENT_SIDE_UPDATE: "parent/gatepass-update",
		API_URN_GATE_PASS_PARENT_SIDE_DELETE: "parent/gatepass-destroy",
		API_URN_GATE_PASS_PARENT_SIDE_LIST: "parent/gatepass-table-data",

	}

	const library = {
		// DASHBOARD
		API_URN_LIBRARY_DASHBOARD_ADMIN: "library-dashboard",

		// RACKS
		API_URN_GET_LIBRARY_RACKS_ADMIN: "library-racks-list",
		API_URN_ADD_LIBRARY_RACK_ADMIN: "library-rack",
		API_URN_EDIT_LIBRARY_RACK_ADMIN: "library-rack",
		API_URN_UPDATE_LIBRARY_RACK_ADMIN: "library-rack",
		API_URN_DELETE_LIBRARY_RACK_ADMIN: "library-rack",
		API_URN_GET_LIBRARY_RACKS_STATS_ADMIN: "library-rack-stats",
		API_URN_GET_LIBRARY_RACKS_DROPDOWN_ADMIN: "library-rack-dropdown",

		// SECTIONS
		API_URN_GET_LIBRARY_SECTIONS_ADMIN: "library-sections-list",
		API_URN_GET_LIBRARY_SECTIONS_DROPDOWN_ADMIN: "library-section-dropdown",
		API_URN_ADD_LIBRARY_SECTION_ADMIN: "library-section",
		API_URN_EDIT_LIBRARY_SECTION_ADMIN: "library-section",
		API_URN_UPDATE_LIBRARY_SECTION_ADMIN: "library-section",
		API_URN_DELETE_LIBRARY_SECTION_ADMIN: "library-section",

		// FLOORS
		API_URN_GET_LIBRARY_FLOORS_ADMIN: "library-floors-list",
		API_URN_GET_LIBRARY_FLOORS_DROPDOWN_ADMIN: "library-floor-dropdown",
		API_URN_ADD_LIBRARY_FLOOR_ADMIN: "library-floor",
		API_URN_EDIT_LIBRARY_FLOOR_ADMIN: "library-floor",
		API_URN_UPDATE_LIBRARY_FLOOR_ADMIN: "library-floor",
		API_URN_DELETE_LIBRARY_FLOOR_ADMIN: "library-floor",

		// SHELVES
		API_URN_GET_LIBRARY_SHELVES_ADMIN: "library-shelves-list",
		API_URN_GET_LIBRARY_SHELVES_DROPDOWN_ADMIN: "library-shelf-dropdown",
		API_URN_ADD_LIBRARY_SHELF_ADMIN: "library-shelf",
		API_URN_EDIT_LIBRARY_SHELF_ADMIN: "library-shelf",
		API_URN_UPDATE_LIBRARY_SHELF_ADMIN: "library-shelf",
		API_URN_DELETE_LIBRARY_SHELF_ADMIN: "library-shelf",

		// LOCATIONS
		API_URN_GET_LIBRARY_LOCATIONS_ADMIN: "library-locations-list",
		API_URN_GET_LIBRARY_LOCATIONS_DROPDOWN_ADMIN: "library-location-dropdown",
		API_URN_ADD_LIBRARY_LOCATION_ADMIN: "library-location",
		API_URN_EDIT_LIBRARY_LOCATION_ADMIN: "library-location",
		API_URN_UPDATE_LIBRARY_LOCATION_ADMIN: "library-location",
		API_URN_DELETE_LIBRARY_LOCATION_ADMIN: "library-location",

		// SPACE TREE
		API_URN_GET_LIBRARY_SPACE_TREE_ADMIN: "library-space-tree",

		// CATEGORIES
		API_URN_GET_LIBRARY_CATEGORIES_ADMIN: "library-categories-list",
		API_URN_ADD_LIBRARY_CATEGORY_ADMIN: "library-category",
		API_URN_EDIT_LIBRARY_CATEGORY_ADMIN: "library-category",
		API_URN_UPDATE_LIBRARY_CATEGORY_ADMIN: "library-category",
		API_URN_DELETE_LIBRARY_CATEGORY_ADMIN: "library-category",
		API_URN_GET_LIBRARY_CATEGORIES_DROPDOWN_ADMIN: "library-category-dropdown",
		// BOOK
		API_URN_ADD_LIBRARY_BOOK_ADMIN: "library-book",
		API_URN_GET_LIBRARY_BOOKS_ADMIN: "library-book-list",
		API_URN_EDIT_LIBRARY_BOOK_ADMIN: "library-book",
		API_URN_UPDATE_LIBRARY_BOOK_ADMIN: "library-book",
		API_URN_DELETE_LIBRARY_BOOK_ADMIN: "library-book",
		API_URN_GET_LIBRARY_BOOKS_DROPDOWN_ADMIN: "library-book-dropdown",
		API_URN_GET_LIBRARY_BOOK_ISSUE_HISTORY_ADMIN: "library-book-issue-history",
		API_URN_GET_LIBRARY_BOOK_ACTIVITY_LOG_ADMIN: "library-book-activity-log",
		API_URN_GET_LIBRARY_BOOK_BARCODES_ADMIN: "library-book-barcodes",
		API_URN_IMPORT_LIBRARY_BOOK_ADMIN: "library-book-import",

		// BOOKS COPIES
		API_URN_ADD_LIBRARY_BOOK_COPIES_ADMIN: "library-book-copies",
		API_URN_GET_LIBRARY_BOOK_COPIES_ADMIN: "library-book-copies-list",
		API_URN_EDIT_LIBRARY_BOOK_COPIES_ADMIN: "library-book-copies",
		API_URN_UPDATE_LIBRARY_BOOK_COPIES_ADMIN: "library-book-copies",
		API_URN_DELETE_LIBRARY_BOOK_COPIES_ADMIN: "library-book-copies",
		API_URN_MOVE_LIBRARY_BOOK_COPIES_ADMIN: "library-book-copies-move",

		// ISSUE / RETURN
		API_URN_ISSUE_LIBRARY_BOOK_ADMIN: "library-book-issue",
		API_URN_GET_LIBRARY_ISSUE_LIST_ADMIN: "library-issue-list",
		API_URN_RETURN_LIBRARY_BOOK_ADMIN: "library-book-return",
		API_URN_GET_STUDENT_SEARCH_LIBRARY_ADMIN: "library-student-search",
		API_URN_GET_BOOK_SEARCH_LIBRARY_ADMIN: "library-copy-search",
		API_URN_GET_ISSUED_COPY_DETAILS_LIBRARY_ADMIN: "library-issued-copy-details",
		API_URN_GET_LIBRARY_BOOK_ISSUE_DETAIL_ADMIN: "library-book-issue-detail",
		API_URN_GET_LIBRARY_ISSUE_BOOK_SEARCH_ADMIN: "library-issue-book-search",
		API_URN_GET_LIBRARY_ISSUE_BOOK_COPIES_ADMIN: "library-issue-book-copies",
		API_URN_GET_LIBRARY_ISSUE_COPY_SEARCH_ADMIN: "library-issue-copy-search",
		API_URN_GET_LIBRARY_BOOK_RETURN_DETAIL_ADMIN: "library-book-return-detail",

		// CONFIGURATION
		API_URN_LIBRARY_CONFIG_ADMIN: "library-config",
		API_URN_LIBRARY_CONFIG_UPDATE_ADMIN: "library-config",

		// CIRCULATION RULES
		API_URN_EDIT_LIBRARY_CIRCULATION_RULES_ADMIN: "library-circulation-rules",
		API_URN_UPDATE_LIBRARY_CIRCULATION_RULES_ADMIN: "library-circulation-rules",

		// FINE POLICY
		API_URN_EDIT_LIBRARY_FINE_POLICY_ADMIN: "library-fine-policy",
		API_URN_UPDATE_LIBRARY_FINE_POLICY_ADMIN: "library-fine-policy",

		// MASTERS
		API_URN_GET_LIBRARY_MASTERS_ADMIN: "library-masters-list",
		API_URN_GET_LIBRARY_MASTERS_DROPDOWN_ADMIN: "library-master-dropdown",
		API_URN_ADD_LIBRARY_MASTER_ADMIN: "library-master",
		API_URN_EDIT_LIBRARY_MASTER_ADMIN: "library-master",
		API_URN_UPDATE_LIBRARY_MASTER_ADMIN: "library-master",
		API_URN_DELETE_LIBRARY_MASTER_ADMIN: "library-master",

		// BILLING
		API_URN_GET_LIBRARY_BILLING_LEDGER_LIST_ADMIN: "library-billing-ledger-list",
		API_URN_GET_LIBRARY_BILLING_LEDGER_STATS_ADMIN: "library-billing-ledger-stats",
		API_URN_GENERATE_LIBRARY_BILL_ADMIN: "library-billing-generate-bill",

		// ACTIVITY LOG
		API_URN_GET_LIBRARY_ACTIVITY_LOG_LIST_ADMIN: "library-activity-log-list",
		API_URN_GET_LIBRARY_ACTIVITY_LOG_STATS_ADMIN: "library-activity-log-stats",
		API_URN_GET_LIBRARY_ACTIVITY_LOG_USERS_ADMIN: "library-activity-log-users"
	};
	//////////////////////////////Configration END//////////////////////////////
	...
	Lib.ReportCenter = require("../core_modules/report-center")(Lib, report_center);
	...
	Lib.CurriculumProvider = require("../core_modules/CurriculumProvider")(
		Lib,
		curriculum_provider
	);
	...
	Lib.StudentTransfer = require("../core_modules/student-transfer")(Lib, config_student_transfer);

	Lib.Broadcast = require("../core_modules/broadcast")(Lib, config_broadcast);

	Lib.UserActivity = require("../core_modules/user-activity")(Lib, config_user_activity);

	Lib.FeeApproval = require("../core_modules/fee-approval")(Lib, config_fee_approval);

	Lib.AttendanceLeaveApproval = require("../core_modules/attendance-leave-approval")(Lib, config_attendance_leave_approval);
	Lib.PayrollSalary = require("../core_modules/payroll-salary")(Lib, config_payroll_salary);

	Lib.DynamicDesign = require("../core_modules/dynamic-design")(Lib, config_dynamic_design);
	...
	Lib.Billing = require("../core_modules/billing-module")(Lib, config_billing)
	Lib.GatePass = require("../core_modules/gatepass")(Lib, gatepass)
	Lib.Library = require("../core_modules/library")(Lib, library)
	/////////////////////////////Project Modules END//////////////////////////
};
