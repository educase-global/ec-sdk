...
const loader = function (shared_libs, config_app) {
	...
	const config_franchise = {
		...
		API_URN_FRANCHISE_CURRICULUM_TEACHER_CURRICULUM_SESSION_START: "teacher/curriculum-session-start",
		API_URN_FRANCHISE_CURRICULUM_TEACHER_CURRICULUM_SESSION_END: "teacher/curriculum-session-end",
