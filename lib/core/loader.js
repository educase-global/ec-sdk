...
const loader = function (shared_libs, config_app) {
	...
	const config_franchise = {
		...
		API_URN_FRANCHISE_COMMUNICATION_CATEGORY_STORE: "communication-category-store",
		API_URN_FRANCHISE_COMMUNICATION_CATEGORY_EDIT: "communication-category-edit",
		API_URN_FRANCHISE_COMMUNICATION_CATEGORY_UPDATE: "communication-category-update",
		API_URN_FRANCHISE_COMMUNICATION_CATEGORY_DESTROY: "communication-category-destroy",
		API_URN_FRANCHISE_COMMUNICATION_CATEGORY_TABLE_DATA: "communication-category-table-data",
		API_URN_FRANCHISE_COMMUNICATION_CATEGORY_DROPDOWN: "communication-category-dropdown",

		API_URN_FRANCHISE_COMMUNICATION_STORE: "communication-store",
		API_URN_FRANCHISE_COMMUNICATION_EDIT: "communication-edit",
		API_URN_FRANCHISE_COMMUNICATION_SHOW: "communication-show",
		API_URN_FRANCHISE_COMMUNICATION_TABLE_DATA: "communication-table-data",
		API_URN_FRANCHISE_COMMUNICATION_DESTROY: "communication-destroy",
		API_URN_FRANCHISE_COMMUNICATION_DESTROY_SINGLE_BRANCH: "communication-destroy-single-branch",
		API_URN_FRANCHISE_COMMUNICATION_UPDATE: "communication-update"
	};
