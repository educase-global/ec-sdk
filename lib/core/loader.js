...
const loader = function (shared_libs, config_app) {
	...
	const config_franchise = {
		...
		API_URN_FRANCHISE_OVERVIEW_GET_EX_STUDENT_TABLE: 'ex-stud-table-data',
		API_URN_FRANCHISE_OVERVIEW_ADD_EX_STUDENT: 'ex-stud-store',

		API_URN_FRANCHISE_OVERVIEW_GET_STUDENT_HISTORY_TABLE: 'stud-delete-history',
		API_URN_FRANCHISE_OVERVIEW_RESTORE_STUDENT: 'stud-restore',
