...
const loader = function (shared_libs, config_app) {
  ...
  const config_sms_email = {
    API_URN_REGISTRATION_STUDENT_TABLE_DATA_ADMIN: "registration-student-table-data",
  ...
  const config_year_management = {
    API_URN_ACADEMIC_YEAR_SHOW_ADMIN: "academic-year-show",
  ...
  const config_test_report = {
    ...
    API_URN_TESTS_TABLE_DATA_ADMIN: "student/test-table-data"
  }
  ...
  Lib.PageContent = require("../core_modules/page-content")(Lib, config_page_content)

  Lib.SmsEmail = require("../core_modules/sms-email")(Lib, config_sms_email)

  Lib.YearManagement = require("../core_modules/year-management")(Lib, config_year_management)
  ...
  Lib.TestReport = require("../core_modules/test-report")(Lib, config_test_report)
