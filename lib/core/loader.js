  ...
  const loader = function(shared_libs, config_app){
    ...
    const config_mealcalendar = {
     ...
     // Api urns MEAL CALENDAR
      ...
      API_URN_ADD_MEAL_CALENDAR_ADMIN : 'menu-calendar-store',
      API_URN_EDIT_MEAL_CALENDAR_ADMIN : 'menu-calendar-edit',
      API_URN_UPDATE_MEAL_CALENDAR_ADMIN : 'menu-calendar-update',
      API_URN_DELETE_MEAL_CALENDAR_ADMIN : 'menu-calendar-destroy',
      API_URN_GET_MEAL_CALENDAR_ADMIN : 'menu-calendar-table-data',
