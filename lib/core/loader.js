...
const config_progress_report = {
  ...
  const config_meet = {
    ...
    API_URN_GET_ARCHIVED_VIRTUAL_MEET_LIST_PARENT: "student/meeting/list/archieved"
  ...
  const config_student = {
    ...
    API_URN_STUDENT_GENERATE_QRCODE_ADMIN: "",

    API_URN_ADD_EX_STUDENT_ADMIN: "student-leave-form",
    API_URN_GET_EX_STUDENT_ADMIN: "student-table-data",
    
    API_URN_UPDATE_STUDENT_DELETE_ADMIN: "student-delete-history",
  ...
  const config_insta = {
   ...
   API_URN_VIEW_DAYCARE_CATEGORY_ADMIN: "daycare-category-edit",
...
API_URN_GET_FEE_FINE_LIST_ADMIN: "fee-type-table-data",
API_URN_DELETE_FEE_FINE_ADMIN: "fee-type-destroy",
API_URN_EDIT_FEE_FINE_ADMIN: "fee-type-edit",
API_URN_UPDATE_FEE_FINE_ADMIN: "fee-type-update",
API_URN_ADD_FEE_FINE_ADMIN: "fee-type-store", 

API_URN_GET_FEE_CONFIG_LIST_ADMIN: "fee-type-table-data",
API_URN_DELETE_FEE_CONFIG_ADMIN: "fee-type-destroy",
API_URN_EDIT_FEE_CONFIG_ADMIN: "fee-type-edit",
API_URN_UPDATE_FEE_CONFIG_ADMIN: "fee-type-update",
API_URN_ADD_FEE_CONFIG_ADMIN: "fee-type-store", 
...
API_URN_STUDENT_FEE_PENDING_REPORT_ADMIN: "student-pending-fee-report",
  ...
  Lib.ProgressReport = require("../core_modules/progress-report")(Lib, config_progress_report)
  ...
  Lib.Configuration = require("../core_modules/configuration")(Lib, config_configuration)

  Lib.Student = require("../core_modules/student")(Lib, config_student)

  Lib.Fee = require("../core_modules/fee")(Lib, config_fee)

  Lib.OurProgram = require("../core_modules/our-program")(Lib, config_our_program)

  Lib.AboutusSection = require("../core_modules/aboutus-section")(Lib, config_aboutus_section)

  Lib.Testimonial = require("../core_modules/testimonial")(Lib, config_testimonial)
