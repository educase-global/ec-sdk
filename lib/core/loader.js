...
const loader = function (shared_libs, config_app) {
  ...
  const config_insta = {
   ...
   API_URN_ALLOCATE_STUDENT_LLIST_ADMIN: "allocate-student-table-data",
    ...
    API_URN_GET_DAYCARE_IN_STORE_ADMIN: "student-daycare-in-store",
    API_URN_GET_DAYCARE_OUT_UPDATE_ADMIN:"student-daycare-out-update"
