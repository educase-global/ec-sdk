...
const loader = function (shared_libs, config_app) {
	...
	const config_student = {
		...
		API_URN_STUDENT_EXPORT_ALL_PROFILE_PHOTO_ADMIN: "student-export-all-profile",
	...
	const config_franchise = {
		...
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_CHAPTER_DROPDOWN: "franchise/curriculum-lesson-plan-chapter-dropdown",
		...
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_CHAPTER_RENAME: "franchise/curriculum-lesson-plan-chapter",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_CHAPTER_DELETE: "franchise/curriculum-lesson-plan-chapter",

		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_TOPIC: "franchise/curriculum-lesson-plan-topic",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_TOPIC_RENAME: "franchise/curriculum-lesson-plan-topic",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_TOPIC_SHOW_EDIT: "franchise/curriculum-lesson-plan-topic",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_TOPIC_DELETE: "franchise/curriculum-lesson-plan-topic",

		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_SUB_TOPIC_STORE: "franchise/curriculum-lesson-plan-sub-topic",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_SUB_TOPIC_UPDATE: "franchise/curriculum-lesson-plan-sub-topic",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_SUB_TOPIC_DELETE: "franchise/curriculum-lesson-plan-sub-topic",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_SUB_TOPIC_SHOW_EDIT: "franchise/curriculum-lesson-plan-sub-topic",

		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_SUB_TOPIC_RESOURCE_STORE: "franchise/curriculum-lesson-plan-sub-topic-resource",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_SUB_TOPIC_RESOURCE_DELETE: "franchise/curriculum-lesson-plan-sub-topic-resource",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_SUB_TOPIC_RESOURCE_RENAME: "franchise/curriculum-lesson-plan-sub-topic-resource",
		...
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_ALLOCATED_STAFF_LIST: "franchise/curriculum-lesson-plan-allocated-staff-list",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_ALLOCATE_DEALLOCATE_STAFF: "franchise/curriculum-lesson-plan-allocate-deallocate-staff",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_ALLOCATE_STAFF_DROPDOWN: "franchise/curriculum-lesson-plan-allocate-staff-dropdown",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_SETTING_STORE: "franchise/curriculum-lesson-plan-setting",
		API_URN_FRANCHISE_CURRICULUM_LESSON_PLAN_SETTING_EDIT: "franchise/curriculum-lesson-plan-setting",
		...
		API_URN_FRANCHISER_KIT_APPLY_SERVICE_CHARGE_DISCOUNT: "admin/kit-apply-service-charge-discount",
		API_URN_FRANCHISER_KIT_SERVICE_CHARGE_SCHOOL_LIST: "franchiser/service-charge-school-list",
		API_URN_FRANCHISER_KIT_SERVICE_CHARGE_DISCOUNT_APPLY: "franchiser/service-charge-discount-apply",
	...
	const config_curriculum = {
		...
		API_URN_ADMIN_CURRICULUM_LESSON_PLAN_DETAIL: "admin/curriculum-lesson-plan-detail",
		API_URN_ADMIN_CURRICULUM_LESSON_PLAN_CHAPTER_DROPDOWN: "admin/curriculum-lesson-plan-chapter-dropdown",
	...
	const config_bustracking = {
		...
		// BUS ROUTE V2
		API_URN_BUSTRACKING_BUS_ROUTE_V2_STORE_ADMIN: "bus-route-v2-store",
		API_URN_BUSTRACKING_BUS_ROUTE_V2_UPDATE_ADMIN: "bus-route-v2-update",
		API_URN_BUSTRACKING_BUS_ROUTE_V2_DESTROY_ADMIN: "bus-route-v2-destroy",
		API_URN_BUSTRACKING_BUS_ROUTE_V2_SHOW_ADMIN: "bus-route-v2-show",
		API_URN_BUSTRACKING_BUS_ROUTE_V2_TABLE_DATA_ADMIN: "bus-route-v2-table-data",
		API_URN_BUSTRACKING_BUS_ROUTE_V2_DROP_DOWN_ADMIN: "bus-route-v2-drop-down",
