...
const loader = function (shared_libs, config_app) {
	...
	const config_progress_report = {
		...
		API_URN_PROGRESS_REPORT_DESTROY_STUDENT_DATA_ADMIN: "3/progress-report-destroy-student-data"
	};
	...
	const config_daycare = {
		...
		API_URN_DAYCARE_DAILY_REPORT_STORE_ADMIN: "daycare-daily-report-store",
		API_URN_DAYCARE_DAILY_REPORT_UPDATE_ADMIN: "daycare-daily-report-update",
		API_URN_DAYCARE_DAILY_REPORT_EDIT_ADMIN: "daycare-daily-report-edit",
		...
		API_URN_DAYCARE_DAILY_REPORT_DROPDOWN_ADMIN: "daycare-daily-report-dropdown",
